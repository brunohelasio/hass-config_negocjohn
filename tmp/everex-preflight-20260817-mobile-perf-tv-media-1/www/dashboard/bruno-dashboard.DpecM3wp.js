...
const Ge = 720, He = 200, Ye = 24, Qe = 4, Qa = 3e4, Xe = 12, Aa = 10 * 1024 * 1024, We = 64;
function $a(r) {
...
class Ze {
  ...
  tarefaLonga(a) {
    this.tarefas.push(a), this.tarefas.length > He && this.tarefas.shift(), this.tarefasTotal++, this.tarefasDuracao += a.duracao, a.duracao > this.tarefasPior && (this.tarefasPior = a.duracao), a.em < Qa && this.tarefasNaCarga++;
  }
  // ── Ciclo de navegação ────────────────────────────────────────────────────
  /**
  ...
  leituraDeTarefas(a) {
    const e = this.tarefasTotal - this.tarefasNaCarga, o = Math.max(0, a - Qa) / 6e4;
    return {
  ...
  instantaneo(a) {
    const o = [...this.componentes.values()].sort(
      ...
      render: { ...s.render },
      motivos: [...s.motivos.entries()].map(([c, l]) => ({ motivo: c, total: l })).sort((c, l) => l.total - c.total).slice(0, Qe),
      timers: { ...s.timers },
...
function oo(r, a, e) {
  ...
  return Q.set(o, "intervalo"), w.timerCriado(r), o;
}
function R(r, a, e) {
  const o = window.setTimeout(() => {
    Q.delete(o), w.timerEncerrado(r), a();
  }, e);
  return Q.set(o, "espera"), w.timerCriado(r), o;
}
function k(r, a) {
  if (a === void 0) return;
  const e = Q.get(a);
  e !== void 0 && (e === "intervalo" ? window.clearInterval(a) : window.clearTimeout(a), Q.delete(a), w.timerEncerrado(r));
}
function io() {
  return Q.size;
}
 ...
 */
const ua = globalThis, Fa = ua.ShadowRoot && (ua.ShadyCSS === void 0 || ua.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Va = Symbol(), Xa = /* @__PURE__ */ new WeakMap();
let _e = class {
  constructor(a, e, o) {
  ...
  get styleSheet() {
    ...
    if (Fa && a === void 0) {
      ...
      o && (a = Xa.get(e)), a === void 0 && ((this.o = a = new CSSStyleSheet()).replaceSync(this.cssText), o && Xa.set(e, a));
    }
    return a;
  }
  toString() {
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), ie = /'/g, te = /"/g, ke = /^(?:script|style|textarea|title)$/i, ze = (r) => (a, ...e) => ({ _$litType$: r, strings: a, values: e }), p = ze(1), Ca = ze(2), X = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), re = /* @__PURE__ */ new WeakMap(), V = B.createTreeWalker(B, 129);
function Ae(r, a) {
...
class na {
  ...
  _$AI(a, e = this) {
    a = W(this, a, e), ta(a) ? a === h || a == null || a === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : a !== this._$AH && a !== X && this._(a) : a._$litType$ !== void 0 ? this.$(a) : a.nodeType !== void 0 ? this.T(a) : vo(a) ? this.k(a) : this._(a);
  }
  O(a) {
...
class qa {
  ...
  _$AI(a, e = this, o, i) {
    ...
    let n = !1;
    if (t === void 0) a = W(this, a, e, 0), n = !ta(a) || a !== this._$AH && a !== X, n && (this._$AH = a);
    else {
      const s = a;
      let c, l;
      for (a = t[0], c = 0; c < t.length - 1; c++) l = W(this, s[o + c], e, c), l === X && (l = this._$AH[c]), n ||= !ta(l) || l !== this._$AH[c], l === h ? a = h : a !== h && (a += (l ?? "") + t[c + 1]), this._$AH[c] = l;
    }
    n && !i && this.j(a);
  }
  j(a) {
...
const Yo = "∅", Qo = (r) => r ? `${r.state}@${r.last_changed}` : Yo;
class xa {
  constructor(a = [], e = {}) {
  ...
  projetar(a, e) {
    return (this.projecoes[e] ?? Qo)(a.states[e]);
  }
  /**
...
const Xo = /^[a-z_]+\.[a-z0-9_]+$/, Wo = 8;
function ce(r, a = 0) {
  const e = [], o = /* @__PURE__ */ new Set(), i = (t, n) => {
    if (!(n > Wo || t == null)) {
      if (typeof t == "string") {
        Xo.test(t) && !o.has(t) && (o.add(t), e.push(t));
        return;
      }
      if (Array.isArray(t)) {
...
const Hi = 4e3, Yi = 3e4, Qi = 700, Xi = "/local/bruno-ui/assets/tcl-qled-mini-led-75.png?v=20260802-assets-resize-1", Wi = "/local/images/echo_pop.png?v=20260702-all-images-1", Zi = "/local/images/office_pc.png?v=20260702-all-images-1";
function U(r, a = 0) {
  const e = Number(r);
...
class Ji extends E {
  ...
  _corpoTv() {
    const a = this._modeloTv(), e = this._idDe("tv"), o = this._sub?.tvStandbyImage ?? Xi, t = (!(!a.titulo || /^TV (ligada|desligada)$/i.test(a.titulo) || a.titulo === a.fonte) && a.estado === "playing" ? a.titulo : "") || a.fonte;
    if (!a.ativo)
      return p`
        <div class="mh-left">
...
//# sourceMappingURL=bruno-dashboard.DpecM3wp.js.map
