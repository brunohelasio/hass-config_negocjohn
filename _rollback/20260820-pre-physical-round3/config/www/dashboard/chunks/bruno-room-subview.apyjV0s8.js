import { i as w, a as ta, M as ra, C as na, r as O, e as v, b as A, O as H, p as sa, m as R, R as la, c as G, d as ca, f as da, g as pa, o as I, h as ma, j as N, k as ha, l as ua, s as ga, A as b, n as l, q as ba, t as xa, u as fa, v as va, w as D } from "./main.C6S5My7_.js";
const wa = {
  sala: {
    title: "Sala",
...
const E = /* @__PURE__ */ new Set(), S = { timer: void 0, ouvindoVisibilidade: !1 }, ya = 1e3;
function Z() {
  for (const u of [...E])
    try {
      u();
...
function J() {
  S.timer !== void 0 || E.size === 0 || W() || (S.timer = globalThis.setInterval(Z, ya));
}
function K() {
...
function ka() {
  S.ouvindoVisibilidade || typeof document > "u" || (document.addEventListener("visibilitychange", qa), S.ouvindoVisibilidade = !0);
}
function za(u) {
  E.add(u), ka(), J();
  let a = !1;
  return () => {
    a || (a = !0, E.delete(u), E.size === 0 && K());
  };
}
const Aa = [
...
const La = ["playing", "paused", "on", "idle"], Pa = ["streaming", "recording", "idle", "on"], ja = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], Ba = ["cooling", "heating", "drying", "fan", "preheating"], Ua = ["off", "idle"], Ha = [
  { visual: 0, position: 0 },
  { visual: 25, position: 33 },
  { visual: 50, position: 47 },
  { visual: 75, position: 70 },
  { visual: 100, position: 100 }
], Y = 3e4, X = 1200, Ga = 350, L = 2, Ya = 700;
function Xa(u) {
  if (!u) return "∅";
...
const Qa = 4e3, Za = 3e4, Wa = 700, Ja = "/local/bruno-ui/assets/tcl-qled-mini-led-75.png?v=20260802-assets-resize-1", Ka = "/local/images/echo_pop.png?v=20260702-all-images-1", ao = "/local/images/office_pc.png?v=20260702-all-images-1";
function M(u, a = 0) {
  const o = Number(u);
...
class oo extends ta {
  constructor() {
    super(...arguments), this._lightsOpen = !1, this._folha = null, this._folhaSaindo = !1, this._tokenAncoraFolha = 0, this._fonteMidia = "", this._fonteMidiaManual = !1, this._midiaAtivasAntes = [], this._tvUltimoVolume = null, this._tvUltimoPoster = "", this._tvUltimaFonte = "HDMI 1", this._tvUltimoTitulo = "", this._menuMidiaAberto = !1, this._spotifyFerramentas = !1, this._painelClima = "", this._controlesCameraAbertos = !1, this._cameraAtiva = "", this._urlsCarregadas = {}, this._ultimaImagem = {}, this._motorCameras = new ra({
      ...
      aoMedir: (a, o, i, e) => {
        const t = a.split(".")[1] ?? a;
        O(`câmera ${t}`, o, i === "ok"), e && O(`câmera ${t} · 1º quadro`, o, !0);
      }
  ...
  setConfig(a) {
    ...
    const o = la.find((n) => n.id === a.room);
    if (!o) throw new Error(`bruno-room-subview: cômodo desconhecido "${a.room}"`);
    this._config = a, this._room = o, this._sub = wa[a.room], this._config, this._hass;
    const i = [
      ...G(o),
      ...G(this._sub)
    ...
    }).filter((n) => !!n), r = Object.fromEntries(t.map((n) => [n, Xa]));
  ...
  set hass(a) {
    ...
    o.length !== 0 && (this._motivo = ca(o), this.requestUpdate());
  }
  getCardSize() {
    return 12;
  }
  ...
  update(a) {
    ...
    this._motivo = "", da(h, () => super.update(a), o || this._motivoPadrao());
  }
  _motivoPadrao() {
  ...
  connectedCallback() {
    super.connectedCallback(), pa(h), this._estadoAoVivo = "ocioso", this._fallbackAoVivo = "", this._montadoEm = performance.now(), this._quadrosNaTela.clear(), this._socorros.clear(), this._aplicarAtributos();
    const a = globalThis;
  ...
  _iniciarTimerRelogio() {
    this._cancelarRelogio || (this._cancelarRelogio = za(() => {
      const a = this._hora();
  ...
  _interpolarCortina(a, o, i) {
    const e = this._percentualCortinaValido(a) ?? 0, t = Ha, r = t[0];
    if (e <= r[o]) return r[i];
  ...
  _fechamentoCortina() {
    ...
    if (o.retido)
      return !r && n != null && e - o.retidoEm >= Ya ? (this._movimentoCortina = void 0, n) : o.fechado;
  ...
  _iniciarTimerMovimentoCortina() {
    this._timerMovimentoCortina || !this.isConnected || (this._timerMovimentoCortina = ba(h, () => {
  ...
  _servico(a, o, i) {
    this._hass && _a(this._hass, a, o, i);
  }
  /**
   ...
   */
  _cameraViva(a) {
    const o = this._estado(a.entity), i = a.fallbackEntity ? this._estado(a.fallbackEntity) : void 0, e = this._indisponivel(o) && !!a.fallbackEntity && !this._indisponivel(i), t = e ? String(a.fallbackEntity) : a.entity, r = e ? i : o, n = this._indisponivel(r), p = !n && Pa.includes(String(r?.state ?? "")), s = String(r?.attributes.entity_picture ?? "");
  ...
  _modeloTv() {
    const a = this._idDe("tv"), o = this._idDe("tvMedia") ?? a, i = this._estado(a), e = this._estado(o), t = i?.attributes ?? {}, r = e?.attributes ?? {}, n = xa(this._hass, a), p = fa(this._hass, o), s = String(i?.state ?? "off").toLowerCase(), c = String(e?.state ?? "").toLowerCase(), m = String(r.app_name ?? r.source ?? t.source ?? t.app_name ?? "").trim(), d = String(r.media_title ?? r.media_series_title ?? r.app_name ?? "").trim(), g = String(r.entity_picture ?? r.media_image_url ?? "").trim(), x = t.volume_level ?? r.volume_level, y = x == null ? Number.NaN : Number(x), C = Number.isFinite(y) ? Math.round(y * 100) : null;
    return n ? (m && (this._tvUltimaFonte = m), d && (this._tvUltimoTitulo = d), g && (this._tvUltimoPoster = g), C != null && (this._tvUltimoVolume = C)) : (this._tvUltimoPoster = "", this._tvUltimoTitulo = "", this._tvUltimoVolume = null), {
      st: i,
      media: e,
      estado: p ? c : s,
      ativo: n,
  ...
  _modeloSpotify() {
    const a = this._estado(this._idDe("spotify")), o = a?.attributes ?? {}, i = a?.state ?? "off", t = La.includes(i) && va(
      a,
  ...
  _corpoTv() {
    const a = this._modeloTv(), o = this._idDe("tv"), i = this._idDe("tvMedia") ?? o, e = this._sub?.tvStandbyImage ?? Ja, r = (!(!a.titulo || /^TV (ligada|desligada)$/i.test(a.titulo) || a.titulo === a.fonte) && a.estado === "playing" ? a.titulo : "") || a.fonte;
    if (!a.ativo)
      return l`
        <div class="mh-left">
    ...
    return l`
      <div class="mh-left">
        ...
        <div class="mh-controls">${this._linhaVolume(o, a.volume ?? 60)} ${p}</div>
      </div>
              ...
              content: {
                ...
                custom_actions: [
                  ...
                  i("menu", "mdi:menu", "button.tv_sala_menu"),
                  {
                    ...
                    tap_action: o("button.tv_sala_ok"),
                    up: { icon: "mdi:chevron-up", tap_action: o("button.tv_sala_navigate_up"), hold_action: { action: "repeat" } },
                    down: { icon: "mdi:chevron-down", tap_action: o("button.tv_sala_navigate_down"), hold_action: { action: "repeat" } },
                    left: { icon: "mdi:chevron-left", tap_action: o("button.tv_sala_navigate_left"), hold_action: { action: "repeat" } },
                    right: { icon: "mdi:chevron-right", tap_action: o("button.tv_sala_navigate_right"), hold_action: { action: "repeat" } }
                  },
  ...
  _corpoPc() {
    const a = this._modeloPc(), o = this._sub?.pcImage ?? ao, i = a.ativo ? [a.sessao, a.janela].filter((t) => t && t !== "--")[0] || "Sessão ativa" : "Pronto para ligar", e = (t) => () => {
  ...
  _corpoSpotify() {
    const a = this._modeloSpotify(), o = this._idDe("spotify"), i = this._sub?.spotifyStandbyImage ?? Ka;
    if (!a.ativo)
      return l`
        <div class="mh-left">
  ...
  _renderEletrodomesticos() {
    ...
    return Array.isArray(a) ? a.filter((o) => !!o && typeof o == "object").map((o) => {
      const i = String(o.key ?? "item").replace(/[^a-z0-9_-]/gi, "-").toLowerCase(), e = String(o.name ?? "Eletrodoméstico"), t = typeof o.image == "string" ? o.image : "", r = typeof o.entity == "string" ? o.entity : "", n = typeof o.stateEntity == "string" ? o.stateEntity : r, p = n && this._hass ? this._hass.states[n] : void 0, s = Array.isArray(o.activeStates) ? o.activeStates.map((C) => String(C).toLowerCase()) : ["on"], c = typeof o.activeAttr == "string" ? o.activeAttr : "", m = this._room?.activeSensor ? this._hass?.states[this._room.activeSensor] : void 0, d = s.includes(String(p?.state ?? "").toLowerCase()) || (c ? Va(m?.attributes[c]) : !1), g = !!o.placeholder || !r, x = typeof o.moreInfoEntity == "string" ? o.moreInfoEntity : r, y = ["appliance-tile", `is-${i}`, d ? "is-on" : "", g ? "is-muted" : ""].filter(Boolean).join(" ");
      return l`
          <article class=${y}>
            <button
              type="button"
   ...
   */
  _modeloClimate() {
    const a = this._estadoClimate(), o = a?.attributes ?? {}, i = String(o.hvac_action ?? "").toLowerCase(), e = this._indisponivel(a), t = e || a?.state === "off" ? !1 : Ba.includes(i) ? !0 : Ua.includes(i) ? !1 : ja.includes(String(a?.state ?? "")), r = (n, p) => Number.isFinite(Number(n)) ? Number(n) : p;
    return {
      st: a,
      indisponivel: e,
      ativo: t,
  ...
  _renderAnelClimate(a) {
    const s = Number.isFinite(a.minima) ? a.minima : 12, c = Number.isFinite(a.maxima) ? a.maxima : 30, m = Number.isFinite(Number(a.alvo)) ? Math.max(s, Math.min(c, Number(a.alvo))) : s + (c - s) / 2, g = -180 + 180 * Math.max(0, Math.min(1, (m - s) / Math.max(1, c - s))), x = (f, _) => {
      ...
      const q = -180 + 180 * (_ / 90), k = _ % 15 === 0, z = _ % 5 === 0, T = x(334, q), U = x(
        k ? 308 : z ? 314 : 321,
        q
      ), ea = k ? "icg-tick major" : z ? "icg-tick medium" : "icg-tick minor";
      return D`<line x1=${T.x.toFixed(3)} y1=${T.y.toFixed(3)} x2=${U.x.toFixed(3)} y2=${U.y.toFixed(3)} class=${ea}></line>`;
    }), aa = Array.from({ length: 73 }, (f, _) => {
      const q = -180 + 180 * (_ / 72), k = x(282, q), z = x(266, q);
      return D`<line x1=${k.x.toFixed(3)} y1=${k.y.toFixed(3)} x2=${z.x.toFixed(3)} y2=${z.y.toFixed(3)} class="icg-inner-tick"></line>`;
    }), oa = [
      ...
      const _ = x(f.r, f.ang);
      return D`<text x=${_.x.toFixed(3)} y=${_.y.toFixed(3)} text-anchor="middle" dominant-baseline="middle" class=${`icg-label ${f.cls}`}>${f.texto}</text>`;
...
customElements.get("bruno-room-subview") || customElements.define("bruno-room-subview", oo);
const F = window;
F.customCards = F.customCards ?? [];
F.customCards.some((u) => u.type === "bruno-room-subview") || F.customCards.push({
  type: "bruno-room-subview",
  name: "Bruno · Subview de cômodo",
  description: "Subview parametrizada por cômodo (arquitetura nova)."
});
export {
  oo as BrunoRoomSubview
};
//# sourceMappingURL=bruno-room-subview.apyjV0s8.js.map
