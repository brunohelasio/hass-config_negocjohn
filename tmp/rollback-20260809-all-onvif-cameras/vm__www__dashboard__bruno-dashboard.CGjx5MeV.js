...
const Mt = 720, Et = 200, Tt = 24, It = 4, je = 3e4, Dt = 12, ge = 10 * 1024 * 1024, Ot = 64;
function be(r) {
...
class Pt {
  ...
  de(e) {
    ...
    return t || (t = Ct(e), this.componentes.set(e, t)), t;
  }
  // ── Pontos de coleta ──────────────────────────────────────────────────────
  conectou(e) {
  ...
  renderizou(e, t, i) {
    ...
    const n = a.motivos.has(i) || a.motivos.size < Tt ? i : "outros";
  ...
  memoriaAmostrada(e) {
    this.memoria.push(e), this.memoria.length > Mt && this.memoria.shift(), e.usado < this.pisoGlobal && (this.pisoGlobal = e.usado), e.usado > this.picoGlobal && (this.picoGlobal = e.usado), this.valoresDeMemoria.size < Ot && this.valoresDeMemoria.add(e.usado);
  }
  tarefaLonga(e) {
    this.tarefas.push(e), this.tarefas.length > Et && this.tarefas.shift(), this.tarefasTotal++, this.tarefasDuracao += e.duracao, e.duracao > this.tarefasPior && (this.tarefasPior = e.duracao), e.em < je && this.tarefasNaCarga++;
  }
  // ── Ciclo de navegação ────────────────────────────────────────────────────
  /**
  ...
  // ── Leitura ───────────────────────────────────────────────────────────────
  leituraDeMemoria() {
    const e = this.memoria, t = e[0], i = e[e.length - 1], a = e.length, o = Math.max(1, Math.floor(a / 3)), n = a ? be(e.slice(0, o)) : 0, l = a ? be(e.slice(a - o)) : 0, s = l - n, d = this.valoresDeMemoria.size, m = a ? be(e.slice(o, a - o)) : 0, p = l - m;
    let h;
    return a < Dt ? h = `Só ${a} amostra(s) — o piso ainda não significa nada.` : d < 2 ? h = `${a} amostras, mas um único valor de heap: o navegador ainda não atualizou a leitura. Sem informação — precisa de sessão longa.` : s > ge && p > ge ? h = `Piso subiu ${(s / 1048576).toFixed(1)} MB e AINDA sobe (${(p / 1048576).toFixed(1)} MB no último terço) — isto é retenção.` : s > ge ? h = `Subiu ${(s / 1048576).toFixed(1)} MB desde a carga e estabilizou em ${(l / 1048576).toFixed(0)} MB — é custo de partida, não vazamento.` : h = `Piso estável em ${d} degraus — a variação do heap é coleta de lixo, não vazamento.`, {
      amostras: a,
      ...t ? { primeira: t } : {},
      ...i ? { ultima: i } : {},
  ...
  leituraDeTarefas(e) {
    const t = this.tarefasTotal - this.tarefasNaCarga, i = Math.max(0, e - je) / 6e4;
    return {
  ...
  instantaneo(e) {
    const i = [...this.componentes.values()].sort(
      ...
      render: { ...l.render },
      motivos: [...l.motivos.entries()].map(([s, d]) => ({ motivo: s, total: d })).sort((s, d) => d.total - s.total).slice(0, It),
      timers: { ...l.timers },
...
const y = new Pt(), Lt = 5e3, W = { timerMemoria: void 0, observador: void 0 };
function Nt() {
  const r = performance;
  if (r.memory)
...
function jt(r) {
  if (W.timerMemoria !== void 0 || W.observador !== void 0) return;
  y.iniciar(performance.now(), r);
  const e = () => {
    const t = Nt();
    t && y.memoriaAmostrada({ em: Math.round(performance.now()), ...t });
  };
  if (e(), W.timerMemoria = window.setInterval(e, Lt), "PerformanceObserver" in window)
    try {
      ...
      t.observe({ entryTypes: ["longtask"] }), W.observador = t;
    } catch {
    }
}
function Rt() {
  return W.timerMemoria !== void 0;
}
const Q = /* @__PURE__ */ new Map();
function F(r, e, t) {
  const i = window.setTimeout(() => {
    Q.delete(i), y.timerEncerrado(r), e();
  }, t);
  return Q.set(i, "espera"), y.timerCriado(r), i;
}
function L(r, e) {
  if (e === void 0) return;
  const t = Q.get(e);
  t !== void 0 && (t === "intervalo" ? window.clearInterval(e) : window.clearTimeout(e), Q.delete(e), y.timerEncerrado(r));
}
function Vt() {
  return Q.size;
}
function fe(r, e, t, i, a) {
  e.addEventListener(t, i, a), y.listenerCriado(r);
}
function ve(r, e, t, i, a) {
  e.removeEventListener(t, i, a), y.listenerEncerrado(r);
}
function G(r, e, t) {
  y.requisicao(r, e, t);
}
...
function Ce(r, e, t) {
  ...
  try {
    ...
    y.renderizou(r, performance.now() - i, t);
  }
}
function st() {
...
function se() {
  return { ...y.instantaneo(performance.now()), timersVivos: Vt() };
}
function Ft() {
  if (Rt()) return;
  jt(Ut());
  const r = {
    instantaneo: se,
    texto: () => JSON.stringify(se(), null, 2),
    zerar: () => y.zerar(),
    marcar: st,
    limparMarca: Bt
  };
 ...
 */
const ne = globalThis, Me = ne.ShadowRoot && (ne.ShadyCSS === void 0 || ne.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ee = Symbol(), Re = /* @__PURE__ */ new WeakMap();
let lt = class {
  constructor(e, t, i) {
...
const Gt = (r) => new lt(typeof r == "string" ? r : r + "", void 0, Ee), _ = (r, ...e) => {
...
}, Ve = Me ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Yt, defineProperty: Zt, getOwnPropertyDescriptor: Wt, getOwnPropertyNames: Xt, getOwnPropertySymbols: Qt, getPrototypeOf: Jt } = Object, ue = globalThis, Be = ue.trustedTypes, Kt = Be ? Be.emptyScript : "", ei = ue.reactiveElementPolyfillSupport, X = (r, e) => r, qe = { toAttribute(r, e) {
  switch (e) {
    case Boolean:
      r = r ? Kt : null;
      break;
  ...
  return t;
} }, ct = (r, e) => !Yt(r, e), Ue = { attribute: !0, type: String, converter: qe, reflect: !1, useDefault: !1, hasChanged: ct };
...
let N = class extends HTMLElement {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const a of i) t.unshift(Ve(a));
  ...
  _$AK(e, t) {
    ...
    if (a !== void 0 && this._$Em !== a) {
      const o = i.getPropertyOptions(a), n = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : qe;
      this._$Em = a;
  ...
  requestUpdate(e, t, i, a = !1, o) {
    if (e !== void 0) {
      ...
      if (a === !1 && (o = this[e]), i ??= n.getPropertyOptions(e), !((i.hasChanged ?? ct)(o, t) || i.useDefault && i.reflect && o === this._$Ej?.get(e) && !this.hasAttribute(n._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
N.elementStyles = [], N.shadowRootOptions = { mode: "open" }, N[X("elementProperties")] = /* @__PURE__ */ new Map(), N[X("finalized")] = /* @__PURE__ */ new Map(), ei?.({ ReactiveElement: N }), (ue.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Te = globalThis, Fe = (r) => r, le = Te.trustedTypes, Ge = le ? le.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, dt = "$lit$", E = `lit$${Math.random().toFixed(9).slice(2)}$`, pt = "?" + E, ti = `<${pt}>`, P = document, J = () => P.createComment(""), K = (r) => r === null || typeof r != "object" && typeof r != "function", Ie = Array.isArray, ii = (r) => Ie(r) || typeof r?.[Symbol.iterator] == "function", xe = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, He = /-->/g, Ye = />/g, T = RegExp(`>|${xe}(?:([^\\s"'>=/]+)(${xe}*=${xe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ze = /'/g, We = /"/g, mt = /^(?:script|style|textarea|title)$/i, ut = (r) => (e, ...t) => ({ _$litType$: r, strings: e, values: t }), c = ut(1), _e = ut(2), R = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), Xe = /* @__PURE__ */ new WeakMap(), D = P.createTreeWalker(P, 129);
function ht(r, e) {
...
const ai = (r, e) => {
  ...
  for (let l = 0; l < t; l++) {
    const s = r[l];
    let d, m, p = -1, h = 0;
    for (; h < s.length && (n.lastIndex = h, m = n.exec(s), m !== null); ) h = n.lastIndex, n === H ? m[1] === "!--" ? n = He : m[1] !== void 0 ? n = Ye : m[2] !== void 0 ? (mt.test(m[2]) && (a = RegExp("</" + m[2], "g")), n = T) : m[3] !== void 0 && (n = T) : n === T ? m[0] === ">" ? (n = a ?? H, p = -1) : m[1] === void 0 ? p = -2 : (p = n.lastIndex - m[2].length, d = m[1], n = m[3] === void 0 ? T : m[3] === '"' ? We : Ze) : n === We || n === Ze ? n = T : n === He || n === Ye ? n = H : (n = T, a = void 0);
    const b = n === T && r[l + 1].startsWith("/>") ? " " : "";
    o += n === H ? s + ti : p >= 0 ? (i.push(d), s.slice(0, p) + dt + s.slice(p) + E + b) : s + E + (p === -2 ? l : b);
  }
  return [ht(r, o + (r[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class ee {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    if (this.el = ee.createElement(d, i), D.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (a = D.nextNode()) !== null && s.length < l; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const p of a.getAttributeNames()) if (p.endsWith(dt)) {
          ...
          s.push({ type: 1, index: o, name: f[2], strings: b, ctor: f[1] === "." ? ri : f[1] === "?" ? ni : f[1] === "@" ? si : he }), a.removeAttribute(p);
        ...
        if (mt.test(a.tagName)) {
          ...
          if (h > 0) {
            ...
            for (let b = 0; b < h; b++) a.append(p[b], J()), D.nextNode(), s.push({ type: 2, index: ++o });
            a.append(p[h], J());
          }
        }
      } else if (a.nodeType === 8) if (a.data === pt) s.push({ type: 2, index: o });
      else {
        let p = -1;
...
function V(r, e, t = r, i) {
  ...
  return a?.constructor !== o && (a?._$AO?.(!1), o === void 0 ? a = void 0 : (a = new o(r), a._$AT(r, t, i)), i !== void 0 ? (t._$Co ??= [])[i] = a : t._$Cl = a), a !== void 0 && (e = V(r, a._$AS(r, e.values), a, i)), e;
}
class oi {
  constructor(e, t) {
  ...
  u(e) {
    ...
    for (; s !== void 0; ) {
      if (n === s.index) {
        let d;
        s.type === 2 ? d = new te(o, o.nextSibling, this, e) : s.type === 1 ? d = new s.ctor(o, s.name, s.strings, this, e) : s.type === 6 && (d = new li(o, this, e)), this._$AV.push(d), s = i[++l];
      }
...
class te {
  ...
  _$AI(e, t = this) {
    e = V(this, e, t), K(e) ? e === u || e == null || e === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : e !== this._$AH && e !== R && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ii(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    const { values: t, _$litType$: i } = e, a = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = ee.createElement(ht(i.h, i.h[0]), this.options)), i);
  ...
  _$AC(e) {
    ...
    return t === void 0 && Xe.set(e.strings, t = new ee(e)), t;
  }
  k(e) {
    Ie(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let i, a = 0;
    for (const o of e) a === t.length ? t.push(i = new te(this.O(J()), this.O(J()), this, this.options)) : i = t[a], i._$AI(o), a++;
...
class he {
  ...
  _$AI(e, t = this, i, a) {
    ...
    let n = !1;
    if (o === void 0) e = V(this, e, t, 0), n = !K(e) || e !== this._$AH && e !== R, n && (this._$AH = e);
    else {
      const l = e;
      let s, d;
      for (e = o[0], s = 0; s < o.length - 1; s++) d = V(this, l[i + s], t, s), d === R && (d = this._$AH[s]), n ||= !K(d) || d !== this._$AH[s], d === u ? e = u : e !== u && (e += (d ?? "") + o[s + 1]), this._$AH[s] = d;
    }
    n && !a && this.j(e);
  }
  j(e) {
...
const ci = Te.litHtmlPolyfillSupport;
ci?.(ee, te), (Te.litHtmlVersions ??= []).push("3.3.3");
const di = (r, e, t) => {
  const i = t?.renderBefore ?? e;
  let a = i._$litPart$;
  if (a === void 0) {
    const o = t?.renderBefore ?? null;
    i._$litPart$ = a = new te(e.insertBefore(J(), o), o, void 0, t ?? {});
  }
  return a._$AI(r), a;
};
/**
...
`, mi = "media_player.spotifyplus_bruno_helasio", Y = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], re = ["playing", "paused", "on"], Oe = [
  {
    id: "sala",
    name: "Sala",
    section: "sala",
...
async function wi(r) {
  ...
  return {
    ...
    cameras: i,
    resumo: a,
    veredito: ft(a, i.length, e.streamCarregado)
  };
}
function bt(r) {
  const e = {
...
class yi extends A {
   ...
   */
  _runtime() {
    const e = se(), t = (s) => (s / 1048576).toFixed(1) + " MB", i = (s) => s.toFixed(1) + " ms", a = e.vazamentos, o = a.timers + a.listeners + a.assinaturas, n = e.desdeAMarca, l = n ? n.instancias + n.timers + n.listeners + n.assinaturas : 0;
    return c`
      <div>
        <h2>Runtime</h2>
        <dl>
  ...
  _cameras() {
    ...
    const e = this._sondaProfunda ?? bt(this._hass);
  ...
  async _copiarBaseline() {
    const e = JSON.stringify(se(), null, 2);
    try {
...
ce.customCards.some((r) => r.type === "bruno-diagnostics") || ce.customCards.push({
...
function Qe(r, e, t = ["on", "home", "active", "yes"]) {
  if (!e) return !1;
  const i = r.states[e];
...
const vt = ["playing", "paused"];
function xt(r, e, t) {
  return !r || !vt.includes(String(r.state).toLowerCase()) ? !1 : Ai(r.attributes, e) ? !0 : Ci(r.attributes, t);
}
function Ci(r, e) {
  if (!e || !vt.includes(String(e.state).toLowerCase())) return !1;
...
const we = "bruno-room-tile", Di = 1200, Oi = 560, et = 10;
function tt() {
  return {
    pointerId: null,
    down: !1,
...
class Pi extends A {
  constructor() {
    super(...arguments), this._lastAction = 0, this._observador = new Pe(), this._motivo = "", this._gestures = {
      room: tt(),
      nav: tt()
  ...
  set hass(e) {
    ...
    t.length !== 0 && (this._motivo = Le(t), this.requestUpdate());
  }
  _watched() {
  ...
  connectedCallback() {
    super.connectedCallback(), Se(we), this._tileModeCache = void 0, globalThis.addEventListener?.("bruno-theme-changed", this._onThemeChanged);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Ae(we), globalThis.removeEventListener?.("bruno-theme-changed", this._onThemeChanged);
  ...
  _onMove(e, t) {
    ...
    a <= et && o <= et || (i.moved = !0, i.holdTimer !== null && (window.clearTimeout(i.holdTimer), this._timers.delete(i.holdTimer), i.holdTimer = null), this._classe(this._alvoSeletor(e), "is-pressed", !1));
  }
  _onUp(e, t) {
    const i = this._gestures[e];
  ...
  _alternarLuzDoPainel(e) {
    this._hass && (ye("tap"), this._hass.callService("light", "toggle", { entity_id: e }, { entity_id: e }));
  }
  // ── Modelo ───────────────────────────────────────────────────────────────
  _dots() {
    ...
    const i = t.activeSensor ? e.states[t.activeSensor] : void 0, a = (o) => {
      ...
      }), s = o.activeAttr ? it(i?.attributes[o.activeAttr]) : !1, d = o.spotifyDevice ? xt(e.states[mi], o.spotifyDevice) : !1;
      return l || s || d;
    };
  ...
  _statusLines() {
    ...
    i.label ? o.push(i.label) : Qe(e, t.entities.lightGroup) && o.push("On");
  ...
  _applianceLine() {
    ...
    if (!(!!n && o.includes(String(n?.state ?? "").toLowerCase()) || (i.activeAttr ? it(a?.attributes[i.activeAttr]) : !1))) return "";
  ...
  render() {
    ...
    if (!e) return u;
    const i = t ? Qe(t, e.entities.lightGroup ?? e.entities.lights?.[0]) : !1, a = t ? Je(t, e.entities.temperature, "°") : "--", o = t ? Je(t, e.entities.humidity, "%") : "--", n = !!(e.entities.temperature ?? e.entities.humidity), l = this._statusLines(), s = this._dots(), d = "20260808-maquetes-premium-1", m = e.assetOff ? `/local/bruno-ui/assets/${e.assetOff}.png?v=${d}` : "", p = e.assetOn ? `/local/bruno-ui/assets/${e.assetOn}.png?v=${d}` : "", h = [
      "room-card",
      i ? "is-room-on" : "",
            ...
            >
              <section class="room-popup-panel" role="document" @click=${(g) => g.stopPropagation()}>
                ...
                <div class="room-popup-lights">
                  ${v.lights.map((g) => {
      const S = t?.states[g.entity], B = String(S?.state ?? "").toLowerCase(), U = B === "on", ie = !S || ["unavailable", "unknown", "none", ""].includes(B), w = [
        "room-popup-light",
        U ? "is-on" : "",
        ie ? "is-unavailable" : ""
      ].filter(Boolean).join(" ");
      return c`<button
                    ...
                    >
                      ...
                      <span class="room-popup-light-copy">
                        ...
                        <span>${ie ? "Indisponivel" : U ? "Ligada" : "Desligada"}</span>
                      </span>
                    </button>`;
    })}
                </div>
...
de.customCards.some((r) => r.type === "bruno-room-tile") || de.customCards.push({
...
}, j = /* @__PURE__ */ new Set(), O = { timer: void 0, ouvindoVisibilidade: !1 }, Ni = 1e3;
function _t() {
  for (const r of [...j])
    try {
      r();
...
function yt() {
  O.timer !== void 0 || j.size === 0 || wt() || (O.timer = globalThis.setInterval(_t, Ni));
}
function kt() {
...
const $t = {
  ...
  principal: 1500,
  secundaria: 3e3
}, Ui = 25e3, Fi = 300, Gi = 6e4, Hi = 12e3, at = { comImagem: 2, semImagem: 4 };
function Yi(r, e) {
...
class zt {
  ...
  agendarProximo(e, t) {
    ...
    let a = Math.max(Bi[i], $t[i] - t);
    const o = e.quadros === 0, n = o ? at.semImagem : at.comImagem, l = o ? Hi : Gi;
...
const ca = ["on", "playing", "paused", "idle"], da = ["playing", "paused", "on", "idle"], pa = ["streaming", "recording", "idle", "on"], ma = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], ua = ["cooling", "heating", "drying", "fan", "preheating"], ha = ["off", "idle"], ga = 4e3, ba = 1e4, fa = "/local/bruno-ui/assets/tcl-qled-mini-led-75.png?v=20260802-assets-resize-1", va = "/local/images/echo_pop.png?v=20260702-all-images-1", xa = "/local/images/office_pc.png?v=20260702-all-images-1";
function Z(r, e = 0) {
  const t = Number(r);
...
class _a extends A {
  constructor() {
    super(...arguments), this._lightsOpen = !1, this._fonteMidia = "", this._midiaAtivasAntes = [], this._menuMidiaAberto = !1, this._spotifyFerramentas = !1, this._painelClima = "", this._controlesCameraAbertos = !1, this._cameraAtiva = "", this._urlsCarregadas = {}, this._ultimaImagem = {}, this._motorCameras = new zt({
      ...
      aoMedir: (e, t, i, a) => {
        const o = e.split(".")[1] ?? e;
        G(`câmera ${o}`, t, i === "ok"), a && G(`câmera ${o} · 1º quadro`, t, !0);
      }
    }), this._liveEntity = "", this._livePronto = "", this._liveIniciadoEm = 0, this._aoVivoSuspenso = !1, this._observador = new Pe(), this._motivo = "", this._ultimoMinuto = "", this._ouvindoVisibilidade = !1, this._aoMudarVisibilidade = () => {
      if (this.isConnected) {
        if (document.visibilityState === "hidden") {
          this._pararTimerCameras(), this._pararAoVivo();
          return;
        }
        this._atualizarCameras(), this._iniciarTimerCameras(), this._aoVivoSuspenso = !1, this._sincronizarCameras();
      }
    }, this._modoPlayer = "nenhum", this._aoCarregarAoVivo = () => {
      const e = this._liveEl, t = this._liveEntity;
      if (!e || !t || !this.isConnected) return;
      const i = e.shadowRoot?.querySelector("video");
      if (!i || i.readyState < 2 || this._livePronto === t) return;
      this._livePronto = t, e.classList.add("is-ready"), L(x, this._timerAoVivo), this._timerAoVivo = void 0;
      const a = t.split(".")[1] ?? t;
      G(
        `marco: ${a} · player ${this._modoPlayer} · primeiro quadro`,
  ...
  update(e) {
    const t = this._motivo;
    this._motivo = "", Ce(x, () => super.update(e), t || this._motivoPadrao());
  }
  _motivoPadrao() {
  ...
  connectedCallback() {
    super.connectedCallback(), Se(x), this._aoVivoSuspenso = !1, this._montadoEm = performance.now(), this._quadrosNaTela.clear(), this._socorros.clear(), this._aplicarAtributos();
    const e = globalThis;
    e.BrunoLiquidGlass?.apply?.(), e.BrunoSurfaceMaterial?.connect?.(this), this._injetarMaterial(), this._iniciarTimerCameras(), this._armarVigiaDeCameras(), this._iniciarTimerRelogio(), !this._ouvindoVisibilidade && typeof document < "u" && (fe(x, document, "visibilitychange", this._aoMudarVisibilidade), this._ouvindoVisibilidade = !0);
  }
  /**
  ...
  _iniciarTimerRelogio() {
    this._cancelarRelogio || (this._cancelarRelogio = Vi(() => {
      const e = this._hora();
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), Ae(x), globalThis.BrunoSurfaceMaterial?.disconnect?.(this), this._pararTimerCameras(), this._pararAoVivo(), this._timerLuzes && (L(x, this._timerLuzes), this._timerLuzes = void 0), this._pararTimerRelogio(), this._ouvindoVisibilidade && (ve(x, document, "visibilitychange", this._aoMudarVisibilidade), this._ouvindoVisibilidade = !1);
  }
  /**
  ...
  _cuidarDoAoVivo(e) {
    ...
    if (!this._liveEl || this._liveEntity !== t) {
      ...
      if (!o) {
        this._aoVivoSuspenso = !0;
        return;
      }
      this._liveEl = o, this._liveEntity = t, this._liveIniciadoEm = performance.now(), fe(x, o, "load", this._aoCarregarAoVivo), fe(x, o, "streams", this._aoInformarStreams), i.appendChild(o), o.entityid = t, this._armarPrazoAoVivo(o, t);
      return;
    }
    const a = this._liveEl;
    a.parentElement !== i && i.appendChild(a), a.entityid !== t && (a.entityid = t);
  }
  /**
  ...
  _criarPlayer() {
    if (customElements.get("ha-web-rtc-player")) {
      const e = document.createElement("ha-web-rtc-player");
  ...
  _armarPrazoAoVivo(e, t) {
    L(x, this._timerAoVivo), this._timerAoVivo = F(x, () => {
      this._timerAoVivo = void 0, !(this._liveEl !== e || this._liveEntity !== t || this._livePronto === t) && this._falharAoVivo("prazo");
    }, ba);
  }
  _falharAoVivo(e) {
    const t = this._liveEntity;
    if (!t) return;
    const i = t.split(".")[1] ?? t;
    G(
      ...
      performance.now() - this._liveIniciadoEm,
      !1
    ), this._aoVivoSuspenso = !0, this._pararAoVivo(), this._sincronizarCameras();
  }
  _pararAoVivo() {
    L(x, this._timerAoVivo), this._timerAoVivo = void 0;
    const e = this._liveEl;
    e && (ve(x, e, "load", this._aoCarregarAoVivo), ve(x, e, "streams", this._aoInformarStreams), e.remove()), this._liveEl = void 0, this._liveEntity = "", this._livePronto = "", this._modoPlayer = "nenhum";
  }
  /**
  ...
  _marcarQuadroNaTela(e) {
    ...
    const t = e.split(".")[1] ?? e;
    G(`câmera ${t} · até aparecer`, performance.now() - this._montadoEm, !0);
  }
  /**
  ...
  _injetarMaterial(e = 0) {
    ...
    if (!a) {
      e < 20 && F(x, () => this._injetarMaterial(e + 1), 60);
      return;
    }
    try {
  ...
  _valorSensor(e, t, i = 0) {
    ...
    return !a || ["unknown", "unavailable", "none", ""].includes(o) ? "--" : `${Z(a.state, i)}${t}`;
  }
   ...
   */
  _alternarDock() {
    this._lightsOpen = !this._lightsOpen, this._luzesAssentadas = !1, L(x, this._timerLuzes), this._timerLuzes = F(x, () => {
  ...
  _modeloSpotify() {
    const e = this._estado(this._idDe("spotify")), t = e?.attributes ?? {}, i = e?.state ?? "off", o = da.includes(i) && xt(
      e,
  ...
  _maisInfo(e) {
    e && (ke(e) && (this._aoVivoSuspenso = !0, this._pararAoVivo(), this._sincronizarCameras()), this.dispatchEvent(
  ...
  _rotuloVentilacao(e) {
    ...
    return t === "auto" ? "Auto" : t.includes("low") || t.includes("baixo") ? "Baixa" : t.includes("med") ? "Média" : t.includes("high") || t.includes("alto") ? "Alta" : t.includes("fort") ? "Forte" : $e(e);
  }
  _iconeVentilacao(e) {
    const t = String(e).toLowerCase();
  ...
  _rotuloSwing(e) {
    const t = String(e).toLowerCase();
    return t ? ["off", "desativado", "desativada", "disabled"].includes(t) ? "Desligado" : ["on", "ativo", "ativada", "enabled"].includes(t) ? "Ativo" : $e(e) : "Indisponível";
  }
  /**
  ...
  _renderAnelClimate(e) {
    const s = Number.isFinite(e.minima) ? e.minima : 12, d = Number.isFinite(e.maxima) ? e.maxima : 30, m = Number.isFinite(Number(e.alvo)) ? Math.max(s, Math.min(d, Number(e.alvo))) : s + (d - s) / 2, h = -180 + 180 * Math.max(0, Math.min(1, (m - s) / Math.max(1, d - s))), b = (w, k) => {
      const $ = k * Math.PI / 180;
      return { x: 360 + w * Math.cos($), y: 410 + w * Math.sin($) };
    }, f = (w, k, $) => {
      const C = b(w, k), M = b(w, $), ae = Math.abs($ - k) <= 180 ? "0" : "1";
      return `M ${C.x.toFixed(3)} ${C.y.toFixed(3)} A ${w} ${w} 0 ${ae} 1 ${M.x.toFixed(3)} ${M.y.toFixed(3)}`;
    }, v = Array.from({ length: 91 }, (w, k) => {
      const $ = -180 + 180 * (k / 90), C = k % 15 === 0, M = k % 5 === 0, ae = b(319, $), Ne = b(C ? 293 : M ? 299 : 306, $), At = C ? "icg-tick major" : M ? "icg-tick medium" : "icg-tick minor";
      return _e`<line x1=${ae.x.toFixed(3)} y1=${ae.y.toFixed(3)} x2=${Ne.x.toFixed(3)} y2=${Ne.y.toFixed(3)} class=${At}></line>`;
    }), q = Array.from({ length: 73 }, (w, k) => {
      const $ = -180 + 180 * (k / 72), C = b(267, $), M = b(251, $);
      return _e`<line x1=${C.x.toFixed(3)} y1=${C.y.toFixed(3)} x2=${M.x.toFixed(3)} y2=${M.y.toFixed(3)} class="icg-inner-tick"></line>`;
    }), g = [
      { texto: `${Z(s, 0)}°`, ang: -180, r: 337, cls: "edge" },
      { texto: "10", ang: -148, r: 343, cls: "" },
      { texto: "20", ang: -90, r: 337, cls: "top" },
      { texto: "25", ang: -32, r: 343, cls: "" },
      { texto: `${Z(d, 0)}°`, ang: 0, r: 337, cls: "edge" }
    ].map((w) => {
      const k = b(w.r, w.ang);
      return _e`<text x=${k.x.toFixed(3)} y=${k.y.toFixed(3)} text-anchor="middle" dominant-baseline="middle" class=${`icg-label ${w.cls}`}>${w.texto}</text>`;
    }), S = b(285, h), B = e.alvo == null ? "--" : Z(e.alvo, 0), U = e.atual == null ? "--" : Z(e.atual, 1), ie = (e.modo === "cool" ? "Resfriamento" : e.modo === "heat" ? "Aquecimento" : e.modo === "fan_only" ? "Ventilacao" : "Temperatura").toUpperCase();
    return c`
      <div class="icg-root">
        <div class="icg-shell">
          <svg
            ...
            viewBox="0 0 720 460"
            role="img"
            aria-label=${`Temperatura alvo ${B}°. Ambiente ${U}°.`}
          >
            <defs>
...
pe.customCards.some((r) => r.type === "bruno-room-subview") || pe.customCards.push({
...
class me extends A {
  ...
  get _entityId() {
    return qt(this._instancia?.entity, this._hass);
  }
  _estado(e) {
    return e && this._hass ? this._hass.states[e] : void 0;
  }
...
z.conhece("climate") || z.registrar({
  ...
  icon: "mdi:air-conditioner",
  create: St("bruno-control-climate"),
  entities: (r) => [typeof r.entity == "string" ? r.entity : r.entity?.[0] ?? ""].filter(Boolean),
  validate: (r) => ({
    ok: !!r.entity,
...
const ze = "bruno-devices-panel", Ca = ["on", "playing", "paused", "idle", "buffering", "cool", "heat", "fan_only", "dry", "heat_cool", "auto"];
class Ma extends A {
  constructor() {
    super(...arguments), this._selecionado = "", this._controles = /* @__PURE__ */ new Map(), this._observador = new Pe(
      nt.flatMap((e) => rt(e))
    ), this._motivo = "";
  }
  static {
  ...
  _estaAtivo(e) {
    const t = qt(e.entity, this._hass), i = t && this._hass ? this._hass.states[t] : void 0;
  ...
  connectedCallback() {
    super.connectedCallback(), Se(ze);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Ae(ze);
  }
  /** Mede o custo de cada atualizacao (Fase 6.0.1). */
  update(e) {
    const t = this._motivo;
    this._motivo = "", Ce(ze, () => super.update(e), t || "outro");
  }
  render() {
  ...
  entidadesObservadas() {
    return [...new Set(this._dispositivos.flatMap((e) => rt(e)))];
  }
  static {
    this.styles = _`
...
globalThis.BrunoCameraEngine = zt;
//# sourceMappingURL=bruno-dashboard.CGjx5MeV.js.map
