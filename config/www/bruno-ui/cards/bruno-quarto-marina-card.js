...
const BRUNO_QUARTO_MARINA_DEFAULT_CONFIG = {
  ...
  "icon": {
    "off": "/local/bruno-ui/assets/marina-bedroom-off.png?v=20260608-room-assets-uniform-1",
    "on": "/local/bruno-ui/assets/marina-bedroom-on.png?v=20260608-room-assets-uniform-1",
