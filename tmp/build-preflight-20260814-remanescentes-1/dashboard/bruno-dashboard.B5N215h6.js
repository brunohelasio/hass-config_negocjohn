 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Na = globalThis, Wa = (r) => r, ma = Na.trustedTypes, Za = ma ? ma.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, be = "$lit$", T = `lit$${Math.random().toFixed(9).slice(2)}$`, fe = "?" + T, li = `<${fe}>`, j = document, aa = () => j.createComment(""), ea = (r) => r === null || typeof r != "object" && typeof r != "function", Pa = Array.isArray, di = (r) => Pa(r) || typeof r?.[Symbol.iterator] == "function", wa = `[ 	
\f\r]`, Q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ja = /-->/g, Ka = />/g, D = RegExp(`>|${wa}(?:([^\\s"'>=/]+)(${wa}*=${wa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ae = /'/g, ee = /"/g, xe = /^(?:script|style|textarea|title)$/i, ve = (r) => (a, ...e) => ({ _$litType$: r, strings: a, values: e }), l = ve(1), ya = ve(2), G = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), ie = /* @__PURE__ */ new WeakMap(), N = j.createTreeWalker(j, 129);
function _e(r, a) {
...
const pi = (r, a) => {
  ...
  for (let c = 0; c < e; c++) {
    ...
    t += n === Q ? s + li : p >= 0 ? (i.push(d), s.slice(0, p) + be + s.slice(p) + T + b) : s + T + (p === -2 ? c : b);
  }
...
class ia {
  constructor({ strings: a, _$litType$: e }, i) {
    ...
    if (this.el = ia.createElement(d, i), N.currentNode = this.el.content, e === 2 || e === 3) {
      const p = this.el.content.firstChild;
      p.replaceWith(...p.childNodes);
    }
    for (; (o = N.nextNode()) !== null && s.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const p of o.getAttributeNames()) if (p.endsWith(be)) {
          const h = m[n++], b = o.getAttribute(p).split(T), f = /([.?@])?(.*)/.exec(h);
          s.push({ type: 1, index: t, name: f[2], strings: b, ctor: f[1] === "." ? ui : f[1] === "?" ? hi : f[1] === "@" ? gi : xa }), o.removeAttribute(p);
        } else p.startsWith(T) && (s.push({ type: 6, index: t }), o.removeAttribute(p));
        if (xe.test(o.tagName)) {
          const p = o.textContent.split(T), h = p.length - 1;
          if (h > 0) {
            o.textContent = ma ? ma.emptyScript : "";
            for (let b = 0; b < h; b++) o.append(p[b], aa()), N.nextNode(), s.push({ type: 2, index: ++t });
            o.append(p[h], aa());
          }
        }
        ...
        let p = -1;
        for (; (p = o.data.indexOf(T, p + 1)) !== -1; ) s.push({ type: 7, index: t }), p += T.length - 1;
      }
      t++;
    }
  }
...
class mi {
  ...
  u(a) {
    ...
    N.currentNode = o;
    let t = N.nextNode(), n = 0, c = 0, s = i[0];
    for (; s !== void 0; ) {
      if (n === s.index) {
        let d;
...
const fi = Na.litHtmlPolyfillSupport;
fi?.(ia, oa), (Na.litHtmlVersions ??= []).push("3.3.3");
const xi = (r, a, e) => {
...
class Ei extends C {
  constructor() {
    super(...arguments), this._env = $i(), this._sondando = !1, this._mensagem = "";
  }
  static {
    this.properties = {
      _hass: { state: !0 }
  ...
  render() {
    const a = this._env, e = ki(this._hass), i = e.issues.filter((n) => n.problem === "missing"), o = e.issues.filter((n) => n.problem === "unavailable"), t = zi(this._hass);
    return l`
      <div class="card">
        <div>
          <h2>Diagnóstico</h2>
...
function ze(r, a, e) {
  return !r || !ke.includes(String(r.state).toLowerCase()) ? !1 : Ri(r.attributes, a) ? !0 : Ni(r.attributes, e);
}
function Ni(r, a) {
  ...
  const o = r ?? {}, t = R(e.media_title), n = R(o.media_title);
  if (t && n && t === n) return !0;
  const c = R(e.media_artist), s = R(o.media_artist);
  return !!(t && n && t.includes(n) && c && s && c === s);
}
const Pi = "∅", Li = (r) => r ? `${r.state}@${r.last_changed}` : Pi;
class Va {
  constructor(a = [], e = {}) {
...
class Ui extends C {
  ...
  _dots() {
    ...
    const i = e.activeSensor ? a.states[e.activeSensor] : void 0, o = (t) => {
      ...
      }), s = t.activeAttr ? ce(i?.attributes[t.activeAttr]) : !1, d = t.spotifyDevice ? ze(a.states[_i], t.spotifyDevice) : !1;
      return c || s || d;
    };
...
function Se() {
  L.timer !== void 0 || U.size === 0 || Ae() || (L.timer = globalThis.setInterval($e, Hi));
}
function Ce() {
...
const I = "ha-web-rtc-player", Wi = 6e3, za = 48, $a = 27;
let Aa;
function Zi(r) {
  return r.split(".")[1] ?? r;
}
function P(r, a, e = 0, i = !0) {
...
async function Ee(r, a) {
  ...
  P(r, "ausente; carregando modulo", 0, !1), Aa ??= Ki(r, a).finally(() => {
    Aa = void 0;
  });
  const i = await Aa, o = typeof performance < "u" ? performance.now() : Date.now();
  return P(r, i ? "definido sob demanda" : "definicao indisponivel", o - e, i), i;
}
function Me() {
...
function Ba(r) {
  ...
  try {
    ...
    return e ? (e.drawImage(r, 0, 0, za, $a), ao(
...
const zo = ["on", "playing", "paused", "idle"], $o = ["playing", "paused", "on", "idle"], Ao = ["streaming", "recording", "idle", "on"], So = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], Co = ["cooling", "heating", "drying", "fan", "preheating"], Eo = ["off", "idle"], Mo = 4e3, Oo = 3e4, To = 700, Io = "/local/bruno-ui/assets/tcl-qled-mini-led-75.png?v=20260802-assets-resize-1", Do = "/local/images/echo_pop.png?v=20260702-all-images-1", Ro = "/local/images/office_pc.png?v=20260702-all-images-1";
function V(r, a = 0) {
  const e = Number(r);
...
class No extends C {
  ...
  _aplicarAtributos() {
    ...
    i("data-appliances", !!(e?.appliances ?? e?.dishwasher)), i("data-tvhub", !!e?.tv), this._folha ? this.setAttribute("data-folha", this._folha) : this.removeAttribute("data-folha"), this._folhaSaindo ? this.setAttribute("data-folha-saindo", "") : this.removeAttribute("data-folha-saindo"), i("data-ps5", !!e?.ps5);
  }
  ...
  _sincronizarLimiteFolhaTelefone() {
    ...
    const a = this.renderRoot.querySelector(".curtain-dock"), e = this.renderRoot.querySelector(".cameras-card"), i = a?.getBoundingClientRect().top ?? (e?.getBoundingClientRect().bottom ?? 0) + 8;
    if (!Number.isFinite(i) || i <= 0) return;
    const o = `${Math.round(i)}px`;
    this.style.getPropertyValue("--fone-folha-top") !== o && this.style.setProperty("--fone-folha-top", o);
  }
  /**
  ...
  _sincronizarAlturaLuzesTelefone() {
    ...
    const e = this.renderRoot.querySelector(".lights-scroll"), i = [...this.renderRoot.querySelectorAll(".light-grid")];
    if (!e || !i.length || e.clientHeight <= 0) return;
    let o = 0, t = 0, n = 0;
    for (const p of i) {
      const h = p.querySelectorAll(".light-cell").length, b = Math.ceil(h / 2);
      if (!b) continue;
      const f = Number.parseFloat(getComputedStyle(p).rowGap) || 0;
      o += b, t += p.getBoundingClientRect().height, n += Math.max(0, b - 1) * f;
    }
    if (!o) return;
    const c = Math.max(0, e.scrollHeight - t), s = (e.clientHeight - c - n - 2) / o, d = Math.floor(Math.max(56, Math.min(60, s)) * 10) / 10;
   ...
   */
  _renderHero() {
    const a = this._entidadeCortina(), e = this._estado(a), i = this._indisponivel(e), o = ["opening", "closing"].includes(String(e?.state));
    return l`
      ...
      ([t, n, c]) => l`
                      <button
                        type="button"
                        class="curtain-action-button ${t === "cover-stop" ? "is-muted" : ""} ${t === "cover-stop" && o ? "is-active" : ""}"
                        data-action=${t}
                        ?disabled=${i}
  ...
  _modeloTv() {
    const a = this._estado(this._idDe("tv")), e = a?.attributes ?? {}, i = a?.state ?? "off", o = zo.includes(i), t = String(e.source ?? e.app_name ?? "") || "HDMI 1", n = String(e.media_title ?? e.media_series_title ?? e.app_name ?? "");
    return {
      st: a,
      estado: i,
      ativo: o,
  ...
  _modeloSpotify() {
    const a = this._estado(this._idDe("spotify")), e = a?.attributes ?? {}, i = a?.state ?? "off", t = $o.includes(i) && ze(
      a,
  ...
  _corpoTv() {
    const a = this._modeloTv(), e = this._idDe("tv"), i = this._sub?.tvStandbyImage ?? Io, t = (!(!a.titulo || /^TV (ligada|desligada)$/i.test(a.titulo) || a.titulo === a.fonte) && a.estado === "playing" ? a.titulo : "") || a.fonte;
    if (!a.ativo)
      return l`
        <div class="mh-left">
  ...
  _corpoPc() {
    const a = this._modeloPc(), e = this._sub?.pcImage ?? Ro, i = a.ativo ? [a.sessao, a.janela].filter((t) => t && t !== "--")[0] || "Sessão ativa" : "Pronto para ligar", o = (t) => () => {
    ...
    return l`
      ...
      this._menuMidiaAberto = !this._menuMidiaAberto, this.requestUpdate();
        ...
        <div class="mh-sources">
          ${n.map((p) => {
      const h = p.chave === s, b = ["mh-source", h ? "is-open" : "", p.ativo ? "is-active" : ""].filter(Boolean).join(" "), f = [
        "mh-source-body",
      ...
      return l`
              <div class=${b}>
                ...
                ${h ? l`<div class=${f}>
                      ${this._estaNoTelefone() && p.atmosfera ? l`<img class="mh-now-atmosphere" src=${p.atmosfera} alt="" aria-hidden="true" />` : u}
                      ${p.corpo()}
                    </div>` : u}
              </div>
            `;
...
customElements.get("bruno-room-subview") || customElements.define("bruno-room-subview", No);
const ga = window;
...
function jo(r) {
  ...
  for (const [i, o] of r.entries()) {
    ...
    o.id ? e.has(o.id) ? a.push(`id repetido — "${o.id}"`) : e.add(o.id) : a.push(`dispositivo em ${t}: falta "id"`), o.type ? $.conhece(o.type) || a.push(`dispositivo "${t}": tipo não registrado — "${o.type}"`) : a.push(`dispositivo "${t}": falta "type"`), o.name || a.push(`dispositivo "${t}": falta "name"`);
    const n = $.obter(o.type)?.validate?.(o);
...
class Yo extends C {
  ...
  _estaAtivo(a) {
    const e = Ie(a.entity, this._hass), i = e && this._hass ? this._hass.states[e] : void 0;
          ...
          this._selecionado = o.id, this.requestUpdate();
                    ...
                    >
                      <span class="item-icone">
                        <bruno-icon icon=${o.icon ?? $.obter(o.type)?.icon ?? "mdi:remote"}></bruno-icon>
                      </span>
...
Je();
console.info("[bruno-dashboard] build 20260813");
globalThis.BrunoCameraEngine = Te;
globalThis.BrunoCameraLive = eo;
//# sourceMappingURL=bruno-dashboard.B5N215h6.js.map
