...
const BRUNO_LAVABO_DEFAULT_CONFIG = {
  ...
  "icon": {
    "off": "/local/bruno-ui/assets/lavabo-off.png?v=20260607-room-assets-contrast-1",
    "on": "/local/bruno-ui/assets/lavabo-on.png?v=20260607-room-assets-contrast-1",
    "fallback": "mdi:toilet"
  },
  "status_dots": [
    {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="room-card${roomActiveClass}" style="--room-icon-size:${iconSize}px;">
        <button class="room-action${hasMetricClass}" type="button" data-action-key="room" aria-label="${BrunoLavaboCard._escape(this._config.name)}">
          ...
          <div class="title">${BrunoLavaboCard._escape(this._config.name)}</div>
