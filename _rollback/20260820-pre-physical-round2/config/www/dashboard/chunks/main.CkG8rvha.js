const Oi = performance.timeOrigin || Date.now() - performance.now(), Ei = () => Math.round(performance.now()), be = () => ({
  at: Date.now(),
  sinceNavigation: Ei()
}), G = {
  version: 1,
  navigationStart: Math.round(Oi),
  moduleStart: be()
};
function Ci() {
...
function Pe() {
  Ci();
  try {
    globalThis.localStorage?.setItem("bruno-ui:last-boot-metrics", JSON.stringify(G));
  } catch {
  }
  globalThis.brunoBootMetrics = G;
}
customElements.whenDefined("bruno-shell").then(() => {
  G.shellDefined = be(), Pe();
});
const lt = () => {
  const o = document.querySelector("bruno-shell");
  o && !G.shellConnected && (G.shellConnected = be());
...
const $i = 720, Mi = 200, Ii = 24, Li = 4, Vt = 3e4, Ri = 12, Ze = 10 * 1024 * 1024, Ni = 64;
function Ke(o) {
...
class zi {
  ...
  de(e) {
    ...
    return t || (t = Ti(e), this.componentes.set(e, t)), t;
  }
  // ── Pontos de coleta ──────────────────────────────────────────────────────
  conectou(e) {
  ...
  renderizou(e, t, a) {
    ...
    const n = i.motivos.has(a) || i.motivos.size < Ii ? a : "outros";
  ...
  memoriaAmostrada(e) {
    this.memoria.push(e), this.memoria.length > $i && this.memoria.shift(), e.usado < this.pisoGlobal && (this.pisoGlobal = e.usado), e.usado > this.picoGlobal && (this.picoGlobal = e.usado), this.valoresDeMemoria.size < Ni && this.valoresDeMemoria.add(e.usado);
  }
  tarefaLonga(e) {
    this.tarefas.push(e), this.tarefas.length > Mi && this.tarefas.shift(), this.tarefasTotal++, this.tarefasDuracao += e.duracao, e.duracao > this.tarefasPior && (this.tarefasPior = e.duracao), e.em < Vt && this.tarefasNaCarga++;
  }
  // ── Ciclo de navegação ────────────────────────────────────────────────────
  /**
  ...
  // ── Leitura ───────────────────────────────────────────────────────────────
  leituraDeMemoria() {
    const e = this.memoria, t = e[0], a = e[e.length - 1], i = e.length, r = Math.max(1, Math.floor(i / 3)), n = i ? Ke(e.slice(0, r)) : 0, s = i ? Ke(e.slice(i - r)) : 0, l = s - n, c = this.valoresDeMemoria.size, p = i ? Ke(e.slice(r, i - r)) : 0, d = s - p;
    let h;
    return i < Ri ? h = `Só ${i} amostra(s) — o piso ainda não significa nada.` : c < 2 ? h = `${i} amostras, mas um único valor de heap: o navegador ainda não atualizou a leitura. Sem informação — precisa de sessão longa.` : l > Ze && d > Ze ? h = `Piso subiu ${(l / 1048576).toFixed(1)} MB e AINDA sobe (${(d / 1048576).toFixed(1)} MB no último terço) — isto é retenção.` : l > Ze ? h = `Subiu ${(l / 1048576).toFixed(1)} MB desde a carga e estabilizou em ${(s / 1048576).toFixed(0)} MB — é custo de partida, não vazamento.` : h = `Piso estável em ${c} degraus — a variação do heap é coleta de lixo, não vazamento.`, {
      amostras: i,
      ...t ? { primeira: t } : {},
      ...a ? { ultima: a } : {},
  ...
  instantaneo(e) {
    const a = [...this.componentes.values()].sort(
      ...
      render: { ...s.render },
      motivos: [...s.motivos.entries()].map(([l, c]) => ({ motivo: l, total: c })).sort((l, c) => c.total - l.total).slice(0, Li),
      timers: { ...s.timers },
...
const C = new zi(), Hi = 5e3, se = { timerMemoria: void 0, observador: void 0 };
function Di() {
  const o = performance;
  if (o.memory)
...
function Pi(o) {
  if (se.timerMemoria !== void 0 || se.observador !== void 0) return;
  C.iniciar(performance.now(), o);
  const e = () => {
    const t = Di();
    t && C.memoriaAmostrada({ em: Math.round(performance.now()), ...t });
  };
  if (e(), se.timerMemoria = window.setInterval(e, Hi), "PerformanceObserver" in window)
    try {
      ...
      t.observe({ entryTypes: ["longtask"] }), se.observador = t;
    } catch {
    }
}
function ji() {
  return se.timerMemoria !== void 0;
}
const ae = /* @__PURE__ */ new Map();
function Jn(o, e, t) {
  const a = window.setInterval(e, t);
  return ae.set(a, "intervalo"), C.timerCriado(o), a;
}
function es(o, e, t) {
  const a = window.setTimeout(() => {
    ae.delete(a), C.timerEncerrado(o), e();
  }, t);
  return ae.set(a, "espera"), C.timerCriado(o), a;
}
function ts(o, e) {
  if (e === void 0) return;
  const t = ae.get(e);
  t !== void 0 && (t === "intervalo" ? window.clearInterval(e) : window.clearTimeout(e), ae.delete(e), C.timerEncerrado(o));
}
function Vi() {
  return ae.size;
}
function as(o, e, t, a, i) {
  e.addEventListener(t, a, i), C.listenerCriado(o);
}
function is(o, e, t, a, i) {
  e.removeEventListener(t, a, i), C.listenerEncerrado(o);
}
function Bi(o, e, t) {
  C.requisicao(o, e, t);
}
...
function Qa(o, e, t) {
  ...
  try {
    ...
    C.renderizou(o, performance.now() - a, t);
  }
}
function Xa() {
  return C.marcar(performance.now());
}
function Ui() {
  C.limparMarca();
}
...
function Ie() {
  return { ...C.instantaneo(performance.now()), timersVivos: Vi() };
}
function Gi() {
  if (ji()) return;
  Pi(Fi());
...
const Wi = "20260718-wallpaper-upload-1", Ae = "input_number.bruno_wallpaper_revision", Ye = Object.freeze([
  ...
  resolve(o, e, t = "") {
    ...
    if (!a) return "";
    const i = Number(o?.states?.[Ae]?.state) || 0, r = Math.max(i, this._revision);
...
globalThis.BrunoWallpaperManager = Zi;
(() => {
  const o = [
...
class A extends HTMLElement {
  ...
  async _setSection(e) {
    ...
    try {
      const l = this._sectionElement(n, s, r), c = e === n ? l : this._sectionElement(e, t, r), [p, d] = await Promise.all([l, c]);
      if (i !== this._sectionRequestId || r !== this._sectionGeneration || this._requestedKey !== e) return;
      this._activateSection({ key: e, el: d, homeKey: n, homeEl: p, content: a, requestId: i });
    } catch (l) {
  ...
  _preloadResolvedBackdropFor(e) {
    if (!this._hass || !this._backdrops || !e) return;
    const t = this._backdrops[e] || this._backdrops.default, a = globalThis.BrunoWallpaperManager?.resolve?.(this._hass, e, t) || t;
  ...
  _loadBackdrop(e) {
    ...
    const i = new Promise((r) => {
      ...
      const s = async (l) => {
        if (!n) {
          if (n = !0, l && typeof a.decode == "function")
            try {
              await a.decode();
            } catch {
            }
      ...
      a.addEventListener("load", () => s(!0), { once: !0 }), a.addEventListener("error", () => s(!1), { once: !0 }), a.src = e, a.complete && s(a.naturalWidth > 0);
    });
    return this._backdropCache.set(e, { image: a, promise: i }), i;
  }
  ...
  _renderRailError(e) {
    ...
    t && (t.innerHTML = `<div class="err">rail: ${A._escape(e && e.message)}</div>`);
  }
        ...
        <div class="config-section config-menu-section">
          <div class="config-menu-list">
            <button class="config-menu-item" type="button" data-config-action="open-section" data-section="themes">
              ...
              <span class="config-menu-copy"><strong>Themes</strong><small>${A._escape(a?.activeLabel?.() || "VisionOS")}</small></span>
    ...
    return `
      <section class="config-panel config-child-panel" role="dialog" aria-modal="true" aria-label="Themes">
        <header class="config-header">
          ...
          <div class="config-title"><strong>Themes</strong><span>${A._escape(e?.activeLabel?.() || a)}</span></div>
          <button class="config-close" type="button" data-config-action="child-close" aria-label="Fechar">&times;</button>
        </header>
          ...
          <div class="theme-list">
            ${t.map((i) => `
              <button class="theme-option${i.key === a ? " is-selected" : ""}" type="button"
                data-config-action="theme" data-theme="${A._escapeAttr(i.key)}" ${i.available ? "" : "disabled"}>
                <span>${A._escape(i.label)}</span>
    ...
    return `
      <section class="config-panel config-child-panel wallpaper-panel" role="dialog" aria-modal="true" aria-label="Wallpaper">
        ...
        <div class="config-section wallpaper-content">
            ...
            <div class="wallpaper-area-list" role="listbox" aria-label="Area do wallpaper">
              ${t.map((l) => `
                <button class="wallpaper-area-option${l.key === a.key ? " is-selected" : ""}" type="button"
                  data-config-action="wallpaper-area" data-wallpaper-key="${A._escapeAttr(l.key)}"
          ...
          <div class="wallpaper-preview${n ? " has-image" : ""}" style="${n ? `--wallpaper-preview:url('${A._escapeAttr(A._cssUrl(n))}')` : ""}" aria-hidden="true"></div>
          ...
          <label class="wallpaper-field">
            ...
            <input id="wallpaperUrl" type="text" spellcheck="false" value="${A._escapeAttr(i)}" placeholder="${A._escapeAttr(r)}">
          </label>
          ...
          ${this._wallpaperMessage ? `<small class="wallpaper-message">${A._escape(this._wallpaperMessage)}</small>` : ""}
        </div>
  ...
  async _openSpotifyPanel(e = {}) {
    ...
    `;
      try {
        ...
        a && (a.innerHTML = `<span class="spotify-panel-loading">${A._escape(t?.message || "Spotify indisponivel")}</span>`);
      }
    }
  }
  /**
  ...
  _renderNetworkQrStep() {
    ...
    this._configOverlayEl.innerHTML = `
      ...
      <section class="config-panel" role="dialog" aria-modal="true" aria-label="Rede">
        ...
        <div class="config-section">
          <img class="network-qr" src="${A._escape(e)}" alt="QR Code da rede de visitantes">
...
const Ki = "20260723-liquid-performance-1", Bt = "bruno-liquid-glass-tokens", At = {
...
function Ja(o = globalThis.document) {
...
globalThis.BrunoThemeManager ? globalThis.BrunoLiquidGlassOriginal = Ut : (globalThis.BrunoLiquidGlass = Ut, Ja());
const ar = "20260723-liquid-glass-ios-3", Ft = "bruno-liquid-glass-tokens", le = globalThis.BrunoLiquidGlass, ei = Object.assign(
  {},
  le?.tokens || {},
  {
...
function or(o = globalThis.document) {
  if (!o?.head) return null;
...
globalThis.BrunoLiquidGlassIOS = {
  version: ar,
  tokens: ei,
  surfaces: le?.surfaces || {},
  states: le?.states || {},
  apply: or,
  feedback: (...o) => le?.feedback?.(...o) || !1,
  routeTransition: (...o) => le?.routeTransition?.(...o)
};
const nr = "20260702-visionos-yaml-2", Gt = "bruno-liquid-glass-tokens", Ot = {
  "bruno-liquid-accent": "255, 159, 10",
  "bruno-liquid-warm-accent": "255, 214, 10",
  "bruno-liquid-green-accent": "50, 215, 75",
...
function pr(o = globalThis.document) {
  if (!o?.head) return null;
...
globalThis.BrunoVisionOS = ti;
globalThis.BrunoLiquidGlass || (globalThis.BrunoLiquidGlass = ti);
const br = "20260716-ios-light-1", Wt = "bruno-liquid-glass-tokens", ce = globalThis.BrunoVisionOS || globalThis.BrunoLiquidGlass, Et = Object.assign({}, ce?.tokens || {}, {
...
function fr(o = globalThis.document) {
  if (!o?.head) return null;
...
const vr = "20260716-ios-dark-1", Zt = "bruno-liquid-glass-tokens", de = globalThis.BrunoVisionOS || globalThis.BrunoLiquidGlass, Ct = Object.assign({}, de?.tokens || {}, {
...
const wr = "20260802-josh-popup-material-1", Kt = "bruno-liquid-glass-tokens";
function te() {
...
function ai() {
  const o = te();
  return Object.assign({}, o?.tokens || {}, kr);
}
const qr = `
html.bruno-liquid-route-transition::after {
  content: "";
...
function Ar(o = globalThis.document) {
  if (!o?.head) return null;
  if (!te()?.tokens)
...
const Yt = "20260723-liquid-glass-ios-1", Oe = "bruno-ui-theme", Qe = "bruno-ui-theme-storage-version", Xe = "2", B = "visionos";
function Or() {
  ...
  const n = {
    ...
    try {
      return (globalThis.localStorage?.getItem(Qe) || "") !== Xe ? (globalThis.localStorage?.setItem(Qe, Xe), globalThis.localStorage?.setItem(Oe, B), B) : globalThis.localStorage?.getItem(Oe) || "";
    } catch {
      return "";
    }
  }, d = (f) => {
    try {
      globalThis.localStorage?.setItem(Qe, Xe), globalThis.localStorage?.setItem(Oe, f);
    } catch {
    }
    ...
    apply(f, m = {}) {
      const x = l(f || B), $ = n[x]?.api || n[s()]?.api;
      if (!$?.apply) return null;
      const T = $.apply(m.styleOptions || void 0);
...
globalThis.BrunoThemeManager = Or();
const Er = "20260801-light-control-backdrop-root-1", Tt = "data-bruno-subview-surface-theme", Le = /* @__PURE__ */ new WeakMap();
function Cr() {
...
function Tr(o) {
  ...
  const t = () => ii(o);
  Le.set(o, t), globalThis.addEventListener?.("bruno-theme-changed", t), t();
}
function $r(o) {
  const e = Le.get(o);
  e && globalThis.removeEventListener?.("bruno-theme-changed", e), Le.delete(o);
}
const F = [
...
function Hr() {
  const o = `:host([${Tt}="josh"])`, e = E(F), t = E(F, "::before"), a = E(F, "::after"), i = E(F.map((h) => `${h}.is-active`)), r = E(Mr), n = E(Ee), s = E(Ir), l = E(Lr), c = E(Rr), p = E(Nr), d = E(zr);
  return `
...
function Dr() {
  const o = E(F), e = E(F, "::before"), t = E(F, "::after");
  return `
    ${o} {
...
const Pr = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", jr = {
...
globalThis.BrunoUpdatesPanel = jr;
const Vr = {
  render({ hass: o } = {}) {
...
globalThis.BrunoSystemPanel = Vr;
const Br = {
  render({ hass: o } = {}) {
    const e = this._model(o);
    return `
...
globalThis.BrunoNetworkPanel = Br;
(() => {
...
}, Xt = ["on", "playing", "paused", "idle", "buffering"], Ur = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], Fr = ["cooling", "heating", "drying", "fan", "preheating"], Gr = ["off", "idle"], Jt = ["playing", "on", "paused"], Wr = 1200, Zr = 2500, Je = Object.freeze({
...
class L extends HTMLElement {
  ...
  _climateIsActive(e) {
    ...
    return Fr.includes(t) ? !0 : Gr.includes(t) ? !1 : Ur.includes(e?.state || "");
  }
  ...
  _isActionCoolingDown(e) {
    ...
    const t = Date.now(), a = this._lastActionAt[e] || 0, i = e === "climate" ? Zr : Wr;
  ...
  _hybridTransitionFor(e, t, a) {
    ...
    }, this._hybridTransitions.set(e, i)), i.active !== t && (this._clearHybridTimer(e), i.active = t, i.phase = t ? "turning-on" : "turning-off", i.startedAt = a, i.until = a + Je[e][t ? "on" : "off"], t && (i.glowStartedAt = e === "corridor" ? 0 : a, i.airflowStartedAt = e === "climate" ? 0 : i.airflowStartedAt), i.token = ++this._hybridTransitionToken, this._scheduleHybridTransition(e, i)), i.phase && !this._hybridTimers.has(e) && this._scheduleHybridTransition(e, i);
    const r = Kr[e], n = (s, l) => s && l ? Math.max(0, a - s) % l : 0;
    return {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="columns" role="region" aria-label="Atividades da casa">
        ${this._config.slots.map((a) => `
          <div class="slot is-hidden" data-slot-key="${je._escapeAttr(a.key)}"></div>
        `).join("")}
      </div>
...
customElements.get(ut) || customElements.define(ut, je);
  ...
  _renderOverflow() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="indicator${e.active ? " is-active" : ""}${this._rolou ? " is-scrolled" : ""}" role="status" aria-live="polite" aria-hidden="${this._rolou ? "true" : "false"}">
        ...
        <span>${je._escapeAttr(e.text)}</span>
        <ha-icon icon="mdi:chevron-down" aria-hidden="true"></ha-icon>
      </div>
    `;
  }
}
customElements.get(ht) || customElements.define(ht, Yr);
window.customCards = window.customCards || [];
window.customCards.push({
  type: ut,
...
}, Qr = ["streaming", "recording", "idle", "on"], Xr = ["unavailable", "unknown", ""], oa = 6500;
class y extends HTMLElement {
  ...
  _cameraState(e) {
    const t = this._state(e.entity), a = t?.state || "", i = !t || Xr.includes(a), r = !i && Qr.includes(a);
...
const gt = "bruno-roborock-card", Jr = "20260606-main-view-4", eo = {
...
}, to = ["cleaning", "moving", "returning", "segment_cleaning"], ao = ["unknown", "unavailable", "none", ""];
class R extends HTMLElement {
  ...
  _isInvalid(e) {
    return e == null || ao.includes(String(e).toLowerCase());
  }
  _entityList(e) {
  ...
  _model() {
    const e = this._config.entities, t = this._state(e.vacuum), a = t?.state || "unknown", i = to.includes(a), r = {
      cleaning: "Limpando",
  ...
  _assetUrl(e) {
    return e ? `${e}${String(e).includes("?") ? "&" : "?"}v=${Jr}` : "";
  }
  _render() {
    if (!this._config) return;
    this.shadowRoot || this.attachShadow({ mode: "open" });
...
const mt = "bruno-home-camera-card", et = {
  name: "Monitoramento",
  active_entity: "input_select.bento_active_camera",
...
}, io = ["streaming", "recording", "idle", "on"], ro = ["unavailable", "unknown", ""], oo = 3e4;
class O extends HTMLElement {
  ...
  setConfig(e) {
    this._config = {
      ...et,
      ...e || {},
      cameras: Array.isArray(e?.cameras) && e.cameras.length ? e.cameras : et.cameras,
      refresh_interval: Number(e?.refresh_interval) > 0 ? Number(e.refresh_interval) : et.refresh_interval
  ...
  _isUnavailable(e) {
    return !e || ro.includes(String(e.state || "").toLowerCase());
  }
  _cameraState(e) {
    const t = this._state(e.entity), a = String(t?.state || "").toLowerCase(), i = this._isUnavailable(t), r = !i && io.includes(a), n = t?.attributes?.entity_picture || "";
    n && (this._lastCameraImages[e.entity] = n);
    ...
    return this._cameraBaseUrls[e.entity] !== s && (this._cameraBaseUrls[e.entity] = s, delete this._loadedCameraUrls[e.entity]), {
      ...
      online: r,
      image: s,
      imageUrl: this._loadedCameraUrls[e.entity] || O._withCacheBust(s, this._refreshSeed || Date.now()),
...
customElements.get(mt) || customElements.define(mt, O);
window.customCards = window.customCards || [];
window.customCards.push({
  type: mt,
...
], so = ["unknown", "unavailable", "none", ""], lo = 60 * 1e3;
class D extends HTMLElement {
  ...
  _activePeriod() {
    ...
    return tt.find((t) => t.option === e) || tt[0];
  }
  _model() {
  ...
  _ensureHistory(e) {
    ...
    t?.loading || t?.fetchedAt && a - t.fetchedAt < lo || (this._historyCache[e.cacheKey] = {
      ...t || {},
      loading: !0
      ...
      <div class="energy-card">
        <div class="header">
          ...
          <div class="selector" aria-label="Periodo de energia">
            ${tt.map((t) => this._segment(t, t.option === e.period.option)).join("")}
          </div>
        </div>
  ...
  _chart(e) {
    const t = [{ value: e.graphCurrent ?? 0, time: Date.now() - 1 }, { value: e.graphCurrent ?? 0, time: Date.now() }], a = e.points.length >= 2 ? e.points : t, i = 360, r = 100, n = 0, s = 10, l = 20, c = a.map((M) => M.value), p = Math.min(e.period.lowerBound, ...c), d = Math.max(1, ...c), h = Math.max(1, d - p), b = (M) => a.length <= 1 ? n : n + M / (a.length - 1) * (i - n * 2), u = (M) => s + (d - M) / h * (r - s - l), g = a.map((M, H) => {
      const ye = b(H).toFixed(2), we = u(M.value).toFixed(2);
      return `${H ? "L" : "M"} ${ye} ${we}`;
    }).join(" "), f = b(0).toFixed(2), m = b(a.length - 1).toFixed(2), x = (r - l).toFixed(2), $ = `${g} L ${m} ${x} L ${f} ${x} Z`, T = e.graphCurrent == null ? "--" : `${Number(e.graphCurrent).toFixed(e.period.unit === "W" ? 0 : 2).replace(".00", "")} ${e.period.unit}`, z = this._comparison(e);
    return `
      <svg viewBox="0 0 ${i} ${r}" preserveAspectRatio="none" role="img" aria-label="${D._escapeAttr(T)}">
        <defs>
        ...
        <path d="${$}" fill="url(#bruno-energy-area)"></path>
        ...
        <text x="18" y="94" class="axis-label">${D._escape(T)}</text>
...
], sa = 5 * 1e3, po = ["unknown", "unavailable", "none", ""];
class V extends HTMLElement {
  ...
  _isInvalid(e) {
    return e == null || po.includes(String(e).toLowerCase());
  }
...
class Re extends HTMLElement {
  ...
  _render() {
    if (!this._config) return;
    this.shadowRoot || this.attachShadow({ mode: "open" });
    const e = Re._cssUrl(this._config.background), t = Re._cssUrl(this._config.fallback_background || this._config.background);
    this.shadowRoot.innerHTML = `
      <style>
        :host {
          display: block;
...
customElements.get(_t) || customElements.define(_t, Re);
window.customCards = window.customCards || [];
window.customCards.push({
  type: _t,
...
const xt = "bruno-hero-card", uo = {
  ...
  { entity: "camera.cz_camera_2", name: "Cozinha", short_name: "Cozinha" },
  { entity: "camera.as_camera_2", name: "Area de Servico", short_name: "Area" }
], ha = 300 * 1e3, ho = ["unknown", "unavailable", "idle", "off", "none", ""];
class w extends HTMLElement {
  ...
  _cameraState(e) {
    const t = this._state(e.entity), a = t?.state || "", i = !t || ho.includes(String(a).toLowerCase()), r = t?.attributes?.entity_picture || "";
...
const ri = "(max-width: 800px)", ba = "bruno-hero-card", ga = "bento-sidebar-liquid-card", bo = 6e3, ma = () => !!globalThis.matchMedia?.(ri).matches;
function Y(o) {
...
function va(o) {
  ...
  if (i.filter((s) => s.classList.contains("is-empty")).forEach((s) => {
    ...
    a.classList.remove("bruno-chat-carousel"), a.style.display = "none", Y(o), o.__brunoChatHeroIndex = 0;
    return;
  }
...
function mo(o) {
  ...
  e.connectedCallback = function(...n) {
    ...
    return !this.__brunoChatViewportQuery && globalThis.matchMedia && (this.__brunoChatViewportQuery = globalThis.matchMedia(ri), this.__brunoChatViewportListener = () => {
      Y(this), this._render?.();
  ...
  e.disconnectedCallback = function(...n) {
    return Y(this), this.__brunoChatViewportQuery && this.__brunoChatViewportListener && this.__brunoChatViewportQuery.removeEventListener?.("change", this.__brunoChatViewportListener), this.__brunoChatViewportQuery = null, this.__brunoChatViewportListener = null, i?.apply(this, n);
  };
}
function fo(o) {
...
Promise.all([
  ...
  mo(customElements.get(ba)), vo(customElements.get(ga));
});
const yt = "bruno-top-badges-card", _o = [
  { visual: 0, position: 0 },
...
class N extends HTMLElement {
  ...
  _interpolateCurtainPercent(e, t, a) {
    const i = this._toPercent(e) ?? 0, r = _o;
...
const kt = "bruno-media-card", ka = "bruno-ui:media-history:v3", Ce = {
...
}, yo = ["playing", "paused"], at = "media_player.android_tv_192_168_3_17", wo = "media_player.android_tv_192_168_3_17", qa = /* @__PURE__ */ new Set(["on", "playing", "paused", "idle", "buffering"]);
class k extends HTMLElement {
  ...
  setConfig(e) {
    this._config = {
      ...
      slots: Array.isArray(e?.slots) ? e.slots : Ce.slots,
      players: Array.isArray(e?.players) ? e.players : Ce.players
    }, this._slideIndex = this._slideIndex || 0, this._mediaMenuOpen = this._mediaMenuOpen || !1, this._mediaHistory === void 0 && (this._mediaHistory = this._readMediaHistory()), this._lastValidMedia = this._latestMediaSnapshot(), this._safeRender();
  }
  set hass(e) {
    this._hass = e;
  ...
  _isActive(e) {
    ...
    if (e === at) {
      const a = String(this._state(wo)?.state || "").toLowerCase();
      return qa.has(a);
    }
  ...
  _capturePlayerHistory() {
    !this._config || !this._hass || this._allPlayerIds().forEach((e) => {
      ...
      const b = this._mediaServiceName(e, r, d, c, p), u = b === "Spotify" ? this._spotifyRoomTarget(a) : null, g = u ? { ...r, ...u } : r, f = this._mediaRoomName(g), m = this._cleanText(a.media_artist), x = this._cleanText(a.media_album_name), $ = this._cleanText(a.media_series_title), T = this._cleanText(a.media_channel), z = this._fallbackMediaTitle(b, f, e), M = this._firstText([n, z, this._playerName(e)]), H = this._firstText([m, x, $, T], [M]);
  ...
  _playbackPriority(e) {
    const t = this._state(e), a = String(t?.state || "").toLowerCase();
    if (e === at) {
      if (qa.has(a) && (this._lastTvPoweredAt = Date.now()), a === "playing") return 4;
      if (a === "buffering") return 3;
      if (a === "paused") return 2;
      if (a === "on" || a === "idle" || a === "off" && Number.isFinite(this._lastTvPoweredAt) && Date.now() - this._lastTvPoweredAt <= BRUNO_MEDIA_TV_OFF_GRACE_MS) return 1;
    } else {
      if (a === "playing") return 4;
      if (a === "paused") return 2;
    }
    const i = this._playerConfig(e), r = t?.attributes || {}, n = String(r.media_content_type || r.app_name || "").toLowerCase(), s = this._isStandbyImage(r.entity_picture) ? "" : r.entity_picture || "";
    return this._hasPlayback(
      a,
      this._cleanText(r.media_title),
      s,
      r.app_name,
      r.source,
      e,
  ...
  _focusModel() {
    ...
    const l = ["paused", "idle"].includes(n) && this._lastArtworkByPlayer[e];
    let c = s;
    ...
    const $ = Number(t?.attributes?.volume_level ?? (i ? a?.attributes?.volume_level : void 0) ?? 0), T = String(
      (i ? a?.attributes?.media_content_type : "") || t?.attributes?.media_content_type || t?.attributes?.app_name || ""
    ).toLowerCase(), z = ["video", "movie", "tvshow", "episode", "channel"].some((Ai) => T.includes(Ai)), M = Date.parse((i ? a?.attributes?.media_position_updated_at : "") || t?.attributes?.media_position_updated_at || "");
    n === "playing" && Number.isFinite(M) && Number.isFinite(x) && (x += Math.max(0, (Date.now() - M) / 1e3)), Number.isFinite(m) && m > 0 && (x = Math.min(x, m));
    const H = this._mediaServiceName(e, r, T, b, u), ye = {
      ...t?.attributes || {},
      ...i ? a?.attributes || {} : {}
    }, we = H === "Spotify" ? this._spotifyRoomTarget(ye) : null, ke = we ? { ...r, ...we } : r, Ht = this._mediaRoomName(ke), S = this._hasPlayback(n, p, s, b, u, e, r, T, ye), wi = this._fallbackMediaTitle(H, Ht, e), Ue = S ? this._firstText([p, b, u, wi, this._playerName(e)]) : "", Dt = S ? this._firstText([d, h, g, f, b, u, this._stateLabel(n)], [Ue]) : "", Pt = S ? [H, Ht].filter(Boolean).join(" ") : "", Fe = r.icon || this._playerIcon(e), Ge = ke.path || ke.navigation_path || "", We = ke.section || "";
    ...
    const qe = e === at && this._isActive(e), I = S ? null : qe ? this._mediaHistory?.[e] || null : this._mediaHistory?.[e] || this._latestMediaSnapshot(), jt = S ? c : c || I?.image || this._lastArtworkByPlayer?.[e] || "", ki = S ? Ue : I?.title || (qe ? "TV ligada" : ""), qi = S ? Dt : I?.secondary || I?.artist || (qe ? this._firstText([b, u, "Sala"]) : ""), Si = S ? Pt : I?.context || (qe ? "TV Sala" : "");
    return {
      entity: S ? e : I?.entity || e,
      image: jt,
      title: ki,
      artist: S ? d && d !== "Pronto para tocar" ? d : "" : I?.artist || "",
      secondary: qi,
      context: Si,
      statusLabel: S ? n === "paused" ? "Pausado" : n === "on" ? this._stateLabel(n) : "Reproduzindo agora" : "Nenhuma mídia ativa",
      state: n,
      serviceName: S ? H : I?.serviceName || H,
      serviceIcon: S ? Fe : I?.serviceIcon || Fe,
      path: S ? Ge : I?.path || Ge,
      section: S ? We : I?.section || We,
      duration: Number.isFinite(m) ? m : 0,
      position: Number.isFinite(x) ? Math.max(0, x) : 0,
      volumePercent: Number.isFinite($) ? Math.max(0, Math.min(100, Math.round($ * 100))) : 0,
      isVideo: z,
      isPlaying: n === "playing",
      isActive: S,
      hasPlayback: S,
      hasLastMedia: !!(I && (I.image || I.title)),
      isSoftArtwork: (n === "paused" || !S) && !!jt
    };
  }
  ...
  _hasPlayback(e, t, a, i, r, n = "", s = {}, l = "", c = {}) {
    ...
    if (["google tv launcher", "android tv launcher", "launcher", "ambient mode", "backdrop", "home screen"].some((f) => d.includes(f))) return !1;
 ...
 */
const Me = globalThis, $t = Me.ShadowRoot && (Me.ShadyCSS === void 0 || Me.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Mt = Symbol(), Sa = /* @__PURE__ */ new WeakMap();
let oi = class {
  constructor(e, t, a) {
  ...
  get styleSheet() {
    ...
    if ($t && e === void 0) {
      ...
      a && (e = Sa.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), a && Sa.set(t, e));
    }
    return e;
  }
  toString() {
...
}, Aa = $t ? (o) => o : (o) => o instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: So, defineProperty: Ao, getOwnPropertyDescriptor: Oo, getOwnPropertyNames: Eo, getOwnPropertySymbols: Co, getPrototypeOf: To } = Object, Ve = globalThis, Oa = Ve.trustedTypes, $o = Oa ? Oa.emptyScript : "", Mo = Ve.reactiveElementPolyfillSupport, pe = (o, e) => o, qt = { toAttribute(o, e) {
  switch (e) {
    case Boolean:
      o = o ? $o : null;
      break;
  ...
  return t;
} }, ni = (o, e) => !So(o, e), Ea = { attribute: !0, type: String, converter: qt, reflect: !1, useDefault: !1, hasChanged: ni };
...
let ee = class extends HTMLElement {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const i of a) t.unshift(Aa(i));
    } else e !== void 0 && t.push(Aa(e));
    return t;
  }
  static _$Eu(e, t) {
    const a = t.attribute;
  ...
  requestUpdate(e, t, a, i = !1, r) {
    if (e !== void 0) {
      ...
      if (i === !1 && (r = this[e]), a ??= n.getPropertyOptions(e), !((a.hasChanged ?? ni)(r, t) || a.useDefault && a.reflect && r === this._$Ej?.get(e) && !this.hasAttribute(n._$Eu(e, a)))) return;
      this.C(e, t, a);
    }
...
ee.elementStyles = [], ee.shadowRootOptions = { mode: "open" }, ee[pe("elementProperties")] = /* @__PURE__ */ new Map(), ee[pe("finalized")] = /* @__PURE__ */ new Map(), Mo?.({ ReactiveElement: ee }), (Ve.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const It = globalThis, Ca = (o) => o, Ne = It.trustedTypes, Ta = Ne ? Ne.createPolicy("lit-html", { createHTML: (o) => o }) : void 0, si = "$lit$", U = `lit$${Math.random().toFixed(9).slice(2)}$`, li = "?" + U, Io = `<${li}>`, J = document, ge = () => J.createComment(""), me = (o) => o === null || typeof o != "object" && typeof o != "function", Lt = Array.isArray, Lo = (o) => Lt(o) || typeof o?.[Symbol.iterator] == "function", it = `[ 	
\f\r]`, oe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, $a = /-->/g, Ma = />/g, K = RegExp(`>|${it}(?:([^\\s"'>=/]+)(${it}*=${it}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ia = /'/g, La = /"/g, ci = /^(?:script|style|textarea|title)$/i, di = (o) => (e, ...t) => ({ _$litType$: o, strings: e, values: t }), v = di(1), ns = di(2), ie = Symbol.for("lit-noChange"), _ = Symbol.for("lit-nothing"), Ra = /* @__PURE__ */ new WeakMap(), X = J.createTreeWalker(J, 129);
function pi(o, e) {
  if (!Lt(o) || !o.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return Ta !== void 0 ? Ta.createHTML(e) : e;
}
const Ro = (o, e) => {
  const t = o.length - 1, a = [];
  let i, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", n = oe;
  for (let s = 0; s < t; s++) {
    const l = o[s];
    let c, p, d = -1, h = 0;
    for (; h < l.length && (n.lastIndex = h, p = n.exec(l), p !== null); ) h = n.lastIndex, n === oe ? p[1] === "!--" ? n = $a : p[1] !== void 0 ? n = Ma : p[2] !== void 0 ? (ci.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = K) : p[3] !== void 0 && (n = K) : n === K ? p[0] === ">" ? (n = i ?? oe, d = -1) : p[1] === void 0 ? d = -2 : (d = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? K : p[3] === '"' ? La : Ia) : n === La || n === Ia ? n = K : n === $a || n === Ma ? n = oe : (n = K, i = void 0);
    const b = n === K && o[s + 1].startsWith("/>") ? " " : "";
    r += n === oe ? l + Io : d >= 0 ? (a.push(c), l.slice(0, d) + si + l.slice(d) + U + b) : l + U + (d === -2 ? s : b);
  }
  return [pi(o, r + (o[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), a];
};
class fe {
  constructor({ strings: e, _$litType$: t }, a) {
    ...
    if (this.el = fe.createElement(c, a), X.currentNode = this.el.content, t === 2 || t === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (i = X.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(si)) {
          const h = p[n++], b = i.getAttribute(d).split(U), u = /([.?@])?(.*)/.exec(h);
          l.push({ type: 1, index: r, name: u[2], strings: b, ctor: u[1] === "." ? zo : u[1] === "?" ? Ho : u[1] === "@" ? Do : Be }), i.removeAttribute(d);
        } else d.startsWith(U) && (l.push({ type: 6, index: r }), i.removeAttribute(d));
        if (ci.test(i.tagName)) {
          const d = i.textContent.split(U), h = d.length - 1;
          if (h > 0) {
            i.textContent = Ne ? Ne.emptyScript : "";
            for (let b = 0; b < h; b++) i.append(d[b], ge()), X.nextNode(), l.push({ type: 2, index: ++r });
            i.append(d[h], ge());
          }
        }
      } else if (i.nodeType === 8) if (i.data === li) l.push({ type: 2, index: r });
      else {
        let d = -1;
...
function re(o, e, t = o, a) {
  if (e === ie) return e;
  let i = a !== void 0 ? t._$Co?.[a] : t._$Cl;
  const r = me(e) ? void 0 : e._$litDirective$;
  return i?.constructor !== r && (i?._$AO?.(!1), r === void 0 ? i = void 0 : (i = new r(o), i._$AT(o, t, a)), a !== void 0 ? (t._$Co ??= [])[a] = i : t._$Cl = i), i !== void 0 && (e = re(o, i._$AS(o, e.values), i, a)), e;
}
class No {
  constructor(e, t) {
  ...
  u(e) {
    ...
    X.currentNode = i;
    let r = X.nextNode(), n = 0, s = 0, l = a[0];
    for (; l !== void 0; ) {
      if (n === l.index) {
        let c;
        l.type === 2 ? c = new xe(r, r.nextSibling, this, e) : l.type === 1 ? c = new l.ctor(r, l.name, l.strings, this, e) : l.type === 6 && (c = new Po(r, this, e)), this._$AV.push(c), l = a[++s];
      }
...
class xe {
  ...
  _$AI(e, t = this) {
    e = re(this, e, t), me(e) ? e === _ || e == null || e === "" ? (this._$AH !== _ && this._$AR(), this._$AH = _) : e !== this._$AH && e !== ie && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Lo(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== _ && me(this._$AH) ? this._$AA.nextSibling.data = e : this.T(J.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: t, _$litType$: a } = e, i = typeof a == "number" ? this._$AC(e) : (a.el === void 0 && (a.el = fe.createElement(pi(a.h, a.h[0]), this.options)), a);
  ...
  _$AC(e) {
    let t = Ra.get(e.strings);
    return t === void 0 && Ra.set(e.strings, t = new fe(e)), t;
  }
  k(e) {
    Lt(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let a, i = 0;
    for (const r of e) i === t.length ? t.push(a = new xe(this.O(ge()), this.O(ge()), this, this.options)) : a = t[i], a._$AI(r), i++;
    i < t.length && (this._$AR(a && a._$AB.nextSibling, i), t.length = i);
  }
  _$AR(e = this._$AA.nextSibling, t) {
    for (this._$AP?.(!1, !0, t); e !== this._$AB; ) {
      const a = Ca(e).nextSibling;
      Ca(e).remove(), e = a;
    }
  }
  setConnected(e) {
...
class Be {
  ...
  _$AI(e, t = this, a, i) {
    ...
    let n = !1;
    if (r === void 0) e = re(this, e, t, 0), n = !me(e) || e !== this._$AH && e !== ie, n && (this._$AH = e);
    else {
      const s = e;
      let l, c;
      for (e = r[0], l = 0; l < r.length - 1; l++) c = re(this, s[a + l], t, l), c === ie && (c = this._$AH[l]), n ||= !me(c) || c !== this._$AH[l], c === _ ? e = _ : e !== _ && (e += (c ?? "") + r[l + 1]), this._$AH[l] = c;
    }
    n && !i && this.j(e);
  }
  j(e) {
...
class Do extends Be {
  ...
  _$AI(e, t = this) {
    if ((e = re(this, e, t, 0) ?? _) === ie) return;
...
jo?.(fe, xe), (It.litHtmlVersions ??= []).push("3.3.3");
const Vo = (o, e, t) => {
  const a = t?.renderBefore ?? e;
  let i = a._$litPart$;
  if (i === void 0) {
    const r = t?.renderBefore ?? null;
    a._$litPart$ = i = new xe(e.insertBefore(ge(), r), r, void 0, t ?? {});
  }
  return i._$AI(o), i;
};
/**
...
W._$litElement$ = !0, W.finalized = !0, Rt.litElementHydrateSupport?.({ LitElement: W });
...
const Wo = "media_player.spotifyplus_bruno_helasio", ne = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], Te = ["playing", "paused", "on"], hi = [
  {
    id: "sala",
    name: "Sala",
    section: "sala",
...
async function an(o) {
  ...
  return {
    ...
    cameras: a,
    resumo: i,
    veredito: gi(i, a.length, e.streamCarregado)
  };
}
function bi(o) {
  const e = {
...
class rn extends W {
   ...
   */
  _runtime() {
    const e = Ie(), t = (l) => (l / 1048576).toFixed(1) + " MB", a = (l) => l.toFixed(1) + " ms", i = e.vazamentos, r = i.timers + i.listeners + i.assinaturas, n = e.desdeAMarca, s = n ? n.instancias + n.timers + n.listeners + n.assinaturas : 0;
    return v`
      <div>
        <h2>Runtime</h2>
        <dl>
  ...
  _cameras() {
    ...
    const e = this._sondaProfunda ?? bi(this._hass);
  ...
  async _copiarBaseline() {
    const e = JSON.stringify(Ie(), null, 2);
    try {
...
const za = {
  "custom:bruno-room-subview": () => import("./bruno-room-subview.BKz5b7K9.js"),
...
function Da(o, e, t = ["on", "home", "active", "yes"]) {
  if (!e) return !1;
  const a = o.states[e];
...
const mi = ["playing", "paused"];
function un(o, e, t) {
  return !o || !mi.includes(String(o.state).toLowerCase()) ? !1 : pn(o.attributes, e) ? !0 : hn(o.attributes, t);
}
function hn(o, e) {
  if (!e || !mi.includes(String(e.state).toLowerCase())) return !1;
  const t = e.attributes ?? {};
  if (Q(
    [t.app_name, t.source, t.media_content_type, t.media_channel].join(" ")
  ).includes("spotify")) return !0;
  const i = o ?? {}, r = Q(t.media_title), n = Q(i.media_title);
  if (r && n && r === n) return !0;
  const s = Q(t.media_artist), l = Q(i.media_artist);
...
const rt = "bruno-room-tile", vn = 1200, _n = 560, ja = 10;
function Va() {
  return {
    pointerId: null,
    down: !1,
...
class xn extends W {
  constructor() {
    super(...arguments), this._lastAction = 0, this._observador = new fi(), this._motivo = "", this._gestures = {
      room: Va(),
      nav: Va()
  ...
  set hass(e) {
    ...
    t.length !== 0 && (this._motivo = vi(t), this.requestUpdate());
  }
  _watched() {
  ...
  connectedCallback() {
    super.connectedCallback(), Ka(rt), this._tileModeCache = void 0, globalThis.addEventListener?.("bruno-theme-changed", this._onThemeChanged);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Ya(rt), globalThis.removeEventListener?.("bruno-theme-changed", this._onThemeChanged);
  ...
  _onMove(e, t) {
    ...
    i <= ja && r <= ja || (a.moved = !0, a.holdTimer !== null && (window.clearTimeout(a.holdTimer), this._timers.delete(a.holdTimer), a.holdTimer = null), this._classe(this._alvoSeletor(e), "is-pressed", !1));
  }
  _onUp(e, t) {
    const a = this._gestures[e];
  ...
  _dots() {
    ...
    const a = t.activeSensor ? e.states[t.activeSensor] : void 0, i = (r) => {
      ...
      }), l = r.activeAttr ? Ba(a?.attributes[r.activeAttr]) : !1, c = r.spotifyDevice ? un(e.states[Wo], r.spotifyDevice) : !1;
      return s || l || c;
    };
  ...
  _statusLines() {
    ...
    a.label ? r.push(a.label) : Da(e, t.entities.lightGroup) && r.push("On");
  ...
  _applianceLine() {
    ...
    if (!(!!n && r.includes(String(n?.state ?? "").toLowerCase()) || (a.activeAttr ? Ba(i?.attributes[a.activeAttr]) : !1))) return "";
  ...
  render() {
    ...
    if (!e) return _;
    const a = t ? Da(t, e.entities.lightGroup ?? e.entities.lights?.[0]) : !1, i = t ? Pa(t, e.entities.temperature, "°") : "--", r = t ? Pa(t, e.entities.humidity, "%") : "--", n = !!(e.entities.temperature ?? e.entities.humidity), s = this._statusLines(), l = this._dots(), c = "20260808-maquetes-premium-1", p = e.assetOff ? `/local/bruno-ui/assets/${e.assetOff}.png?v=${c}` : "", d = e.assetOn ? `/local/bruno-ui/assets/${e.assetOn}.png?v=${c}` : "", h = [
      "room-card",
      a ? "is-room-on" : "",
            ...
            >
              <section class="room-popup-panel" role="document" @click=${(m) => m.stopPropagation()}>
                ...
                <div class="room-popup-lights">
                  ${g.lights.map((m) => {
      const x = t?.states[m.entity], $ = String(x?.state ?? "").toLowerCase(), T = $ === "on", z = !x || ["unavailable", "unknown", "none", ""].includes($), M = [
        "room-popup-light",
        T ? "is-on" : "",
        z ? "is-unavailable" : ""
      ].filter(Boolean).join(" ");
      return v`<button
                    ...
                    >
                      ...
                      <span class="room-popup-light-copy">
                        ...
                        <span>${z ? "Indisponivel" : T ? "Ligada" : "Desligada"}</span>
                      </span>
                    </button>`;
    })}
                </div>
...
He.customCards.some((o) => o.type === "bruno-room-tile") || He.customCards.push({
...
class De extends W {
  ...
  get _entityId() {
    return _i(this._instancia?.entity, this._hass);
  }
  _estado(e) {
...
j.conhece("climate") || j.registrar({
  ...
  icon: "mdi:air-conditioner",
  create: xi("bruno-control-climate"),
  entities: (o) => [typeof o.entity == "string" ? o.entity : o.entity?.[0] ?? ""].filter(Boolean),
  validate: (o) => ({
    ok: !!o.entity,
...
class Mn extends W {
  constructor() {
    super(...arguments), this._selecionado = "", this._controles = /* @__PURE__ */ new Map(), this._observador = new fi(
      Ga.flatMap((e) => Fa(e))
    ), this._motivo = "";
  }
  static {
  ...
  _estaAtivo(e) {
    const t = _i(e.entity, this._hass), a = t && this._hass ? this._hass.states[t] : void 0;
  ...
  connectedCallback() {
    super.connectedCallback(), Ka(nt);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Ya(nt);
  }
  /** Mede o custo de cada atualizacao (Fase 6.0.1). */
  update(e) {
    const t = this._motivo;
    this._motivo = "", Qa(nt, () => super.update(e), t || "outro");
  }
  render() {
  ...
  entidadesObservadas() {
    return [...new Set(this._dispositivos.flatMap((e) => Fa(e)))];
  }
  static {
    this.styles = _e`
...
const Z = "ha-web-rtc-player", In = 6e3, ue = 48, he = 27, Wa = 500;
let st;
const $e = /* @__PURE__ */ new WeakMap();
function Ln(o) {
  return o.split(".")[1] ?? o;
}
function ve(o, e, t = 0, a = !0) {
  Bi(`marco: ${Ln(o)} · player webrtc · ${e}`, t, a);
}
function Rn() {
  return typeof customElements > "u" ? Promise.resolve(!1) : customElements.get(Z) ? Promise.resolve(!0) : new Promise((o) => {
    ...
    }, a = globalThis.setTimeout(() => t(!!customElements.get(Z)), In);
...
async function zn(o, e) {
  ...
  ve(o, "ausente; carregando modulo", 0, !1), st ??= Nn(o, e).finally(() => {
    st = void 0;
  });
  const a = await st, i = typeof performance < "u" ? performance.now() : Date.now();
  return ve(o, a ? "definido sob demanda" : "definicao indisponivel", i - t, a), a;
}
function Hn() {
...
function Dn(o, e, t) {
  if (e !== ue || t !== he || o.length !== e * t * 4) return !1;
    ...
    for (let c = 0; c < a; c++) {
      ...
      for (let u = l * n; u < (l + 1) * n; u++)
        for (let g = c * r; g < (c + 1) * r; g++) {
          ...
          const m = o[f] ?? 0, x = o[f + 1] ?? 0, $ = o[f + 2] ?? 0;
          if (d++, !yi(m, x, $)) continue;
          h++;
          const T = m >> 4 | x >> 4 << 4 | $ >> 4 << 8, z = (p.get(T) ?? 0) + 1;
          p.set(T, z), b = Math.max(b, z);
        }
...
function Pn(o, e = ue, t = he) {
  ...
  return r / i >= 0.45 && yi(s, l, c) || Dn(o, e, t);
}
function jn(o) {
  if ($e.has(o)) return;
  let e = 0;
  const t = () => {
    if (o.isConnected) {
      ...
      if (r && r.readyState >= 2) {
        ...
        n && o.classList.contains("is-ready") ? (o.classList.remove("is-ready"), o.setAttribute("data-bruno-quadro-verde", ""), ve(o.entityid ?? "camera.desconhecida", "quadro verde eventual rejeitado", 0, !1)) : !n && s && (o.removeAttribute("data-bruno-quadro-verde"), o.classList.add("is-ready"), ve(o.entityid ?? "camera.desconhecida", "stream recuperado apos quadro verde"));
      }
    } else if (e += 1, e >= 20) {
      $e.delete(o);
      return;
    }
    const i = globalThis.setTimeout(t, Wa);
    $e.set(o, i);
  }, a = globalThis.setTimeout(t, Wa);
  $e.set(o, a);
}
function zt(o) {
  ...
  try {
    ...
    e.width = ue, e.height = he;
    const t = e.getContext("2d", { willReadFrequently: !0 });
    return t ? (t.drawImage(o, 0, 0, ue, he), Pn(
      t.getImageData(0, 0, ue, he).data
    )) : !1;
  } catch {
    return !1;
  }
...
const Vn = {
  ...
  principal: 1500,
  secundaria: 3e3
}, Fn = 25e3, Gn = 300, Wn = 6e4, Zn = 12e3, Za = { comImagem: 2, semImagem: 4 };
function Kn(o, e) {
...
class Xn {
  ...
  agendarProximo(e, t) {
    ...
    const r = e.quadros === 0, n = r ? Za.semImagem : Za.comImagem, s = r ? Zn : Wn;
...
//# sourceMappingURL=main.CkG8rvha.js.map
