...
const Pe = 720, Le = 200, je = 24, Ve = 4, Ga = 3e4, Fe = 12, va = 10 * 1024 * 1024, Be = 64;
function _a(r) {
...
class Ue {
  ...
  de(a) {
    ...
    return e || (e = Ne(a), this.componentes.set(a, e)), e;
  }
  // ── Pontos de coleta ──────────────────────────────────────────────────────
  conectou(a) {
  ...
  renderizou(a, e, o) {
    ...
    const n = i.motivos.has(o) || i.motivos.size < je ? o : "outros";
  ...
  memoriaAmostrada(a) {
    this.memoria.push(a), this.memoria.length > Pe && this.memoria.shift(), a.usado < this.pisoGlobal && (this.pisoGlobal = a.usado), a.usado > this.picoGlobal && (this.picoGlobal = a.usado), this.valoresDeMemoria.size < Be && this.valoresDeMemoria.add(a.usado);
  }
  tarefaLonga(a) {
  ...
  // ── Leitura ───────────────────────────────────────────────────────────────
  leituraDeMemoria() {
    const a = this.memoria, e = a[0], o = a[a.length - 1], i = a.length, t = Math.max(1, Math.floor(i / 3)), n = i ? _a(a.slice(0, t)) : 0, l = i ? _a(a.slice(i - t)) : 0, s = l - n, d = this.valoresDeMemoria.size, m = i ? _a(a.slice(t, i - t)) : 0, p = l - m;
    let u;
    return i < Fe ? u = `Só ${i} amostra(s) — o piso ainda não significa nada.` : d < 2 ? u = `${i} amostras, mas um único valor de heap: o navegador ainda não atualizou a leitura. Sem informação — precisa de sessão longa.` : s > va && p > va ? u = `Piso subiu ${(s / 1048576).toFixed(1)} MB e AINDA sobe (${(p / 1048576).toFixed(1)} MB no último terço) — isto é retenção.` : s > va ? u = `Subiu ${(s / 1048576).toFixed(1)} MB desde a carga e estabilizou em ${(l / 1048576).toFixed(0)} MB — é custo de partida, não vazamento.` : u = `Piso estável em ${d} degraus — a variação do heap é coleta de lixo, não vazamento.`, {
      amostras: i,
      ...e ? { primeira: e } : {},
      ...o ? { ultima: o } : {},
  ...
  leituraDeTarefas(a) {
    const e = this.tarefasTotal - this.tarefasNaCarga, o = Math.max(0, a - Ga) / 6e4;
    return {
  ...
  instantaneo(a) {
    const o = [...this.componentes.values()].sort(
      ...
      render: { ...l.render },
      motivos: [...l.motivos.entries()].map(([s, d]) => ({ motivo: s, total: d })).sort((s, d) => d.total - s.total).slice(0, Ve),
      timers: { ...l.timers },
...
function O(r, a, e) {
  const o = window.setTimeout(() => {
    K.delete(o), y.timerEncerrado(r), a();
  }, e);
  return K.set(o, "espera"), y.timerCriado(r), o;
}
function k(r, a) {
  if (a === void 0) return;
  const e = K.get(a);
 ...
 */
const da = globalThis, Da = da.ShadowRoot && (da.ShadyCSS === void 0 || da.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ra = Symbol(), Ha = /* @__PURE__ */ new WeakMap();
let ue = class {
  constructor(a, e, o) {
    if (this._$cssResult$ = !0, o !== Ra) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (Da && a === void 0) {
      ...
      o && (a = Ha.get(e)), a === void 0 && ((this.o = a = new CSSStyleSheet()).replaceSync(this.cssText), o && Ha.set(e, a));
    }
    return a;
  }
  toString() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: eo, defineProperty: oo, getOwnPropertyDescriptor: io, getOwnPropertyNames: to, getOwnPropertySymbols: ro, getPrototypeOf: no } = Object, fa = globalThis, Xa = fa.trustedTypes, so = Xa ? Xa.emptyScript : "", lo = fa.reactiveElementPolyfillSupport, J = (r, a) => r, Ma = { toAttribute(r, a) {
  switch (a) {
    case Boolean:
      r = r ? so : null;
      break;
  ...
  return e;
} }, ge = (r, a) => !eo(r, a), Qa = { attribute: !0, type: String, converter: Ma, reflect: !1, useDefault: !1, hasChanged: ge };
...
let B = class extends HTMLElement {
  ...
  static createProperty(a, e = Qa) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(a) && ((e = Object.create(e)).wrapped = !0), this.elementProperties.set(a, e), !e.noAccessor) {
      ...
      i !== void 0 && oo(this.prototype, a, i);
    }
  }
  static getPropertyDescriptor(a, e, o) {
    const { get: i, set: t } = io(this.prototype, a) ?? { get() {
      return this[e];
    }, set(n) {
      this[e] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(J("properties"))) {
      const e = this.properties, o = [...to(e), ...ro(e)];
  ...
  static finalizeStyles(a) {
    ...
    if (Array.isArray(a)) {
      ...
      for (const i of o) e.unshift(Ya(i));
  ...
  createRenderRoot() {
    ...
    return ao(a, this.constructor.elementStyles), a;
  }
  connectedCallback() {
  ...
  _$ET(a, e) {
    ...
    if (i !== void 0 && o.reflect === !0) {
      const t = (o.converter?.toAttribute !== void 0 ? o.converter : Ma).toAttribute(e, o.type);
  ...
  _$AK(a, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const t = o.getPropertyOptions(i), n = typeof t.converter == "function" ? { fromAttribute: t.converter } : t.converter?.fromAttribute !== void 0 ? t.converter : Ma;
      this._$Em = i;
      const l = n.fromAttribute(e, t.type);
  ...
  requestUpdate(a, e, o, i = !1, t) {
    if (a !== void 0) {
      ...
      if (i === !1 && (t = this[a]), o ??= n.getPropertyOptions(a), !((o.hasChanged ?? ge)(t, e) || o.useDefault && o.reflect && t === this._$Ej?.get(a) && !this.hasAttribute(n._$Eu(a, o)))) return;
      this.C(a, e, o);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (o.size > 0) for (const [i, t] of o) {
        const { wrapped: n } = t, l = this[i];
        n !== !0 || this._$AL.has(i) || l === void 0 || this.C(i, void 0, t, l);
      }
    }
    let a = !1;
    const e = this._$AL;
...
B.elementStyles = [], B.shadowRootOptions = { mode: "open" }, B[J("elementProperties")] = /* @__PURE__ */ new Map(), B[J("finalized")] = /* @__PURE__ */ new Map(), lo?.({ ReactiveElement: B }), (fa.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Na = globalThis, Wa = (r) => r, ma = Na.trustedTypes, Za = ma ? ma.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, be = "$lit$", T = `lit$${Math.random().toFixed(9).slice(2)}$`, fe = "?" + T, co = `<${fe}>`, j = document, aa = () => j.createComment(""), ea = (r) => r === null || typeof r != "object" && typeof r != "function", Pa = Array.isArray, po = (r) => Pa(r) || typeof r?.[Symbol.iterator] == "function", wa = `[ 	
\f\r]`, Q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ja = /-->/g, Ka = />/g, D = RegExp(`>|${wa}(?:([^\\s"'>=/]+)(${wa}*=${wa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ae = /'/g, ee = /"/g, xe = /^(?:script|style|textarea|title)$/i, ve = (r) => (a, ...e) => ({ _$litType$: r, strings: a, values: e }), c = ve(1), ya = ve(2), G = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), oe = /* @__PURE__ */ new WeakMap(), N = j.createTreeWalker(j, 129);
function _e(r, a) {
  if (!Pa(r) || !r.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return Za !== void 0 ? Za.createHTML(a) : a;
}
const mo = (r, a) => {
  const e = r.length - 1, o = [];
  let i, t = a === 2 ? "<svg>" : a === 3 ? "<math>" : "", n = Q;
  for (let l = 0; l < e; l++) {
    const s = r[l];
    let d, m, p = -1, u = 0;
    for (; u < s.length && (n.lastIndex = u, m = n.exec(s), m !== null); ) u = n.lastIndex, n === Q ? m[1] === "!--" ? n = Ja : m[1] !== void 0 ? n = Ka : m[2] !== void 0 ? (xe.test(m[2]) && (i = RegExp("</" + m[2], "g")), n = D) : m[3] !== void 0 && (n = D) : n === D ? m[0] === ">" ? (n = i ?? Q, p = -1) : m[1] === void 0 ? p = -2 : (p = n.lastIndex - m[2].length, d = m[1], n = m[3] === void 0 ? D : m[3] === '"' ? ee : ae) : n === ee || n === ae ? n = D : n === Ja || n === Ka ? n = Q : (n = D, i = void 0);
    const b = n === D && r[l + 1].startsWith("/>") ? " " : "";
    t += n === Q ? s + co : p >= 0 ? (o.push(d), s.slice(0, p) + be + s.slice(p) + T + b) : s + T + (p === -2 ? l : b);
  }
  return [_e(r, t + (r[e] || "<?>") + (a === 2 ? "</svg>" : a === 3 ? "</math>" : "")), o];
};
class oa {
  constructor({ strings: a, _$litType$: e }, o) {
    ...
    this.parts = [];
    let t = 0, n = 0;
    const l = a.length - 1, s = this.parts, [d, m] = mo(a, e);
    if (this.el = oa.createElement(d, o), N.currentNode = this.el.content, e === 2 || e === 3) {
      const p = this.el.content.firstChild;
      p.replaceWith(...p.childNodes);
    }
    for (; (i = N.nextNode()) !== null && s.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const p of i.getAttributeNames()) if (p.endsWith(be)) {
          const u = m[n++], b = i.getAttribute(p).split(T), f = /([.?@])?(.*)/.exec(u);
          s.push({ type: 1, index: t, name: f[2], strings: b, ctor: f[1] === "." ? uo : f[1] === "?" ? go : f[1] === "@" ? bo : xa }), i.removeAttribute(p);
        } else p.startsWith(T) && (s.push({ type: 6, index: t }), i.removeAttribute(p));
        if (xe.test(i.tagName)) {
          const p = i.textContent.split(T), u = p.length - 1;
          if (u > 0) {
            i.textContent = ma ? ma.emptyScript : "";
            for (let b = 0; b < u; b++) i.append(p[b], aa()), N.nextNode(), s.push({ type: 2, index: ++t });
            i.append(p[u], aa());
          }
        }
      } else if (i.nodeType === 8) if (i.data === fe) s.push({ type: 2, index: t });
      else {
        let p = -1;
        for (; (p = i.data.indexOf(T, p + 1)) !== -1; ) s.push({ type: 7, index: t }), p += T.length - 1;
      }
      t++;
    }
  }
...
function H(r, a, e = r, o) {
  if (a === G) return a;
  let i = o !== void 0 ? e._$Co?.[o] : e._$Cl;
  const t = ea(a) ? void 0 : a._$litDirective$;
  return i?.constructor !== t && (i?._$AO?.(!1), t === void 0 ? i = void 0 : (i = new t(r), i._$AT(r, e, o)), o !== void 0 ? (e._$Co ??= [])[o] = i : e._$Cl = i), i !== void 0 && (a = H(r, i._$AS(r, a.values), i, o)), a;
}
class ho {
  constructor(a, e) {
  ...
  u(a) {
    const { el: { content: e }, parts: o } = this._$AD, i = (a?.creationScope ?? j).importNode(e, !0);
    N.currentNode = i;
    let t = N.nextNode(), n = 0, l = 0, s = o[0];
    for (; s !== void 0; ) {
      if (n === s.index) {
        let d;
        s.type === 2 ? d = new ia(t, t.nextSibling, this, a) : s.type === 1 ? d = new s.ctor(t, s.name, s.strings, this, a) : s.type === 6 && (d = new fo(t, this, a)), this._$AV.push(d), s = o[++l];
      }
      n !== s?.index && (t = N.nextNode(), n++);
    }
...
class ia {
  ...
  _$AI(a, e = this) {
    a = H(this, a, e), ea(a) ? a === h || a == null || a === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : a !== this._$AH && a !== G && this._(a) : a._$litType$ !== void 0 ? this.$(a) : a.nodeType !== void 0 ? this.T(a) : po(a) ? this.k(a) : this._(a);
  }
  O(a) {
  ...
  _(a) {
    this._$AH !== h && ea(this._$AH) ? this._$AA.nextSibling.data = a : this.T(j.createTextNode(a)), this._$AH = a;
  }
  $(a) {
    const { values: e, _$litType$: o } = a, i = typeof o == "number" ? this._$AC(a) : (o.el === void 0 && (o.el = oa.createElement(_e(o.h, o.h[0]), this.options)), o);
    if (this._$AH?._$AD === i) this._$AH.p(e);
    else {
      const t = new ho(i, this), n = t.u(this.options);
      t.p(e), this.T(n), this._$AH = t;
    }
  }
  _$AC(a) {
    let e = oe.get(a.strings);
    return e === void 0 && oe.set(a.strings, e = new oa(a)), e;
  }
  k(a) {
    Pa(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let o, i = 0;
    for (const t of a) i === e.length ? e.push(o = new ia(this.O(aa()), this.O(aa()), this, this.options)) : o = e[i], o._$AI(t), i++;
    i < e.length && (this._$AR(o && o._$AB.nextSibling, i), e.length = i);
  }
  _$AR(a = this._$AA.nextSibling, e) {
    for (this._$AP?.(!1, !0, e); a !== this._$AB; ) {
      const o = Wa(a).nextSibling;
      Wa(a).remove(), a = o;
    }
  }
  setConnected(a) {
...
class xa {
  ...
  _$AI(a, e = this, o, i) {
    ...
    if (t === void 0) a = H(this, a, e, 0), n = !ea(a) || a !== this._$AH && a !== G, n && (this._$AH = a);
      ...
      const l = a;
      let s, d;
      for (a = t[0], s = 0; s < t.length - 1; s++) d = H(this, l[o + s], e, s), d === G && (d = this._$AH[s]), n ||= !ea(d) || d !== this._$AH[s], d === h ? a = h : a !== h && (a += (d ?? "") + t[s + 1]), this._$AH[s] = d;
    }
    n && !i && this.j(a);
  }
  j(a) {
...
const xo = Na.litHtmlPolyfillSupport;
xo?.(oa, ia), (Na.litHtmlVersions ??= []).push("3.3.3");
const vo = (r, a, e) => {
  const o = e?.renderBefore ?? a;
  let i = o._$litPart$;
  if (i === void 0) {
    const t = e?.renderBefore ?? null;
    o._$litPart$ = i = new ia(a.insertBefore(aa(), t), t, void 0, e ?? {});
  }
  return i._$AI(r), i;
};
/**
...
class C extends B {
  ...
  update(a) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(a), this._$Do = vo(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const _o = La.litElementPolyfillSupport;
_o?.({ LitElement: C });
...
`, wo = "media_player.spotifyplus_bruno_helasio", W = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], ca = ["playing", "paused", "on"], ja = [
  {
    id: "sala",
    name: "Sala",
    section: "sala",
...
function zo(r) {
  ...
  for (const { entityId: i, roomId: t, field: n } of a) {
    const l = r.states[i];
    l ? l.state === "unavailable" ? e.push({ entityId: i, roomId: t, field: n, problem: "unavailable" }) : o++ : e.push({ entityId: i, roomId: t, field: n, problem: "missing" });
  }
  return { total: a.length, ok: o, issues: e };
}
function $o(r) {
  return ko(r).ausentes.map((a) => ({
    tipo: "scene",
    entityId: a.entity,
    nome: a.name,
...
async function Eo(r) {
  ...
  const o = await Promise.all(
    a.cameras.map(async (t) => {
      ...
      try {
        ...
        return l.includes("web_rtc") ? { ...t, caminho: "web_rtc" } : l.includes("hls") ? { ...t, caminho: "hls" } : t;
      } catch {
        return t;
      }
    })
  ...
  return {
    ...
    cameras: o,
    resumo: i,
    veredito: qe(i, o.length, a.streamCarregado)
  };
}
function ye(r) {
  const a = {
  ...
  for (const [t, n] of Object.entries(r.states)) {
    ...
    e.push({
      entityId: t,
      nome: String(l.friendly_name ?? t),
      estado: String(n.state),
      caminho: Co(l, String(n.state)),
      suportaStream: (s & So) !== 0
    });
  }
...
class Mo extends C {
  constructor() {
    super(...arguments), this._env = Ao(), this._sondando = !1, this._mensagem = "";
  }
  static {
    this.properties = {
      _hass: { state: !0 }
   ...
   */
  _runtime() {
    const a = pa(), e = (s) => (s / 1048576).toFixed(1) + " MB", o = (s) => s.toFixed(1) + " ms", i = a.vazamentos, t = i.timers + i.listeners + i.assinaturas, n = a.desdeAMarca, l = n ? n.instancias + n.timers + n.listeners + n.assinaturas : 0;
    return c`
      <div>
        <h2>Runtime</h2>
        <dl>
      ...
      (s) => c`<li>
                  ...
                  ${s.requisicoes.total ? c` · ${s.requisicoes.total} req (${s.requisicoes.falhas} falhas, pior ${o(s.requisicoes.pior)})` : h}
        ...
        ${this._mensagem ? c`<p class="empty">${this._mensagem}</p>` : h}
      </div>
    `;
  }
  /**
  ...
  _cameras() {
    !this._sondaProfunda && !this._sondando && this._hass && (this._sondando = !0, Eo(this._hass).then((e) => {
      this._sondaProfunda = e, this._sondando = !1, this.requestUpdate();
    }));
    const a = this._sondaProfunda ?? ye(this._hass);
    return a.cameras.length ? c`
      <div>
        ...
        <ul>
          ${a.cameras.map((e) => c`<li>${e.entityId} → ${e.caminho}${e.suportaStream ? " · stream" : ""}</li>`)}
        </ul>
      </div>
    ` : h;
  }
  ...
  render() {
    const a = this._env, e = zo(this._hass), o = e.issues.filter((n) => n.problem === "missing"), i = e.issues.filter((n) => n.problem === "unavailable"), t = $o(this._hass);
    return c`
      <div class="card">
        <div>
          <h2>Diagnóstico</h2>
      ...
      (n) => c`<li class="warn">${n.roomId} · ${n.field} → ${n.entityId}</li>`
        ...
        ${this._runtime()}
        ${this._cameras()}
        ${this._hass ? h : c`<p class="empty">Aguardando o objeto hass…</p>`}
      </div>
    `;
  }
}
customElements.get("bruno-diagnostics") || customElements.define("bruno-diagnostics", Mo);
const ha = window;
ha.customCards = ha.customCards ?? [];
ha.customCards.some((r) => r.type === "bruno-diagnostics") || ha.customCards.push({
...
function To(r) {
  const { hass: a, groupEntityId: e, activeSensorId: o, fallbackLightIds: i = [] } = r, t = r.now ?? Date.now(), n = e ? a.states[e] : void 0, l = o ? a.states[o] : void 0;
  let s = null;
  ...
  const m = Io(n);
  s === null && m.length > 0 && (s = m.filter((b) => a.states[b]?.state === "on").length), s === null && i.length > 0 && (s = i.filter((b) => a.states[b]?.state === "on").length), s === null && (s = n?.state === "on" ? 1 : 0);
  let p = String(l?.attributes.lights_elapsed ?? "");
  if (!p) {
    const b = m.length > 0 ? m : i;
    let f = null;
    for (const v of b) {
      const A = a.states[v];
...
function Do(r) {
  const { hass: a, semanticSensorId: e, motionRecentId: o, occupancyId: i } = r, t = e ? a.states[e] : void 0, n = String(t?.state ?? "").toLowerCase(), l = t?.attributes.display;
...
function ie(r, a, e = ["on", "home", "active", "yes"]) {
  if (!a) return !1;
  const o = r.states[a];
...
function ze(r, a, e) {
  return !r || !ke.includes(String(r.state).toLowerCase()) ? !1 : No(r.attributes, a) ? !0 : Po(r.attributes, e);
}
function Po(r, a) {
  ...
  const i = r ?? {}, t = R(e.media_title), n = R(i.media_title);
  if (t && n && t === n) return !0;
  const l = R(e.media_artist), s = R(i.media_artist);
  return !!(t && n && t.includes(n) && l && s && l === s);
}
const Lo = "∅", jo = (r) => r ? `${r.state}@${r.last_changed}` : Lo;
class Va {
  constructor(a = [], e = {}) {
  ...
  projetar(a, e) {
    return (this.projecoes[e] ?? jo)(a.states[e]);
  }
  /**
...
const Vo = /^[a-z_]+\.[a-z0-9_]+$/, Fo = 8;
function re(r, a = 0) {
  const e = [], o = /* @__PURE__ */ new Set(), i = (t, n) => {
    if (!(n > Fo || t == null)) {
      if (typeof t == "string") {
        Vo.test(t) && !o.has(t) && (o.add(t), e.push(t));
        return;
      }
      if (Array.isArray(t)) {
        for (const l of t) i(l, n + 1);
        return;
      }
      if (typeof t == "object")
        for (const l of Object.values(t)) i(l, n + 1);
    }
  };
  return i(r, a), e;
}
const qa = "bruno-room-tile", Bo = 1200, Uo = 560, ne = 10;
function se() {
  return {
    pointerId: null,
    down: !1,
...
class Go extends C {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), Ta(qa), globalThis.removeEventListener?.("bruno-theme-changed", this._onThemeChanged);
  ...
  _onMove(a, e) {
    ...
    i <= ne && t <= ne || (o.moved = !0, o.holdTimer !== null && (window.clearTimeout(o.holdTimer), this._timers.delete(o.holdTimer), o.holdTimer = null), this._classe(this._alvoSeletor(a), "is-pressed", !1));
  }
  _onUp(a, e) {
    const o = this._gestures[a];
  ...
  _runAction(a) {
    ...
    const i = Date.now();
    if (i - this._lastAction < Bo) return;
    this._lastAction = i;
  ...
  _posicionarPainel() {
    ...
    const o = 10, i = window.innerWidth || document.documentElement.clientWidth, t = window.innerHeight || document.documentElement.clientHeight, n = a.offsetWidth || 520, l = a.offsetHeight || 240;
    let s = e.right - n;
    s = Math.min(Math.max(s, o), Math.max(o, i - n - o));
    let d = e.bottom + o;
    d + l > t - o && (d = e.top - l - o), d = Math.min(Math.max(d, o), Math.max(o, t - l - o)), a.style.left = `${Math.round(s)}px`, a.style.top = `${Math.round(d)}px`;
  }
  ...
  _dots() {
    ...
    const o = e.activeSensor ? a.states[e.activeSensor] : void 0, i = (t) => {
      const n = (t.states ?? []).map((m) => m.toLowerCase()), l = (t.entities ?? []).some((m) => {
        const p = a.states[m];
        return !!p && n.includes(String(p?.state ?? "").toLowerCase());
      }), s = t.activeAttr ? le(o?.attributes[t.activeAttr]) : !1, d = t.spotifyDevice ? ze(a.states[wo], t.spotifyDevice) : !1;
      return l || s || d;
    };
  ...
  _applianceLine() {
    ...
    if (!a || !e || !o) return "";
    const i = e.activeSensor ? a.states[e.activeSensor] : void 0, t = (o.states ?? []).map((d) => d.toLowerCase()), n = o.entity ? a.states[o.entity] : void 0;
  ...
  render() {
    ...
    if (!a) return h;
    const o = e ? ie(e, a.entities.lightGroup ?? a.entities.lights?.[0]) : !1, i = e ? te(e, a.entities.temperature, "°") : "--", t = e ? te(e, a.entities.humidity, "%") : "--", n = !!(a.entities.temperature ?? a.entities.humidity), l = this._statusLines(), s = this._dots(), d = "20260808-maquetes-premium-1", m = a.assetOff ? `/local/bruno-ui/assets/${a.assetOff}.png?v=${d}` : "", p = a.assetOn ? `/local/bruno-ui/assets/${a.assetOn}.png?v=${d}` : "", u = [
      "room-card",
      o ? "is-room-on" : "",
    ...
    return c`
      <div class=${u}>
        ${this._tileMode && this._config?.divider_left ? c`<span class="tile-divider" aria-hidden="true"></span>` : h}
        <button
          class="room-action"
          type="button"
          aria-label=${b}
        ...
        >
          <div class="room-icon" aria-hidden="true">
            <span class="room-asset-wrap">
              ${m ? c`<img class="room-asset room-asset-off" src=${m} alt="" decoding="async" />` : h}
              ${p ? c`<img class="room-asset room-asset-on" src=${p} alt="" decoding="async" />` : h}
            </span>
          </div>
          ...
          >
            <span class="room-title-row">
              ...
              ${f ? c`<span class="room-chevron" aria-hidden="true">›</span>` : h}
            </span>
              ...
              <section class="room-popup-panel" role="document" @click=${(g) => g.stopPropagation()}>
                <header class="room-popup-header">
                  ...
                  <div class="room-popup-title">
                    ...
                    ${v.subtitle ? c`<span>${v.subtitle}</span>` : h}
                  </div>
                  <button
...
customElements.get("bruno-room-tile") || customElements.define("bruno-room-tile", Go);
const ua = window;
ua.customCards = ua.customCards ?? [];
ua.customCards.some((r) => r.type === "bruno-room-tile") || ua.customCards.push({
...
}, U = /* @__PURE__ */ new Set(), L = { timer: void 0, ouvindoVisibilidade: !1 }, Yo = 1e3;
function $e() {
  for (const r of [...U])
    try {
      r();
...
function Se() {
  L.timer !== void 0 || U.size === 0 || Ae() || (L.timer = globalThis.setInterval($e, Yo));
}
function Ce() {
...
function Qo() {
  L.ouvindoVisibilidade || typeof document > "u" || (document.addEventListener("visibilitychange", Xo), L.ouvindoVisibilidade = !0);
}
function Wo(r) {
  U.add(r), Qo(), Se();
  let a = !1;
...
const I = "ha-web-rtc-player", Zo = 6e3, za = 48, $a = 27;
let Aa;
function Jo(r) {
  return r.split(".")[1] ?? r;
}
function P(r, a, e = 0, o = !0) {
  F(`marco: ${Jo(r)} · player webrtc · ${a}`, e, o);
}
function Ko() {
  return typeof customElements > "u" ? Promise.resolve(!1) : customElements.get(I) ? Promise.resolve(!0) : new Promise((r) => {
    ...
    }, o = globalThis.setTimeout(() => e(!!customElements.get(I)), Zo);
    customElements.whenDefined(I).then(() => e(!0));
  });
}
async function ai(r, a) {
...
async function Ee(r, a) {
  ...
  P(r, "ausente; carregando modulo", 0, !1), Aa ??= ai(r, a).finally(() => {
    Aa = void 0;
  });
  const o = await Aa, i = typeof performance < "u" ? performance.now() : Date.now();
  return P(r, o ? "definido sob demanda" : "definicao indisponivel", i - e, o), o;
}
function Me() {
...
function ei(r) {
  ...
  for (let s = 0; s + 3 < r.length; s += 4) {
    ...
    const d = r[s] ?? 0, m = r[s + 1] ?? 0, p = r[s + 2] ?? 0, u = d >> 4 | m >> 4 << 4 | p >> 4 << 8;
    a.set(u, (a.get(u) ?? 0) + 1), e++;
  }
  if (e < 32) return !1;
  let o = 0, i = 0;
  for (const [s, d] of a)
    d <= o || (o = d, i = s);
  const t = (i & 15) * 16 + 8, n = (i >> 4 & 15) * 16 + 8, l = (i >> 8 & 15) * 16 + 8;
  return o / e >= 0.45 && n >= 80 && n - t >= 48 && n - l >= 48;
}
function Ba(r) {
  if (typeof document > "u") return !1;
  try {
    const a = document.createElement("canvas");
    a.width = za, a.height = $a;
    const e = a.getContext("2d", { willReadFrequently: !0 });
    return e ? (e.drawImage(r, 0, 0, za, $a), ei(
      e.getImageData(0, 0, za, $a).data
    )) : !1;
  } catch {
    return !1;
  }
...
const oi = {
  ...
  principal: 1500,
  secundaria: 3e3
}, ti = 25e3, ri = 300, ni = 6e4, si = 12e3, ce = { comImagem: 2, semImagem: 4 };
function li(r, a) {
...
const ci = (r, a) => {
  ...
  return e.onload = () => i(Ba(e) ? "quadro-verde" : !0), e.onerror = () => i(!1), e.src = r, () => {
...
class Te {
  constructor(a = {}) {
    this.cameras = /* @__PURE__ */ new Map(), this.ligado = !1, this.carregador = a.carregador ?? ci, this.agenda = a.agenda ?? di, this.aoCarregar = a.aoCarregar ?? (() => {
  ...
  buscar(a) {
    ...
    const e = li(a.alvo.base, Math.round(a.inicio) || 1);
    a.prazo = this.agenda.agendar(() => this.encerrar(a, "prazo", e), ti), a.abortar = this.carregador(
      e,
      (o) => this.encerrar(
        a,
  ...
  agendarProximo(a, e) {
    ...
    let i = Math.max(ii[o], Oe[o] - e);
    const t = a.quadros === 0, n = t ? ce.semImagem : ce.comImagem, l = t ? si : ni;
...
const zi = ["on", "playing", "paused", "idle"], $i = ["playing", "paused", "on", "idle"], Ai = ["streaming", "recording", "idle", "on"], Si = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], Ci = ["cooling", "heating", "drying", "fan", "preheating"], Ei = ["off", "idle"], Mi = 4e3, Oi = 3e4, Ti = 700, Ii = "/local/bruno-ui/assets/tcl-qled-mini-led-75.png?v=20260802-assets-resize-1", Di = "/local/images/echo_pop.png?v=20260702-all-images-1", Ri = "/local/images/office_pc.png?v=20260702-all-images-1";
function V(r, a = 0) {
  const e = Number(r);
...
class Ni extends C {
  constructor() {
    super(...arguments), this._lightsOpen = !1, this._folha = null, this._folhaSaindo = !1, this._fonteMidia = "", this._fonteMidiaManual = !1, this._midiaAtivasAntes = [], this._menuMidiaAberto = !1, this._spotifyFerramentas = !1, this._painelClima = "", this._controlesCameraAbertos = !1, this._cameraAtiva = "", this._urlsCarregadas = {}, this._ultimaImagem = {}, this._motorCameras = new Te({
      ...
      aoMedir: (a, e, o, i) => {
        const t = a.split(".")[1] ?? a;
        F(`câmera ${t}`, e, o === "ok"), i && F(`câmera ${t} · 1º quadro`, e, !0);
      }
      ...
      if (Ba(o)) {
        this._quadroVerdeRegistrado !== e && (this._quadroVerdeRegistrado = e, P(
          e,
          "quadro verde rejeitado",
          performance.now() - this._liveIniciadoEm,
          !1
        )), k(x, this._timerQuadroVerde), this._timerQuadroVerde = O(x, () => {
          this._timerQuadroVerde = void 0, this._aoCarregarAoVivo();
        }, 700);
        return;
      }
      this._livePronto = e, this._estadoAoVivo = "ao-vivo", k(x, this._timerQuadroVerde), this._timerQuadroVerde = void 0, a.classList.add("is-ready"), k(x, this._timerAoVivo), this._timerAoVivo = void 0;
      const i = e.split(".")[1] ?? e;
      F(
      ...
      a.detail?.dialog === "ha-more-info-dialog" && this._estadoAoVivo === "entregue-more-info" && (this._estadoAoVivo = "retomando", P(this._cameraAtiva, "more-info fechado; retomando"), k(x, this._timerRetomadaAoVivo), this._timerRetomadaAoVivo = O(x, () => {
  ...
  setConfig(a) {
    ...
    this._config = a, this._room = e, this._sub = Ho[a.room], this._config, this._hass, this._observador.observar([
      ...re(e),
      ...re(this._sub)
  ...
  update(a) {
    const e = this._motivo;
    this._motivo = "", Ia(x, () => super.update(a), e || this._motivoPadrao());
  }
  _motivoPadrao() {
  ...
  _iniciarTimerRelogio() {
    this._cancelarRelogio || (this._cancelarRelogio = Wo(() => {
      const a = this._hora();
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), Ta(x), globalThis.BrunoSurfaceMaterial?.disconnect?.(this), this._limparFolhaImediatamente(), this._pararVigiaTelefone(), this._encerrarArrasto(), this._pararTimerCameras(), this._tokenDefinicaoPlayer++, this._estadoAoVivo = "ocioso", this._pararAoVivo(), k(x, this._timerRetomadaAoVivo), this._timerRetomadaAoVivo = void 0, this._timerLuzes && (k(x, this._timerLuzes), this._timerLuzes = void 0), this._pararTimerRelogio(), this._ouvindoVisibilidade && (la(x, document, "visibilitychange", this._aoMudarVisibilidade), this._ouvindoVisibilidade = !1), this._ouvindoFechamentoDialogo && (la(x, window, "dialog-closed", this._aoFecharDialogo), this._ouvindoFechamentoDialogo = !1);
  }
  /**
  ...
  _cuidarDoAoVivo(a) {
    ...
    if (!this._liveEl || this._liveEntity !== e) {
      ...
      if (!t) {
        ...
        Ee(e, this._hass).then((l) => {
          !this.isConnected || n !== this._tokenDefinicaoPlayer || (this._estadoAoVivo = l ? "ocioso" : "fallback", this._fallbackAoVivo = l ? "" : e, this._sincronizarCameras());
        });
        return;
      }
      this._estadoAoVivo = "negociando", this._liveEl = t, this._liveEntity = e, sa(x, t, "load", this._aoCarregarAoVivo), sa(x, t, "streams", this._aoInformarStreams), o.appendChild(t), this._iniciarPlayerAposContexto(t, e);
      return;
    }
  ...
  _iniciarPlayerAposContexto(a, e) {
    Promise.resolve(a.updateComplete).then(() => {
      this._liveEl !== a || this._liveEntity !== e || !a.isConnected || (this._liveIniciadoEm = performance.now(), a.entityid = e, P(e, "entityid atribuido"), this._armarPrazoAoVivo(a, e));
    }).catch(() => {
      this._liveEl === a && this._liveEntity === e && this._falharAoVivo("contexto");
    });
  }
  _armarPrazoAoVivo(a, e) {
    k(x, this._timerAoVivo), this._timerAoVivo = O(x, () => {
  ...
  _pararAoVivo() {
    k(x, this._timerAoVivo), this._timerAoVivo = void 0, k(x, this._timerQuadroVerde), this._timerQuadroVerde = void 0;
    const a = this._liveEl;
    a && (la(x, a, "load", this._aoCarregarAoVivo), la(x, a, "streams", this._aoInformarStreams), a.remove()), this._liveEl = void 0, this._liveEntity = "", this._livePronto = "", this._quadroVerdeRegistrado = "", this._modoPlayer = "nenhum";
  }
  /**
  ...
  _injetarMaterial(a = 0) {
    ...
    if (!i) {
      a < 20 && O(x, () => this._injetarMaterial(a + 1), 60);
      return;
    }
    try {
   ...
   */
  _renderTopBand() {
    const a = this._room?.entities, e = this._hass, o = (l) => l && e ? e.states[l] : void 0, i = this._contarLuzes(), t = o(a?.motionRecent)?.state === "on", n = [
      {
    ...
    return c`
      ...
      (l) => c`
              <div
                ...
                data-phone-hide=${l.ocultarNoTelefone ? "" : h}
                style="--tone: ${l.tone};"
              >
  ...
  _valorSensor(a, e, o = 0) {
    ...
    return !i || ["unknown", "unavailable", "none", ""].includes(t) ? "--" : `${V(i.state, o)}${e}`;
  }
   ...
   */
  _alternarDock() {
    this._lightsOpen = !this._lightsOpen, this._luzesAssentadas = !1, k(x, this._timerLuzes), this._timerLuzes = O(x, () => {
  ...
  _sincronizarAlturaLuzesTelefone() {
    ...
    let i = 0, t = 0, n = 0;
    for (const p of o) {
      const u = p.querySelectorAll(".light-cell").length, b = Math.ceil(u / 2);
      if (!b) continue;
      const f = Number.parseFloat(getComputedStyle(p).rowGap) || 0;
      i += b, t += p.getBoundingClientRect().height, n += Math.max(0, b - 1) * f;
    }
    if (!i) return;
    const l = Math.max(0, e.scrollHeight - t), s = (e.clientHeight - l - n - 2) / i, d = Math.floor(Math.max(56, Math.min(60, s)) * 10) / 10;
  ...
  _abrirFolha(a) {
    if (this._estaNoTelefone()) {
      ...
      k(x, this._timerFecharFolha), this._timerFecharFolha = void 0, this._folhaSaindo = !1, this._folha = a, this._folha === "luzes" && (this._lightsOpen = !0, this._luzesAssentadas = !0), this._aplicarAtributos(), this._avisarFolha(), this.requestUpdate();
    }
  }
  _fecharFolha() {
    if (!this._folha || this._folhaSaindo) return;
    if (this._encerrarArrasto(), this._folhaSaindo = !0, this._aplicarAtributos(), this.requestUpdate(), typeof globalThis.matchMedia == "function" && globalThis.matchMedia("(prefers-reduced-motion: reduce)").matches) {
      this._limparFolhaImediatamente();
      return;
    }
    this._timerFecharFolha = O(x, () => {
      this._timerFecharFolha = void 0, this._limparFolhaImediatamente();
    }, 280);
  }
  _limparFolhaImediatamente(a = !0) {
    const e = !!this._folha;
    k(x, this._timerFecharFolha), this._timerFecharFolha = void 0, this._folhaSaindo = !1, this._folha = null, this._encerrarArrasto(), this._aplicarAtributos(), e && a && this._avisarFolha(), this.requestUpdate();
  }
  /**
  ...
  _renderSecoesDeLuz() {
    ...
    const l = n.map((d) => {
      ...
      return {
        ...
        nome: e[d] ?? i[d] ?? d.charAt(0).toUpperCase() + d.slice(1),
        icone: o[d] ?? t[d] ?? "mdi:lightbulb-group",
        luzes: m,
      ...
      return c`
        <section class="light-section">
          ...
          <div class="light-grid">
            ${d.luzes.map((p, u) => this._renderCelulaDeLuz(p, u, m))}
          </div>
        </section>
      `;
    });
  ...
  _renderCelulaDeLuz(a, e, o) {
    const i = this._hass?.states[a.entity]?.state === "on", t = o && e === 0, n = o ? e - 1 : e, l = t ? 0 : Math.floor(n / 2) + (o ? 1 : 0), s = [
      "light-cell",
      i ? "is-on" : "",
      t ? "is-wide" : "",
      !t && l > 0 ? "has-rule-top" : "",
  ...
  _iconeDaLuz(a, e) {
    ...
    return c`<span class="tpl-light-icon icon-${i} ${e ? "is-on" : ""}">
    ...
    return c`
      ...
      ([t, n, l]) => c`
              ...
              <div class="curtain-slider-zone">
                ...
                <input
                  ...
                  max="100"
                  step="1"
                  .value=${String(this._posicaoCortina())}
                  aria-label="Posição da cortina"
                  ?disabled=${o}
                  @change=${(t) => this._posicionarCortina(Number(t.currentTarget.value))}
                />
      ...
      (t) => c`
                      <button
                        ...
                        ?disabled=${o}
                        @click=${() => this._posicionarCortina(100 - t)}
                      >
                        ${t}%
                      </button>
                    `
   ...
   */
  _cameraViva(a) {
    const e = this._estado(a.entity), o = this._indisponivel(e), i = !o && Ai.includes(String(e?.state ?? "")), t = String(e?.attributes.entity_picture ?? "");
   ...
   */
  _renderFeed(a, e) {
    const o = a?.shortName || a?.name || "Câmera", t = !!this._controleCamera(a, "privacy")?.ativo, n = !a || a.indisponivel, l = [
      "camera-main",
      "camera-feed",
      ...
      n ? "is-unavailable" : ""
        ...
        </div>` : t ? c`<div class="camera-state-surface">
            <bruno-icon icon="mdi:eye-off-outline"></bruno-icon><span>Modo privacidade ativo</span>
          </div>` : h, d = !!(a && !e && Sa(a.entity)), m = c`
      <div class="camera-row-image">
        ${d ? c`<div class="camera-live-slot" data-camera-live=${a.entity}></div>` : h}
        ${a ? c`<img
              src=${a.url}
    ...
    >
      ${m}
    </button>` : c`<div class=${l} aria-label=${`Câmera ${o}`}>${m}</div>`;
  }
  /** Câmeras: cabeçalho com o menu de três pontos + palco com feed e PIP. */
  _renderCameras() {
    const a = this._camerasConfiguradas().map((l) => this._cameraViva(l));
    if (!a.length)
      return c`
      ...
      `;
    const e = a.find((l) => l.entity === this._cameraAtiva) ?? a[0], o = a.find((l) => l.online), i = e?.online || !o ? e : o, t = a.find((l) => l.entity !== i?.entity), n = this._controlesCameraAbertos;
    return c`
      <div class="glass-card cameras-card cameras-card-controls">
        <div class="mh-head cameras-head">
          <div class="mh-head-title">
  ...
  _modeloTv() {
    const a = this._estado(this._idDe("tv")), e = a?.attributes ?? {}, o = a?.state ?? "off", i = zi.includes(o), t = String(e.source ?? e.app_name ?? "") || "HDMI 1", n = String(e.media_title ?? e.media_series_title ?? e.app_name ?? "");
    return {
      st: a,
      estado: o,
      ativo: i,
  ...
  _modeloSpotify() {
    const a = this._estado(this._idDe("spotify")), e = a?.attributes ?? {}, o = a?.state ?? "off", t = $i.includes(o) && ze(
      a,
      this._sub?.spotifyDeviceName,
      this._estado(this._idDe("speaker"))
    ), n = String(e.media_title ?? "") || "SpotifyPlus", l = Number(e.media_duration) || 0, s = Number(e.media_position) || 0, d = Date.parse(String(e.media_position_updated_at ?? "")), m = t && o === "playing", p = m && Number.isFinite(d) ? s + (Date.now() - d) / 1e3 : s, u = l > 0 ? Math.max(0, Math.min(l, p)) : Math.max(0, p);
    return {
      st: a,
      ativo: t,
      tocando: m,
      ...
      progresso: l > 0 ? Math.max(0, Math.min(100, u / l * 100)) : 0,
      decorrido: de(u),
      total: l > 0 ? de(l) : "--:--"
    };
  }
  ...
  _botaoMidia(a, e, o, i = {}) {
    ...
    return c`
      <button
        ...
        @click=${o}
      >
        <bruno-icon icon=${e}></bruno-icon>${t ? h : c`<span>${a}</span>`}
      </button>
    `;
  }
  /**
  ...
  _arteMidia(a, e, o, i) {
    return c`
      <div class="mh-art mh-art-${e} ${i ? "is-cover" : "is-standby"}">
        ${a ? c`<img src=${a} alt="" loading="lazy" />` : c`<bruno-icon icon=${o}></bruno-icon>`}
      </div>
    `;
  }
  _corpoTv() {
    const a = this._modeloTv(), e = this._idDe("tv"), o = this._sub?.tvStandbyImage ?? Ii, t = (!(!a.titulo || /^TV (ligada|desligada)$/i.test(a.titulo) || a.titulo === a.fonte) && a.estado === "playing" ? a.titulo : "") || a.fonte;
    if (!a.ativo)
      return c`
        <div class="mh-left">
    ...
    return c`
      <div class="mh-left">
        <div class="mh-info">
          <small>Ligada</small>${t ? c`<em>${t}</em>` : h}
        </div>
        <div class="mh-controls">${this._linhaVolume(e, a.volume ?? 60)} ${l}</div>
      </div>
  ...
  _corpoPc() {
    const a = this._modeloPc(), e = this._sub?.pcImage ?? Ri, o = a.ativo ? [a.sessao, a.janela].filter((t) => t && t !== "--")[0] || "Sessão ativa" : "Pronto para ligar", i = (t) => () => {
    ...
    return c`
      <div class="mh-left">
        ...
        <div class="mh-controls">
          ${a.ativo ? c`<div class="mh-btn-row mh-btn-row-5 office-pc-actions">
  ...
  _corpoSpotify() {
    const a = this._modeloSpotify(), e = this._idDe("spotify"), o = this._sub?.spotifyStandbyImage ?? Di;
    if (!a.ativo)
      return c`
        <div class="mh-left">
      ...
      `;
    const i = this._spotifyFerramentas ? c`<div class="mh-btn-row mh-btn-row-4">
    ...
    return c`
      <div class="mh-left">
        <div class="mh-info">
          <small>${a.titulo}</small>${a.artista ? c`<em>${a.artista}</em>` : h}
  ...
  _maisInfo(a) {
    a && (Sa(a) && (this._tokenDefinicaoPlayer++, this._estadoAoVivo = "entregue-more-info", P(a, "entregue ao more-info"), this._pararAoVivo(), this._sincronizarCameras()), this.dispatchEvent(
    ...
    return c`
      ...
      this._menuMidiaAberto = !this._menuMidiaAberto, this.requestUpdate();
        ...
        <div class="mh-sources">
          ${n.map((p) => {
      const u = p.chave === s, b = ["mh-source", u ? "is-open" : "", p.ativo ? "is-active" : ""].filter(Boolean).join(" "), f = [
        "mh-source-body",
        `mh-source-body-${p.chave}`,
        p.ativo ? "is-source-active" : "is-source-idle",
        p.atmosfera ? "has-atmosphere" : ""
      ].filter(Boolean).join(" ");
      return c`
              <div class=${b}>
                <button
                  ...
                  @click=${() => this._selecionarFonteMidia(p.chave)}
                >
                  <bruno-icon
                  ...
                  ${u ? h : c`<bruno-icon class="mh-src-chevron" icon="mdi:chevron-right"></bruno-icon>`}
                </button>
                ${u ? c`<div class=${f}>
                      ${this._estaNoTelefone() && p.atmosfera ? c`<img class="mh-now-atmosphere" src=${p.atmosfera} alt="" aria-hidden="true" />` : h}
                      ${p.corpo()}
                    </div>` : h}
              </div>
            `;
  ...
  _renderEletrodomesticos() {
    ...
    return Array.isArray(a) ? a.filter((e) => !!e && typeof e == "object").map((e) => {
      const o = String(e.key ?? "item").replace(/[^a-z0-9_-]/gi, "-").toLowerCase(), i = String(e.name ?? "Eletrodoméstico"), t = typeof e.image == "string" ? e.image : "", n = typeof e.entity == "string" ? e.entity : "", l = typeof e.stateEntity == "string" ? e.stateEntity : n, s = l && this._hass ? this._hass.states[l] : void 0, d = Array.isArray(e.activeStates) ? e.activeStates.map((A) => String(A).toLowerCase()) : ["on"], m = typeof e.activeAttr == "string" ? e.activeAttr : "", p = this._room?.activeSensor ? this._hass?.states[this._room.activeSensor] : void 0, u = d.includes(String(s?.state ?? "").toLowerCase()) || (m ? ki(p?.attributes[m]) : !1), b = !!e.placeholder || !n, f = typeof e.moreInfoEntity == "string" ? e.moreInfoEntity : n, v = ["appliance-tile", `is-${o}`, u ? "is-on" : "", b ? "is-muted" : ""].filter(Boolean).join(" ");
      return c`
          <article class=${v}>
            <button
              type="button"
            ...
            >
              <div class="appliance-visual" data-image-wrapper>
                ${t ? c`<img src=${t} alt="" loading="lazy" decoding="async" />` : h}
              </div>
              <div class="appliance-copy">
                <strong>${i}</strong>
                <small>${this._rotuloDoAparelho(e, s, u, b)}</small>
              </div>
            </button>
            <button
              type="button"
  ...
  _rotuloDoAparelho(a, e, o, i) {
    const t = (l, s) => typeof a[l] == "string" ? a[l] : s;
   ...
   */
  _modeloClimate() {
    const a = this._estadoClimate(), e = a?.attributes ?? {}, o = String(e.hvac_action ?? "").toLowerCase(), i = this._indisponivel(a), t = i || a?.state === "off" ? !1 : Ci.includes(o) ? !0 : Ei.includes(o) ? !1 : Si.includes(String(a?.state ?? "")), n = (l, s) => Number.isFinite(Number(l)) ? Number(l) : s;
    return {
      st: a,
      indisponivel: i,
      ativo: t,
  ...
  _renderAnelClimate(a) {
    const s = Number.isFinite(a.minima) ? a.minima : 12, d = Number.isFinite(a.maxima) ? a.maxima : 30, m = Number.isFinite(Number(a.alvo)) ? Math.max(s, Math.min(d, Number(a.alvo))) : s + (d - s) / 2, u = -180 + 180 * Math.max(0, Math.min(1, (m - s) / Math.max(1, d - s))), b = (w, q) => {
      const z = q * Math.PI / 180;
      return { x: 360 + w * Math.cos(z), y: 410 + w * Math.sin(z) };
    }, f = (w, q, z) => {
      const E = b(w, q), M = b(w, z), ra = Math.abs(z - q) <= 180 ? "0" : "1";
      return `M ${E.x.toFixed(3)} ${E.y.toFixed(3)} A ${w} ${w} 0 ${ra} 1 ${M.x.toFixed(3)} ${M.y.toFixed(3)}`;
    }, v = Array.from({ length: 91 }, (w, q) => {
      const z = -180 + 180 * (q / 90), E = q % 15 === 0, M = q % 5 === 0, ra = b(319, z), Ua = b(E ? 293 : M ? 299 : 306, z), Re = E ? "icg-tick major" : M ? "icg-tick medium" : "icg-tick minor";
      return ya`<line x1=${ra.x.toFixed(3)} y1=${ra.y.toFixed(3)} x2=${Ua.x.toFixed(3)} y2=${Ua.y.toFixed(3)} class=${Re}></line>`;
    }), A = Array.from({ length: 73 }, (w, q) => {
      const z = -180 + 180 * (q / 72), E = b(267, z), M = b(251, z);
    ...
    }), S = b(285, u), Y = a.alvo == null ? "--" : V(a.alvo, 0), X = a.atual == null ? "--" : V(a.atual, 1), ta = (a.modo === "cool" ? "Resfriamento" : a.modo === "heat" ? "Aquecimento" : a.modo === "fan_only" ? "Ventilacao" : "Temperatura").toUpperCase();
    return c`
      <div class="icg-root">
        <div class="icg-shell">
          <svg
  ...
  _renderAC() {
    const a = this._entidadeClimate(), e = this._modeloClimate(), o = e.swing.toLowerCase(), i = ["on", "ativo", "ativada", "enabled"].includes(o) || o.includes("ativ") && !o.includes("desativ"), t = (m) => [...new Set(m.filter(Boolean))], n = this._painelClima, l = {
      ...
      this._painelClima = this._painelClima === m ? "" : m, this.requestUpdate();
        ...
        >
          ...
          <span class="ac-action-text"><small>${u}</small><strong>${b}</strong></span>
        </button>
        ${s(m)}
      </div>
    `;
...
customElements.get("bruno-room-subview") || customElements.define("bruno-room-subview", Ni);
const ga = window;
...
const $ = new Pi();
function Li(r) {
  const a = $.obter(r.type);
  if (a)
    return a.create(r);
}
function pe(r) {
  return $.obter(r.type)?.entities(r) ?? [];
}
function ji(r) {
  const a = [], e = /* @__PURE__ */ new Set();
  for (const [o, i] of r.entries()) {
    const t = i.id || `posição ${o}`;
    i.id ? e.has(i.id) ? a.push(`id repetido — "${i.id}"`) : e.add(i.id) : a.push(`dispositivo em ${t}: falta "id"`), i.type ? $.conhece(i.type) || a.push(`dispositivo "${t}": tipo não registrado — "${i.type}"`) : a.push(`dispositivo "${t}": falta "type"`), i.name || a.push(`dispositivo "${t}": falta "name"`);
    const n = $.obter(i.type)?.validate?.(i);
...
], Fi = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], Bi = ["on", "playing", "paused", "idle", "buffering"];
class ba extends C {
  static {
  ...
  get _entityId() {
    return Ie(this._instancia?.entity, this._hass);
  }
  _estado(a) {
    return a && this._hass ? this._hass.states[a] : void 0;
  }
...
class Ui extends ba {
  ...
  render() {
    ...
    if (!e) return c`<p class="indisponivel">Entidade indisponível: ${a ?? "—"}</p>`;
    const o = Bi.includes(String(e.state)), i = String(e.attributes.source ?? e.attributes.app_name ?? "") || "HDMI 1", t = e.attributes.volume_level != null ? Math.round(Number(e.attributes.volume_level) * 100) : null;
    return c`
      <div class="titulo">
...
class Gi extends ba {
  ...
  render() {
    const a = this._entityId, e = this._estado(a);
    if (!e) return c`<p class="indisponivel">Entidade indisponível: ${a ?? "—"}</p>`;
    const o = Fi.includes(String(e.state)), i = Number(e.attributes.temperature), t = Number(e.attributes.current_temperature), n = Number.isFinite(Number(e.attributes.min_temp)) ? Number(e.attributes.min_temp) : 16, l = Number.isFinite(Number(e.attributes.max_temp)) ? Number(e.attributes.max_temp) : 30, s = Number(e.attributes.target_temp_step) || 1, d = Array.isArray(e.attributes.hvac_modes) ? e.attributes.hvac_modes : [], m = (p) => this._servico("climate", "set_temperature", {
      entity_id: a,
...
customElements.get("bruno-control-tv") || customElements.define("bruno-control-tv", Ui);
customElements.get("bruno-control-climate") || customElements.define("bruno-control-climate", Gi);
function De(r) {
  return (a) => {
...
const Ea = "bruno-devices-panel", Hi = ["on", "playing", "paused", "idle", "buffering", "cool", "heat", "fan_only", "dry", "heat_cool", "auto"];
class Yi extends C {
  constructor() {
  ...
  _estaAtivo(a) {
    const e = Ie(a.entity, this._hass), o = e && this._hass ? this._hass.states[e] : void 0;
    return !!o && Hi.includes(String(o?.state ?? "").toLowerCase());
  }
  /**
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), Ta(Ea);
  }
  /** Mede o custo de cada atualizacao (Fase 6.0.1). */
  update(a) {
    const e = this._motivo;
    this._motivo = "", Ia(Ea, () => super.update(a), e || "outro");
  }
  render() {
    const a = ji(this._dispositivos), e = this._idAberto;
    return c`
          ...
          this._selecionado = i.id, this.requestUpdate();
                    ...
                    >
                      <span class="item-icone">
                        <bruno-icon icon=${i.icon ?? $.obter(i.type)?.icon ?? "mdi:remote"}></bruno-icon>
                      </span>
...
customElements.get("bruno-devices-panel") || customElements.define("bruno-devices-panel", Yi);
Je();
console.info("[bruno-dashboard] build 20260814");
globalThis.BrunoCameraEngine = Te;
globalThis.BrunoCameraLive = oi;
//# sourceMappingURL=bruno-dashboard.BiGrF8VE.js.map
