 ...
 *   Mídia             ┘
 *
 * A folha sobe pela base, cobre as linhas e o dock, e o fundo escurece —
 * MENOS a câmera, que fica acima do escurecimento e continua transmitindo.
...
export const SUBVIEW_TELEFONE_CSS = css`
  @media (max-width: 800px) {
    ...
    /* ANTERIOR (rollback refinamento mobile): zerar o estado escondia a folha
       sem transicao. O host agora conserva data-folha por 180ms e acrescenta
    ...
    :host([data-folha][data-folha-saindo]) .room-subview .glass-card.appliances-card {
      animation: fone-folha-desce 180ms cubic-bezier(0.4, 0, 0.8, 0.2) forwards;
      pointer-events: none;
    }
