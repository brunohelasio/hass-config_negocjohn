  ...
  _openSpotifyPlusPopup(mode = 'full') {
    ...
    this._fireDomEvent({
      ...
      browser_mod: {
        ...
        data: {
          title: 'Spotify',
          tag: `spotify_quarto_marina_${mode}`,
  ...
  _cameraFrame(camera) {
    ...
    return `
      <div class="camera-row-image">
        ...
        ${camera?.entity ? `<div class="camera-live" data-camera-live-mount="${BrunoQuartoMarinaSubview._escapeAttr(camera.entity)}"></div>` : ''}
        <div class="camera-placeholder" aria-hidden="true"></div>
      </div>
    `;
  }
  ...
  _renderMediaHubLegacy(model) {
    ...
    const standbyImage = (src, className, fallbackIcon) => (
      src
        ...
        : `<ha-icon icon="${BrunoQuartoMarinaSubview._escapeAttr(fallbackIcon)}"></ha-icon>`
    );
      ...
      return `
        ...
        >
          ${image
            ...
            : `<ha-icon icon="${BrunoQuartoMarinaSubview._escapeAttr(app.icon || 'mdi:apps')}"></ha-icon>`}
        </button>
      `;
    }).join('');
      ...
      <section class="glass-card spotify-card${spotify.active ? ' is-active' : ''}">
        ...
        <div class="spotify-body">
          <div class="spotify-art${artwork ? ' has-art' : ''}">
            ${artwork ? `<img src="${BrunoQuartoMarinaSubview._escapeAttr(artwork)}" alt="">` : '<ha-icon icon="mdi:music-note"></ha-icon>'}
          </div>
