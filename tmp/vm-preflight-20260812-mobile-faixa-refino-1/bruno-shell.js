...
class BrunoShell extends HTMLElement {
  ...
  connectedCallback() {
    ...
    // Folha aberta numa subview: o conteudo sobe acima do dock enquanto durar.
   ...
   */
  /**
   * Ergue o slot de conteudo enquanto ha bottom sheet aberta no telefone.
   *
   * Sem isto a folha e pintada SOB o dock (rail-slot z-index 2, content-slot
   * 1) e as ultimas linhas dela somem atras dos botoes. A alternativa era
   * fazer a folha parar acima do dock, e o usuario recusou: quebra a ideia de
   * folha subindo da borda inferior.
   *
    ...
    return `
      ...
      */
      ...
      @media (max-width: 800px) {
        ...
        /* Folha aberta: o conteudo sobe acima do dock. Ver _onFolha(). */
