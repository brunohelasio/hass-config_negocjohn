...
const Ge = 720, He = 200, Ye = 24, Xe = 4, Xa = 3e4, Qe = 12, Aa = 10 * 1024 * 1024, We = 64;
function $a(r) {
...
class Ze {
  ...
  de(a) {
    ...
    return e || (e = Ue(a), this.componentes.set(a, e)), e;
  }
  // ── Pontos de coleta ──────────────────────────────────────────────────────
  conectou(a) {
  ...
  renderizou(a, e, o) {
    ...
    const n = i.motivos.has(o) || i.motivos.size < Ye ? o : "outros";
  ...
  memoriaAmostrada(a) {
    this.memoria.push(a), this.memoria.length > Ge && this.memoria.shift(), a.usado < this.pisoGlobal && (this.pisoGlobal = a.usado), a.usado > this.picoGlobal && (this.picoGlobal = a.usado), this.valoresDeMemoria.size < We && this.valoresDeMemoria.add(a.usado);
  }
  tarefaLonga(a) {
    this.tarefas.push(a), this.tarefas.length > He && this.tarefas.shift(), this.tarefasTotal++, this.tarefasDuracao += a.duracao, a.duracao > this.tarefasPior && (this.tarefasPior = a.duracao), a.em < Xa && this.tarefasNaCarga++;
  }
  // ── Ciclo de navegação ────────────────────────────────────────────────────
  /**
  ...
  leituraDeTarefas(a) {
    const e = this.tarefasTotal - this.tarefasNaCarga, o = Math.max(0, a - Xa) / 6e4;
    return {
  ...
  instantaneo(a) {
    const o = [...this.componentes.values()].sort(
      ...
      render: { ...s.render },
      motivos: [...s.motivos.entries()].map(([c, l]) => ({ motivo: c, total: l })).sort((c, l) => l.total - c.total).slice(0, Xe),
      timers: { ...s.timers },
...
const w = new Ze(), Je = 5e3, K = { timerMemoria: void 0, observador: void 0 };
function Ke() {
  const r = performance;
  if (r.memory)
...
function ao(r) {
  ...
  if (a(), K.timerMemoria = window.setInterval(a, Je), "PerformanceObserver" in window)
    try {
...
function oo(r, a, e) {
  ...
  return X.set(o, "intervalo"), w.timerCriado(r), o;
}
function R(r, a, e) {
  const o = window.setTimeout(() => {
    X.delete(o), w.timerEncerrado(r), a();
  }, e);
  return X.set(o, "espera"), w.timerCriado(r), o;
}
function k(r, a) {
  if (a === void 0) return;
  const e = X.get(a);
  e !== void 0 && (e === "intervalo" ? window.clearInterval(a) : window.clearTimeout(a), X.delete(a), w.timerEncerrado(r));
}
function io() {
  return X.size;
}
...
function ga() {
  return { ...w.instantaneo(performance.now()), timersVivos: io() };
}
function no() {
  if (eo()) return;
  ao(ro());
 ...
 */
const ua = globalThis, Fa = ua.ShadowRoot && (ua.ShadyCSS === void 0 || ua.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Va = Symbol(), Qa = /* @__PURE__ */ new WeakMap();
let _e = class {
  constructor(a, e, o) {
...
}, Wa = Fa ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((a) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: lo, defineProperty: po, getOwnPropertyDescriptor: mo, getOwnPropertyNames: ho, getOwnPropertySymbols: uo, getPrototypeOf: go } = Object, ya = globalThis, Za = ya.trustedTypes, bo = Za ? Za.emptyScript : "", fo = ya.reactiveElementPolyfillSupport, aa = (r, a) => r, Da = { toAttribute(r, a) {
  switch (a) {
    case Boolean:
      r = r ? bo : null;
      break;
  ...
  return e;
} }, we = (r, a) => !lo(r, a), Ja = { attribute: !0, type: String, converter: Da, reflect: !1, useDefault: !1, hasChanged: we };
...
let H = class extends HTMLElement {
  ...
  static createProperty(a, e = Ja) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(a) && ((e = Object.create(e)).wrapped = !0), this.elementProperties.set(a, e), !e.noAccessor) {
      ...
      i !== void 0 && po(this.prototype, a, i);
    }
  }
  static getPropertyDescriptor(a, e, o) {
    const { get: i, set: t } = mo(this.prototype, a) ?? { get() {
      return this[e];
    }, set(n) {
      this[e] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(aa("properties"))) {
      const e = this.properties, o = [...ho(e), ...uo(e)];
  ...
  static finalizeStyles(a) {
    ...
    if (Array.isArray(a)) {
      ...
      for (const i of o) e.unshift(Wa(i));
    } else a !== void 0 && e.push(Wa(a));
    return e;
  }
  static _$Eu(a, e) {
    const o = e.attribute;
  ...
  createRenderRoot() {
    ...
    return co(a, this.constructor.elementStyles), a;
  }
  connectedCallback() {
  ...
  requestUpdate(a, e, o, i = !1, t) {
    if (a !== void 0) {
      ...
      if (i === !1 && (t = this[a]), o ??= n.getPropertyOptions(a), !((o.hasChanged ?? we)(t, e) || o.useDefault && o.reflect && t === this._$Ej?.get(a) && !this.hasAttribute(n._$Eu(a, o)))) return;
      this.C(a, e, o);
    }
...
H.elementStyles = [], H.shadowRootOptions = { mode: "open" }, H[aa("elementProperties")] = /* @__PURE__ */ new Map(), H[aa("finalized")] = /* @__PURE__ */ new Map(), fo?.({ ReactiveElement: H }), (ya.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ja = globalThis, Ka = (r) => r, ba = ja.trustedTypes, ae = ba ? ba.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, ye = "$lit$", D = `lit$${Math.random().toFixed(9).slice(2)}$`, qe = "?" + D, xo = `<${qe}>`, B = document, ia = () => B.createComment(""), ta = (r) => r === null || typeof r != "object" && typeof r != "function", Ba = Array.isArray, vo = (r) => Ba(r) || typeof r?.[Symbol.iterator] == "function", Sa = `[ 	
\f\r]`, Z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ee = /-->/g, oe = />/g, L = RegExp(`>|${Sa}(?:([^\\s"'>=/]+)(${Sa}*=${Sa}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ie = /'/g, te = /"/g, ke = /^(?:script|style|textarea|title)$/i, ze = (r) => (a, ...e) => ({ _$litType$: r, strings: a, values: e }), p = ze(1), Ca = ze(2), Q = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), re = /* @__PURE__ */ new WeakMap(), V = B.createTreeWalker(B, 129);
function Ae(r, a) {
...
const _o = (r, a) => {
  ...
  for (let s = 0; s < e; s++) {
    const c = r[s];
    let l, m, d = -1, u = 0;
    for (; u < c.length && (n.lastIndex = u, m = n.exec(c), m !== null); ) u = n.lastIndex, n === Z ? m[1] === "!--" ? n = ee : m[1] !== void 0 ? n = oe : m[2] !== void 0 ? (ke.test(m[2]) && (i = RegExp("</" + m[2], "g")), n = L) : m[3] !== void 0 && (n = L) : n === L ? m[0] === ">" ? (n = i ?? Z, d = -1) : m[1] === void 0 ? d = -2 : (d = n.lastIndex - m[2].length, l = m[1], n = m[3] === void 0 ? L : m[3] === '"' ? te : ie) : n === te || n === ie ? n = L : n === ee || n === oe ? n = Z : (n = L, i = void 0);
    const g = n === L && r[s + 1].startsWith("/>") ? " " : "";
    t += n === Z ? c + xo : d >= 0 ? (o.push(l), c.slice(0, d) + ye + c.slice(d) + D + g) : c + D + (d === -2 ? s : g);
  }
  return [Ae(r, t + (r[e] || "<?>") + (a === 2 ? "</svg>" : a === 3 ? "</math>" : "")), o];
};
class ra {
  constructor({ strings: a, _$litType$: e }, o) {
    ...
    this.parts = [];
    let t = 0, n = 0;
    const s = a.length - 1, c = this.parts, [l, m] = _o(a, e);
    ...
    for (; (i = V.nextNode()) !== null && c.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(ye)) {
          const u = m[n++], g = i.getAttribute(d).split(D), f = /([.?@])?(.*)/.exec(u);
          c.push({ type: 1, index: t, name: f[2], strings: g, ctor: f[1] === "." ? yo : f[1] === "?" ? qo : f[1] === "@" ? ko : qa }), i.removeAttribute(d);
      ...
      } else if (i.nodeType === 8) if (i.data === qe) c.push({ type: 2, index: t });
      else {
        let d = -1;
...
function W(r, a, e = r, o) {
  if (a === Q) return a;
  let i = o !== void 0 ? e._$Co?.[o] : e._$Cl;
  const t = ta(a) ? void 0 : a._$litDirective$;
  return i?.constructor !== t && (i?._$AO?.(!1), t === void 0 ? i = void 0 : (i = new t(r), i._$AT(r, e, o)), o !== void 0 ? (e._$Co ??= [])[o] = i : e._$Cl = i), i !== void 0 && (a = W(r, i._$AS(r, a.values), i, o)), a;
}
class wo {
  constructor(a, e) {
  ...
  u(a) {
    ...
    for (; c !== void 0; ) {
      if (n === c.index) {
        let l;
        c.type === 2 ? l = new na(t, t.nextSibling, this, a) : c.type === 1 ? l = new c.ctor(t, c.name, c.strings, this, a) : c.type === 6 && (l = new zo(t, this, a)), this._$AV.push(l), c = o[++s];
      }
...
class na {
  ...
  _$AI(a, e = this) {
    a = W(this, a, e), ta(a) ? a === h || a == null || a === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : a !== this._$AH && a !== Q && this._(a) : a._$litType$ !== void 0 ? this.$(a) : a.nodeType !== void 0 ? this.T(a) : vo(a) ? this.k(a) : this._(a);
  }
  O(a) {
  ...
  $(a) {
    const { values: e, _$litType$: o } = a, i = typeof o == "number" ? this._$AC(a) : (o.el === void 0 && (o.el = ra.createElement(Ae(o.h, o.h[0]), this.options)), o);
    if (this._$AH?._$AD === i) this._$AH.p(e);
    else {
      const t = new wo(i, this), n = t.u(this.options);
...
class qa {
  ...
  _$AI(a, e = this, o, i) {
    ...
    let n = !1;
    if (t === void 0) a = W(this, a, e, 0), n = !ta(a) || a !== this._$AH && a !== Q, n && (this._$AH = a);
    else {
      const s = a;
      let c, l;
      for (a = t[0], c = 0; c < t.length - 1; c++) l = W(this, s[o + c], e, c), l === Q && (l = this._$AH[c]), n ||= !ta(l) || l !== this._$AH[c], l === h ? a = h : a !== h && (a += (l ?? "") + t[c + 1]), this._$AH[c] = l;
    }
    n && !i && this.j(a);
  }
  j(a) {
...
const Ao = ja.litHtmlPolyfillSupport;
Ao?.(ra, na), (ja.litHtmlVersions ??= []).push("3.3.3");
const $o = (r, a, e) => {
...
class E extends H {
  ...
  update(a) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(a), this._$Do = $o(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const So = Ua.litElementPolyfillSupport;
So?.({ LitElement: E });
...
`, Co = "media_player.spotifyplus_bruno_helasio", J = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], pa = ["playing", "paused", "on"], Ga = [
  {
    id: "sala",
    name: "Sala",
    section: "sala",
...
async function Po(r) {
  ...
  return {
    ...
    cameras: o,
    resumo: i,
    veredito: Ce(i, o.length, a.streamCarregado)
  };
}
function Se(r) {
  const a = {
  ...
  for (const [t, n] of Object.entries(r.states)) {
    ...
    e.push({
      ...
      caminho: No(s, String(n.state)),
      suportaStream: (c & Do) !== 0
    });
  }
...
class Lo extends E {
  constructor() {
    super(...arguments), this._env = Ro(), this._sondando = !1, this._mensagem = "";
  }
  static {
    this.properties = {
      _hass: { state: !0 }
  ...
  _runtime() {
    ...
    return p`
      ...
      (c) => p`<li>
                  ...
                  ${c.requisicoes.total ? p` · ${c.requisicoes.total} req (${c.requisicoes.falhas} falhas, pior ${o(c.requisicoes.pior)})` : h}
  ...
  _cameras() {
    !this._sondaProfunda && !this._sondando && this._hass && (this._sondando = !0, Po(this._hass).then((e) => {
      this._sondaProfunda = e, this._sondando = !1, this.requestUpdate();
    }));
    const a = this._sondaProfunda ?? Se(this._hass);
  ...
  render() {
    const a = this._env, e = To(this._hass), o = e.issues.filter((n) => n.problem === "missing"), i = e.issues.filter((n) => n.problem === "unavailable"), t = Io(this._hass);
    return p`
      <div class="card">
        <div>
          <h2>Diagnóstico</h2>
...
customElements.get("bruno-diagnostics") || customElements.define("bruno-diagnostics", Lo);
const fa = window;
...
function ne(r, a, e = ["on", "home", "active", "yes"]) {
  if (!a) return !1;
  const o = r.states[a];
...
const Ee = ["playing", "paused"];
function Me(r, a, e) {
  return !r || !Ee.includes(String(r.state).toLowerCase()) ? !1 : Go(r.attributes, a) ? !0 : Ho(r.attributes, e);
}
function Ho(r, a) {
  if (!a || !Ee.includes(String(a.state).toLowerCase())) return !1;
...
const Yo = "∅", Xo = (r) => r ? `${r.state}@${r.last_changed}` : Yo;
class xa {
  constructor(a = [], e = {}) {
  ...
  projetar(a, e) {
    return (this.projecoes[e] ?? Xo)(a.states[e]);
  }
  /**
...
const Qo = /^[a-z_]+\.[a-z0-9_]+$/, Wo = 8;
function ce(r, a = 0) {
  const e = [], o = /* @__PURE__ */ new Set(), i = (t, n) => {
    if (!(n > Wo || t == null)) {
      if (typeof t == "string") {
        Qo.test(t) && !o.has(t) && (o.add(t), e.push(t));
        return;
      }
      if (Array.isArray(t)) {
...
const Ea = "bruno-room-tile", Zo = 1200, Jo = 560, le = 10;
function de() {
  return {
    pointerId: null,
    down: !1,
...
class Ko extends E {
  ...
  _onMove(a, e) {
    ...
    i <= le && t <= le || (o.moved = !0, o.holdTimer !== null && (window.clearTimeout(o.holdTimer), this._timers.delete(o.holdTimer), o.holdTimer = null), this._classe(this._alvoSeletor(a), "is-pressed", !1));
  }
  _onUp(a, e) {
    const o = this._gestures[a];
  ...
  _runAction(a) {
    ...
    const i = Date.now();
    if (i - this._lastAction < Zo) return;
    this._lastAction = i;
  ...
  _dots() {
    ...
    const o = e.activeSensor ? a.states[e.activeSensor] : void 0, i = (t) => {
      ...
      }), c = t.activeAttr ? pe(o?.attributes[t.activeAttr]) : !1, l = t.spotifyDevice ? Me(a.states[Co], t.spotifyDevice) : !1;
      return s || c || l;
    };
  ...
  _applianceLine() {
    ...
    if (!(!!n && t.includes(String(n?.state ?? "").toLowerCase()) || (o.activeAttr ? pe(i?.attributes[o.activeAttr]) : !1))) return "";
  ...
  render() {
    ...
    if (!a) return h;
    const o = e ? ne(e, a.entities.lightGroup ?? a.entities.lights?.[0]) : !1, i = e ? se(e, a.entities.temperature, "°") : "--", t = e ? se(e, a.entities.humidity, "%") : "--", n = !!(a.entities.temperature ?? a.entities.humidity), s = this._statusLines(), c = this._dots(), l = "20260808-maquetes-premium-1", m = a.assetOff ? `/local/bruno-ui/assets/${a.assetOff}.png?v=${l}` : "", d = a.assetOn ? `/local/bruno-ui/assets/${a.assetOn}.png?v=${l}` : "", u = [
      "room-card",
      o ? "is-room-on" : "",
              ...
              <section class="room-popup-panel" role="document" @click=${(b) => b.stopPropagation()}>
                <header class="room-popup-header">
                  ...
                  <div class="room-popup-title">
                    ...
                    ${x.subtitle ? p`<span>${x.subtitle}</span>` : h}
                  </div>
                  <button
                ...
                <div class="room-popup-lights">
                  ${x.lights.map((b) => {
      const P = e?.states[b.entity], A = String(P?.state ?? "").toLowerCase(), M = A === "on", O = !P || ["unavailable", "unknown", "none", ""].includes(A), za = [
        "room-popup-light",
        M ? "is-on" : "",
        O ? "is-unavailable" : ""
      ].filter(Boolean).join(" ");
      return p`<button
                    ...
                    >
                      ...
                      <span class="room-popup-light-copy">
                        ...
                        <span>${O ? "Indisponivel" : M ? "Ligada" : "Desligada"}</span>
                      </span>
                    </button>`;
    })}
                </div>
...
customElements.get("bruno-room-tile") || customElements.define("bruno-room-tile", Ko);
const va = window;
...
}, Y = /* @__PURE__ */ new Set(), j = { timer: void 0, ouvindoVisibilidade: !1 }, ei = 1e3;
function Oe() {
  for (const r of [...Y])
    try {
      r();
...
function Ie() {
  j.timer !== void 0 || Y.size === 0 || Te() || (j.timer = globalThis.setInterval(Oe, ei));
}
function Re() {
...
function ii() {
  j.ouvindoVisibilidade || typeof document > "u" || (document.addEventListener("visibilitychange", oi), j.ouvindoVisibilidade = !0);
}
function ti(r) {
  Y.add(r), ii(), Ie();
  let a = !1;
  return () => {
    a || (a = !0, Y.delete(r), Y.size === 0 && Re());
  };
}
const N = "ha-web-rtc-player", ri = 6e3, ea = 48, oa = 27, me = 500;
let Oa;
...
function C(r, a, e = 0, o = !0) {
  G(`marco: ${ni(r)} · player webrtc · ${a}`, e, o);
}
function si() {
  return typeof customElements > "u" ? Promise.resolve(!1) : customElements.get(N) ? Promise.resolve(!0) : new Promise((r) => {
    ...
    }, o = globalThis.setTimeout(() => e(!!customElements.get(N)), ri);
    customElements.whenDefined(N).then(() => e(!0));
  });
}
async function ci(r, a) {
  ...
  try {
    ...
    return i && a && (i.hass = a), await si();
  } catch {
    return !1;
  }
}
async function De(r, a) {
  if (typeof customElements < "u" && customElements.get(N)) return !0;
  const e = typeof performance < "u" ? performance.now() : Date.now();
  C(r, "ausente; carregando modulo", 0, !1), Oa ??= ci(r, a).finally(() => {
    Oa = void 0;
  });
  const o = await Oa, i = typeof performance < "u" ? performance.now() : Date.now();
    ...
    for (let l = 0; l < o; l++) {
      ...
      for (let f = c * n; f < (c + 1) * n; f++)
        for (let x = l * t; x < (l + 1) * t; x++) {
          ...
          if (d++, !Pe(b, P, A)) continue;
          u++;
          const M = b >> 4 | P >> 4 << 4 | A >> 4 << 8, O = (m.get(M) ?? 0) + 1;
          m.set(M, O), g = Math.max(g, O);
        }
...
function di(r, a = ea, e = oa) {
  ...
  return t / i >= 0.45 && Pe(s, c, l) || li(r, a, e);
}
function pi(r) {
  if (ma.has(r)) return;
  let a = 0;
  const e = () => {
    ...
    const i = globalThis.setTimeout(e, me);
    ma.set(r, i);
  }, o = globalThis.setTimeout(e, me);
  ma.set(r, o);
}
function ka(r) {
  ...
  try {
    ...
    return e ? (e.drawImage(r, 0, 0, ea, oa), di(
...
const mi = {
  ...
  principal: 1500,
  secundaria: 3e3
}, ui = 25e3, gi = 300, bi = 6e4, fi = 12e3, he = { comImagem: 2, semImagem: 4 };
function xi(r, a) {
...
class Fe {
  constructor(a = {}) {
    this.cameras = /* @__PURE__ */ new Map(), this.ligado = !1, this.carregador = a.carregador ?? vi, this.agenda = a.agenda ?? _i, this.aoCarregar = a.aoCarregar ?? (() => {
  ...
  buscar(a) {
    ...
    const e = xi(a.alvo.base, Math.round(a.inicio) || 1);
    a.prazo = this.agenda.agendar(() => this.encerrar(a, "prazo", e), ui), a.abortar = this.carregador(
      e,
      (o) => this.encerrar(
        a,
  ...
  agendarProximo(a, e) {
    ...
    let i = Math.max(hi[o], Le[o] - e);
    const t = a.quadros === 0, n = t ? he.semImagem : he.comImagem, s = t ? fi : bi;
...
const Ri = ["on", "playing", "paused", "idle"], Di = ["playing", "paused", "on", "idle"], Ni = ["streaming", "recording", "idle", "on"], Pi = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], Li = ["cooling", "heating", "drying", "fan", "preheating"], Fi = ["off", "idle"], Vi = [
  { visual: 0, position: 0 },
  { visual: 25, position: 33 },
  { visual: 50, position: 47 },
  { visual: 75, position: 70 },
  { visual: 100, position: 100 }
], ue = 3e4, ge = 1200, ji = 350, ha = 2, Bi = 1800, Ui = 700;
function Gi(r) {
  if (!r) return "∅";
...
const Hi = 4e3, Yi = 3e4, Xi = 700, Qi = "/local/bruno-ui/assets/tcl-qled-mini-led-75.png?v=20260802-assets-resize-1", Wi = "/local/images/echo_pop.png?v=20260702-all-images-1", Zi = "/local/images/office_pc.png?v=20260702-all-images-1";
function U(r, a = 0) {
  const e = Number(r);
...
class Ji extends E {
  ...
  setConfig(a) {
    ...
    this._config = a, this._room = e, this._sub = ai[a.room], this._config, this._hass;
    const o = [
      ...ce(e),
      ...ce(this._sub)
    ...
    }).filter((s) => !!s), n = Object.fromEntries(t.map((s) => [s, Gi]));
  ...
  _iniciarTimerRelogio() {
    this._cancelarRelogio || (this._cancelarRelogio = ti(() => {
      const a = this._hora();
  ...
  _interpolarCortina(a, e, o) {
    const i = this._percentualCortinaValido(a) ?? 0, t = Vi, n = t[0];
    if (i <= n[e]) return n[o];
  ...
  _fechamentoCortina() {
    ...
    if (e.retido)
      return !n && s != null && i - e.retidoEm >= Ui ? (this._movimentoCortina = void 0, s) : e.fechado;
    const c = i - e.iniciadoEm, l = s != null && Math.abs(s - e.alvoFechado) <= ha, m = t === "closed" && e.alvoFechado >= 100 - ha || t === "open" && e.alvoFechado <= ha;
    if (!n && c >= Bi && (l || m))
    ...
    if (s != null && !l && Math.abs(s - e.ultimoRelatado) >= 1)
      return e.ultimoRelatado = s, e.inicioFechado = s, e.iniciadoEm = i, e.duracao = Math.max(
        ge,
        ue * (Math.abs(e.alvoFechado - s) / 100)
      ), s;
    const g = this._fechamentoMovimentoCortina(e, i) ?? a;
    if (c >= e.duracao && !n) {
      this._movimentoCortina = void 0, this._pararTimerMovimentoCortina();
      const x = this._fechamentoCortinaComandado(), y = x != null && Math.abs(x - e.alvoFechado) <= ha;
  ...
  _iniciarTimerMovimentoCortina() {
    this._timerMovimentoCortina || !this.isConnected || (this._timerMovimentoCortina = oo(v, () => {
  ...
  _servico(a, e, o) {
    ...
    const { entity_id: i, ...t } = o, n = typeof i == "string" && i ? { entity_id: i } : void 0;
    this._hass.callService(a, e, t, n);
  }
  /**
   ...
   */
  _cameraViva(a) {
    const e = this._estado(a.entity), o = this._indisponivel(e), i = !o && Ni.includes(String(e?.state ?? "")), t = String(e?.attributes.entity_picture ?? "");
  ...
  _modeloTv() {
    const a = this._estado(this._idDe("tv")), e = a?.attributes ?? {}, o = a?.state ?? "off", i = Ri.includes(o), t = String(e.source ?? e.app_name ?? "") || "HDMI 1", n = String(e.media_title ?? e.media_series_title ?? e.app_name ?? "");
    return {
      st: a,
      estado: o,
      ativo: i,
  ...
  _modeloSpotify() {
    const a = this._estado(this._idDe("spotify")), e = a?.attributes ?? {}, o = a?.state ?? "off", t = Di.includes(o) && Me(
      a,
      this._sub?.spotifyDeviceName,
      this._estado(this._idDe("speaker"))
    ), n = String(e.media_title ?? "") || "SpotifyPlus", s = Number(e.media_duration) || 0, c = Number(e.media_position) || 0, l = Date.parse(String(e.media_position_updated_at ?? "")), m = t && o === "playing", d = m && Number.isFinite(l) ? c + (Date.now() - l) / 1e3 : c, u = s > 0 ? Math.max(0, Math.min(s, d)) : Math.max(0, d);
    return {
      st: a,
      estado: o,
      ativo: t,
  ...
  _corpoTv() {
    const a = this._modeloTv(), e = this._idDe("tv"), o = this._sub?.tvStandbyImage ?? Qi, t = (!(!a.titulo || /^TV (ligada|desligada)$/i.test(a.titulo) || a.titulo === a.fonte) && a.estado === "playing" ? a.titulo : "") || a.fonte;
    if (!a.ativo)
      return p`
        <div class="mh-left">
  ...
  _corpoPc() {
    const a = this._modeloPc(), e = this._sub?.pcImage ?? Zi, o = a.ativo ? [a.sessao, a.janela].filter((t) => t && t !== "--")[0] || "Sessão ativa" : "Pronto para ligar", i = (t) => () => {
  ...
  _corpoSpotify() {
    const a = this._modeloSpotify(), e = this._idDe("spotify"), o = this._sub?.spotifyStandbyImage ?? Wi;
    if (!a.ativo)
      return p`
        <div class="mh-left">
  ...
  _maisInfo(a) {
    a && (Ta(a) && (this._tokenDefinicaoPlayer++, this._estadoAoVivo = "entregue-more-info", C(a, "entregue ao more-info"), this._pararAoVivo(), this._sincronizarCameras()), this.dispatchEvent(
  ...
  _renderMediaHub() {
    ...
    ], s = Object.fromEntries(n.map((d) => [d.chave, d.ativo])), c = this._fonteAberta(n.map((d) => d.chave), s), l = n.find((d) => d.chave === c)?.ativo, m = [
      "glass-card",
      "media-hub-card",
  ...
  _renderEletrodomesticos() {
    ...
    return Array.isArray(a) ? a.filter((e) => !!e && typeof e == "object").map((e) => {
      const o = String(e.key ?? "item").replace(/[^a-z0-9_-]/gi, "-").toLowerCase(), i = String(e.name ?? "Eletrodoméstico"), t = typeof e.image == "string" ? e.image : "", n = typeof e.entity == "string" ? e.entity : "", s = typeof e.stateEntity == "string" ? e.stateEntity : n, c = s && this._hass ? this._hass.states[s] : void 0, l = Array.isArray(e.activeStates) ? e.activeStates.map((y) => String(y).toLowerCase()) : ["on"], m = typeof e.activeAttr == "string" ? e.activeAttr : "", d = this._room?.activeSensor ? this._hass?.states[this._room.activeSensor] : void 0, u = l.includes(String(c?.state ?? "").toLowerCase()) || (m ? Ii(d?.attributes[m]) : !1), g = !!e.placeholder || !n, f = typeof e.moreInfoEntity == "string" ? e.moreInfoEntity : n, x = ["appliance-tile", `is-${o}`, u ? "is-on" : "", g ? "is-muted" : ""].filter(Boolean).join(" ");
      return p`
          <article class=${x}>
            <button
              type="button"
   ...
   */
  _modeloClimate() {
    const a = this._estadoClimate(), e = a?.attributes ?? {}, o = String(e.hvac_action ?? "").toLowerCase(), i = this._indisponivel(a), t = i || a?.state === "off" ? !1 : Li.includes(o) ? !0 : Fi.includes(o) ? !1 : Pi.includes(String(a?.state ?? "")), n = (s, c) => Number.isFinite(Number(s)) ? Number(s) : c;
    return {
      st: a,
      indisponivel: i,
      ativo: t,
  ...
  _renderAnelClimate(a) {
    const l = Number.isFinite(a.minima) ? a.minima : 12, m = Number.isFinite(a.maxima) ? a.maxima : 30, d = Number.isFinite(Number(a.alvo)) ? Math.max(l, Math.min(m, Number(a.alvo))) : l + (m - l) / 2, g = -180 + 180 * Math.max(0, Math.min(1, (d - l) / Math.max(1, m - l))), f = (q, z) => {
      ...
      const T = f(q, z), I = f(q, $), sa = Math.abs($ - z) <= 180 ? "0" : "1";
      return `M ${T.x.toFixed(3)} ${T.y.toFixed(3)} A ${q} ${q} 0 ${sa} 1 ${I.x.toFixed(3)} ${I.y.toFixed(3)}`;
    }, y = Array.from({ length: 91 }, (q, z) => {
      const $ = -180 + 180 * (z / 90), T = z % 15 === 0, I = z % 5 === 0, sa = f(334, $), Ya = f(
        T ? 308 : I ? 314 : 321,
        $
      ), Be = T ? "icg-tick major" : I ? "icg-tick medium" : "icg-tick minor";
      return Ca`<line x1=${sa.x.toFixed(3)} y1=${sa.y.toFixed(3)} x2=${Ya.x.toFixed(3)} y2=${Ya.y.toFixed(3)} class=${Be}></line>`;
    }), b = Array.from({ length: 73 }, (q, z) => {
      const $ = -180 + 180 * (z / 72), T = f(282, $), I = f(266, $);
      return Ca`<line x1=${T.x.toFixed(3)} y1=${T.y.toFixed(3)} x2=${I.x.toFixed(3)} y2=${I.y.toFixed(3)} class="icg-inner-tick"></line>`;
    }), P = [
    ...
    }), A = f(315, g), M = a.alvo == null ? "--" : U(a.alvo, 0), O = a.atual == null ? "--" : U(a.atual, 1), za = (a.modo === "cool" ? "Resfriamento" : a.modo === "heat" ? "Aquecimento" : a.modo === "fan_only" ? "Ventilacao" : "Temperatura").toUpperCase();
    return p`
      <div class="icg-root">
        <div class="icg-shell">
          <svg
...
customElements.get("bruno-room-subview") || customElements.define("bruno-room-subview", Ji);
const _a = window;
...
], it = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], tt = ["on", "playing", "paused", "idle", "buffering"];
class wa extends E {
  static {
  ...
  get _entityId() {
    return Ve(this._instancia?.entity, this._hass);
  }
  _estado(a) {
    return a && this._hass ? this._hass.states[a] : void 0;
  }
...
class rt extends wa {
  ...
  render() {
    ...
    const o = tt.includes(String(e.state)), i = String(e.attributes.source ?? e.attributes.app_name ?? "") || "HDMI 1", t = e.attributes.volume_level != null ? Math.round(Number(e.attributes.volume_level) * 100) : null;
    return p`
      <div class="titulo">
...
customElements.get("bruno-control-tv") || customElements.define("bruno-control-tv", rt);
customElements.get("bruno-control-climate") || customElements.define("bruno-control-climate", nt);
function je(r) {
  return (a) => {
...
S.conhece("climate") || S.registrar({
  ...
  icon: "mdi:air-conditioner",
  create: je("bruno-control-climate"),
  entities: (r) => [typeof r.entity == "string" ? r.entity : r.entity?.[0] ?? ""].filter(Boolean),
  validate: (r) => ({
    ok: !!r.entity,
...
const Ra = "bruno-devices-panel", st = ["on", "playing", "paused", "idle", "buffering", "cool", "heat", "fan_only", "dry", "heat_cool", "auto"];
class ct extends E {
  constructor() {
  ...
  _estaAtivo(a) {
    const e = Ve(a.entity, this._hass), o = e && this._hass ? this._hass.states[e] : void 0;
    return !!o && st.includes(String(o?.state ?? "").toLowerCase());
  }
  /**
  ...
  render() {
    const a = et(this._dispositivos), e = this._idAberto;
    return p`
  ...
  entidadesObservadas() {
    return [...new Set(this._dispositivos.flatMap((a) => fe(a)))];
  }
  static {
    this.styles = _`
...
customElements.get("bruno-devices-panel") || customElements.define("bruno-devices-panel", ct);
no();
console.info("[bruno-dashboard] build 20260815");
globalThis.BrunoCameraEngine = Fe;
globalThis.BrunoCameraLive = mi;
//# sourceMappingURL=bruno-dashboard.BJutTx-c.js.map
