...
const BRUNO_QUARTO_CASAL_SUBVIEW_DEFAULT_CONFIG = {
  ...
  background: '/local/bruno-ui/assets/couple-bedroom-on-tight.png?v=20260609-rail-dynamic-1',
  fallback_background: '/local/bruno-ui/assets/couple-bedroom-off-tight.png?v=20260609-rail-dynamic-1',
  ...
  entities: {
    ...
    lights: [
      ...
      { entity: 'light.quarto_casal_2_switch_3', name: 'QC Luz cortineiro', icon_type: 'ledstrip', zone: 'sala' },
...
class BrunoQuartoCasalSubview extends HTMLElement {
  ...
  _renderError(error) {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="error">Erro na subview Sala: ${BrunoQuartoCasalSubview._escape(error?.message || error)}</div>
    `;
  }
