/**
 * REV.4 (Codex, 2026-08-09): o usuario aprovou tile e more-info do Office.
 * O mesmo caminho WebRTC direto foi liberado para os oito PROFILE_1 ONVIF
 * confirmados no registro da VM. Rollback desta rodada: voltar para a lista
 * de uma linha preservada logo acima da lista ativa.
 *
 ...
 */
// ANTERIOR (rollback ONVIF geral): somente o Office validado na primeira rodada.
// export const CAMERAS_WEBRTC: readonly string[] = ['camera.of_camera_profile_1'];
export const CAMERAS_WEBRTC: readonly string[] = [
