...
const Be = 720, Ue = 200, Ge = 24, He = 4, Ha = 3e4, Ye = 12, ka = 10 * 1024 * 1024, Xe = 64;
function za(r) {
...
class Qe {
  ...
  de(a) {
    ...
    return e || (e = Fe(a), this.componentes.set(a, e)), e;
  }
  // ── Pontos de coleta ──────────────────────────────────────────────────────
  conectou(a) {
  ...
  renderizou(a, e, o) {
    ...
    const n = i.motivos.has(o) || i.motivos.size < Ge ? o : "outros";
  ...
  memoriaAmostrada(a) {
    this.memoria.push(a), this.memoria.length > Be && this.memoria.shift(), a.usado < this.pisoGlobal && (this.pisoGlobal = a.usado), a.usado > this.picoGlobal && (this.picoGlobal = a.usado), this.valoresDeMemoria.size < Xe && this.valoresDeMemoria.add(a.usado);
  }
  tarefaLonga(a) {
    this.tarefas.push(a), this.tarefas.length > Ue && this.tarefas.shift(), this.tarefasTotal++, this.tarefasDuracao += a.duracao, a.duracao > this.tarefasPior && (this.tarefasPior = a.duracao), a.em < Ha && this.tarefasNaCarga++;
  }
  // ── Ciclo de navegação ────────────────────────────────────────────────────
  /**
  ...
  // ── Leitura ───────────────────────────────────────────────────────────────
  leituraDeMemoria() {
    const a = this.memoria, e = a[0], o = a[a.length - 1], i = a.length, t = Math.max(1, Math.floor(i / 3)), n = i ? za(a.slice(0, t)) : 0, c = i ? za(a.slice(i - t)) : 0, s = c - n, l = this.valoresDeMemoria.size, m = i ? za(a.slice(t, i - t)) : 0, d = c - m;
    let u;
    return i < Ye ? u = `Só ${i} amostra(s) — o piso ainda não significa nada.` : l < 2 ? u = `${i} amostras, mas um único valor de heap: o navegador ainda não atualizou a leitura. Sem informação — precisa de sessão longa.` : s > ka && d > ka ? u = `Piso subiu ${(s / 1048576).toFixed(1)} MB e AINDA sobe (${(d / 1048576).toFixed(1)} MB no último terço) — isto é retenção.` : s > ka ? u = `Subiu ${(s / 1048576).toFixed(1)} MB desde a carga e estabilizou em ${(c / 1048576).toFixed(0)} MB — é custo de partida, não vazamento.` : u = `Piso estável em ${l} degraus — a variação do heap é coleta de lixo, não vazamento.`, {
      amostras: i,
      ...e ? { primeira: e } : {},
      ...o ? { ultima: o } : {},
  ...
  instantaneo(a) {
    const o = [...this.componentes.values()].sort(
      ...
      render: { ...c.render },
      motivos: [...c.motivos.entries()].map(([s, l]) => ({ motivo: s, total: l })).sort((s, l) => l.total - s.total).slice(0, He),
      timers: { ...c.timers },
...
const w = new Qe(), We = 5e3, K = { timerMemoria: void 0, observador: void 0 };
function Ze() {
  const r = performance;
  if (r.memory)
...
function Je(r) {
  ...
  if (a(), K.timerMemoria = window.setInterval(a, We), "PerformanceObserver" in window)
    try {
...
function ha() {
  return { ...w.instantaneo(performance.now()), timersVivos: eo() };
}
function to() {
  if (Ke()) return;
  Je(io());
 ...
 */
const ua = globalThis, Pa = ua.ShadowRoot && (ua.ShadyCSS === void 0 || ua.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, La = Symbol(), Ya = /* @__PURE__ */ new WeakMap();
let xe = class {
  constructor(a, e, o) {
    if (this._$cssResult$ = !0, o !== La) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
const ro = (r) => new xe(typeof r == "string" ? r : r + "", void 0, La), _ = (r, ...a) => {
  const e = r.length === 1 ? r[0] : a.reduce((o, i, t) => o + ((n) => {
    if (n._$cssResult$ === !0) return n.cssText;
    if (typeof n == "number") return n;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(i) + r[t + 1], r[0]);
  return new xe(e, r, La);
}, no = (r, a) => {
  if (Pa) r.adoptedStyleSheets = a.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
...
}, Xa = Pa ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((a) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: so, defineProperty: co, getOwnPropertyDescriptor: lo, getOwnPropertyNames: po, getOwnPropertySymbols: mo, getPrototypeOf: uo } = Object, wa = globalThis, Qa = wa.trustedTypes, ho = Qa ? Qa.emptyScript : "", go = wa.reactiveElementPolyfillSupport, aa = (r, a) => r, Ia = { toAttribute(r, a) {
  switch (a) {
    case Boolean:
      r = r ? ho : null;
      break;
  ...
  return e;
} }, ve = (r, a) => !so(r, a), Wa = { attribute: !0, type: String, converter: Ia, reflect: !1, useDefault: !1, hasChanged: ve };
...
let H = class extends HTMLElement {
  ...
  static createProperty(a, e = Wa) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(a) && ((e = Object.create(e)).wrapped = !0), this.elementProperties.set(a, e), !e.noAccessor) {
      ...
      i !== void 0 && co(this.prototype, a, i);
    }
  }
  static getPropertyDescriptor(a, e, o) {
    const { get: i, set: t } = lo(this.prototype, a) ?? { get() {
      return this[e];
    }, set(n) {
      this[e] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(aa("properties"))) {
      const e = this.properties, o = [...po(e), ...mo(e)];
  ...
  createRenderRoot() {
    ...
    return no(a, this.constructor.elementStyles), a;
  }
  connectedCallback() {
  ...
  _$ET(a, e) {
    ...
    if (i !== void 0 && o.reflect === !0) {
      const t = (o.converter?.toAttribute !== void 0 ? o.converter : Ia).toAttribute(e, o.type);
  ...
  _$AK(a, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const t = o.getPropertyOptions(i), n = typeof t.converter == "function" ? { fromAttribute: t.converter } : t.converter?.fromAttribute !== void 0 ? t.converter : Ia;
      this._$Em = i;
  ...
  requestUpdate(a, e, o, i = !1, t) {
    if (a !== void 0) {
      ...
      if (i === !1 && (t = this[a]), o ??= n.getPropertyOptions(a), !((o.hasChanged ?? ve)(t, e) || o.useDefault && o.reflect && t === this._$Ej?.get(a) && !this.hasAttribute(n._$Eu(a, o)))) return;
      this.C(a, e, o);
    }
...
H.elementStyles = [], H.shadowRootOptions = { mode: "open" }, H[aa("elementProperties")] = /* @__PURE__ */ new Map(), H[aa("finalized")] = /* @__PURE__ */ new Map(), go?.({ ReactiveElement: H }), (wa.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Va = globalThis, Za = (r) => r, ga = Va.trustedTypes, Ja = ga ? ga.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, _e = "$lit$", D = `lit$${Math.random().toFixed(9).slice(2)}$`, we = "?" + D, bo = `<${we}>`, B = document, ia = () => B.createComment(""), ta = (r) => r === null || typeof r != "object" && typeof r != "function", ja = Array.isArray, fo = (r) => ja(r) || typeof r?.[Symbol.iterator] == "function", $a = `[ 	
\f\r]`, Z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ka = /-->/g, ae = />/g, L = RegExp(`>|${$a}(?:([^\\s"'>=/]+)(${$a}*=${$a}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ee = /'/g, oe = /"/g, ye = /^(?:script|style|textarea|title)$/i, qe = (r) => (a, ...e) => ({ _$litType$: r, strings: a, values: e }), p = qe(1), Aa = qe(2), Q = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), ie = /* @__PURE__ */ new WeakMap(), j = B.createTreeWalker(B, 129);
function ke(r, a) {
  if (!ja(r) || !r.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const xo = (r, a) => {
  ...
  for (let c = 0; c < e; c++) {
    const s = r[c];
    let l, m, d = -1, u = 0;
    for (; u < s.length && (n.lastIndex = u, m = n.exec(s), m !== null); ) u = n.lastIndex, n === Z ? m[1] === "!--" ? n = Ka : m[1] !== void 0 ? n = ae : m[2] !== void 0 ? (ye.test(m[2]) && (i = RegExp("</" + m[2], "g")), n = L) : m[3] !== void 0 && (n = L) : n === L ? m[0] === ">" ? (n = i ?? Z, d = -1) : m[1] === void 0 ? d = -2 : (d = n.lastIndex - m[2].length, l = m[1], n = m[3] === void 0 ? L : m[3] === '"' ? oe : ee) : n === oe || n === ee ? n = L : n === Ka || n === ae ? n = Z : (n = L, i = void 0);
    const g = n === L && r[c + 1].startsWith("/>") ? " " : "";
    t += n === Z ? s + bo : d >= 0 ? (o.push(l), s.slice(0, d) + _e + s.slice(d) + D + g) : s + D + (d === -2 ? c : g);
  }
  return [ke(r, t + (r[e] || "<?>") + (a === 2 ? "</svg>" : a === 3 ? "</math>" : "")), o];
};
class ra {
  constructor({ strings: a, _$litType$: e }, o) {
    ...
    this.parts = [];
    let t = 0, n = 0;
    const c = a.length - 1, s = this.parts, [l, m] = xo(a, e);
    ...
    for (; (i = j.nextNode()) !== null && s.length < c; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(_e)) {
          const u = m[n++], g = i.getAttribute(d).split(D), f = /([.?@])?(.*)/.exec(u);
          s.push({ type: 1, index: t, name: f[2], strings: g, ctor: f[1] === "." ? _o : f[1] === "?" ? wo : f[1] === "@" ? yo : ya }), i.removeAttribute(d);
        } else d.startsWith(D) && (s.push({ type: 6, index: t }), i.removeAttribute(d));
      ...
      } else if (i.nodeType === 8) if (i.data === we) s.push({ type: 2, index: t });
      else {
        let d = -1;
        for (; (d = i.data.indexOf(D, d + 1)) !== -1; ) s.push({ type: 7, index: t }), d += D.length - 1;
      }
      t++;
    }
  }
...
class vo {
  ...
  u(a) {
    ...
    for (; s !== void 0; ) {
      if (n === s.index) {
        let l;
        s.type === 2 ? l = new na(t, t.nextSibling, this, a) : s.type === 1 ? l = new s.ctor(t, s.name, s.strings, this, a) : s.type === 6 && (l = new qo(t, this, a)), this._$AV.push(l), s = o[++c];
      }
...
class na {
  ...
  _$AI(a, e = this) {
    a = W(this, a, e), ta(a) ? a === h || a == null || a === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : a !== this._$AH && a !== Q && this._(a) : a._$litType$ !== void 0 ? this.$(a) : a.nodeType !== void 0 ? this.T(a) : fo(a) ? this.k(a) : this._(a);
  }
  O(a) {
  ...
  $(a) {
    const { values: e, _$litType$: o } = a, i = typeof o == "number" ? this._$AC(a) : (o.el === void 0 && (o.el = ra.createElement(ke(o.h, o.h[0]), this.options)), o);
    if (this._$AH?._$AD === i) this._$AH.p(e);
    else {
      const t = new vo(i, this), n = t.u(this.options);
...
class ya {
  ...
  _$AI(a, e = this, o, i) {
    ...
    if (t === void 0) a = W(this, a, e, 0), n = !ta(a) || a !== this._$AH && a !== Q, n && (this._$AH = a);
      ...
      const c = a;
      let s, l;
      for (a = t[0], s = 0; s < t.length - 1; s++) l = W(this, c[o + s], e, s), l === Q && (l = this._$AH[s]), n ||= !ta(l) || l !== this._$AH[s], l === h ? a = h : a !== h && (a += (l ?? "") + t[s + 1]), this._$AH[s] = l;
    }
    n && !i && this.j(a);
  }
  j(a) {
...
const ko = Va.litHtmlPolyfillSupport;
ko?.(ra, na), (Va.litHtmlVersions ??= []).push("3.3.3");
const zo = (r, a, e) => {
...
class E extends H {
  ...
  update(a) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(a), this._$Do = zo(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
E._$litElement$ = !0, E.finalized = !0, Fa.litElementHydrateSupport?.({ LitElement: E });
const $o = Fa.litElementPolyfillSupport;
$o?.({ LitElement: E });
(Fa.litElementVersions ??= []).push("4.2.2");
const ze = _`
  :host {
...
`, Ao = "media_player.spotifyplus_bruno_helasio", J = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], pa = ["playing", "paused", "on"], Ba = [
  {
    id: "sala",
    name: "Sala",
    section: "sala",
...
async function Do(r) {
  ...
  return {
    ...
    cameras: o,
    resumo: i,
    veredito: Ae(i, o.length, a.streamCarregado)
  };
}
function $e(r) {
  const a = {
  ...
  for (const [t, n] of Object.entries(r.states)) {
    ...
    e.push({
      ...
      caminho: Ro(c, String(n.state)),
      suportaStream: (s & Io) !== 0
    });
  }
...
class No extends E {
  constructor() {
    super(...arguments), this._env = Oo(), this._sondando = !1, this._mensagem = "";
  }
  static {
    this.properties = {
      _hass: { state: !0 }
  ...
  _cameras() {
    !this._sondaProfunda && !this._sondando && this._hass && (this._sondando = !0, Do(this._hass).then((e) => {
      this._sondaProfunda = e, this._sondando = !1, this.requestUpdate();
    }));
    const a = this._sondaProfunda ?? $e(this._hass);
  ...
  render() {
    const a = this._env, e = Mo(this._hass), o = e.issues.filter((n) => n.problem === "missing"), i = e.issues.filter((n) => n.problem === "unavailable"), t = To(this._hass);
    return p`
      <div class="card">
        <div>
          <h2>Diagnóstico</h2>
...
customElements.get("bruno-diagnostics") || customElements.define("bruno-diagnostics", No);
const ba = window;
...
const Se = ["playing", "paused"];
function Ce(r, a, e) {
  return !r || !Se.includes(String(r.state).toLowerCase()) ? !1 : Bo(r.attributes, a) ? !0 : Uo(r.attributes, e);
}
function Uo(r, a) {
  if (!a || !Se.includes(String(a.state).toLowerCase())) return !1;
...
const Go = "∅", Ho = (r) => r ? `${r.state}@${r.last_changed}` : Go;
class fa {
  constructor(a = [], e = {}) {
  ...
  projetar(a, e) {
    return (this.projecoes[e] ?? Ho)(a.states[e]);
  }
  /**
...
const Yo = /^[a-z_]+\.[a-z0-9_]+$/, Xo = 8;
function ne(r, a = 0) {
  const e = [], o = /* @__PURE__ */ new Set(), i = (t, n) => {
    if (!(n > Xo || t == null)) {
      if (typeof t == "string") {
        Yo.test(t) && !o.has(t) && (o.add(t), e.push(t));
        return;
      }
      if (Array.isArray(t)) {
...
const Sa = "bruno-room-tile", Qo = 1200, Wo = 560, se = 10;
function ce() {
  return {
    pointerId: null,
    down: !1,
...
class Zo extends E {
  constructor() {
    super(...arguments), this._lastAction = 0, this._observador = new fa(), this._motivo = "", this._gestures = {
      room: ce(),
      nav: ce()
  ...
  connectedCallback() {
    super.connectedCallback(), Ra(Sa), this._tileModeCache = void 0, globalThis.addEventListener?.("bruno-theme-changed", this._onThemeChanged);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Da(Sa), globalThis.removeEventListener?.("bruno-theme-changed", this._onThemeChanged);
  ...
  _runAction(a) {
    ...
    const i = Date.now();
    if (i - this._lastAction < Qo) return;
    this._lastAction = i;
  ...
  _alternarLuzDoPainel(a) {
    this._hass && (Ca("tap"), this._hass.callService("light", "toggle", { entity_id: a }, { entity_id: a }));
  }
  // ── Modelo ───────────────────────────────────────────────────────────────
  _dots() {
    ...
    const o = e.activeSensor ? a.states[e.activeSensor] : void 0, i = (t) => {
      ...
      }), s = t.activeAttr ? le(o?.attributes[t.activeAttr]) : !1, l = t.spotifyDevice ? Ce(a.states[Ao], t.spotifyDevice) : !1;
      return c || s || l;
    };
            ...
            >
              <section class="room-popup-panel" role="document" @click=${(b) => b.stopPropagation()}>
                ...
                <div class="room-popup-lights">
                  ${v.lights.map((b) => {
      const $ = e?.states[b.entity], M = String($?.state ?? "").toLowerCase(), T = M === "on", P = !$ || ["unavailable", "unknown", "none", ""].includes(M), y = [
        "room-popup-light",
        T ? "is-on" : "",
        P ? "is-unavailable" : ""
      ].filter(Boolean).join(" ");
      return p`<button
                    ...
                    >
                      ...
                      <span class="room-popup-light-copy">
                        ...
                        <span>${P ? "Indisponivel" : T ? "Ligada" : "Desligada"}</span>
                      </span>
                    </button>`;
    })}
                </div>
...
customElements.get("bruno-room-tile") || customElements.define("bruno-room-tile", Zo);
const xa = window;
xa.customCards = xa.customCards ?? [];
xa.customCards.some((r) => r.type === "bruno-room-tile") || xa.customCards.push({
...
}, Y = /* @__PURE__ */ new Set(), F = { timer: void 0, ouvindoVisibilidade: !1 }, Ko = 1e3;
function Ee() {
  for (const r of [...Y])
    try {
      r();
...
function Te() {
  F.timer !== void 0 || Y.size === 0 || Me() || (F.timer = globalThis.setInterval(Ee, Ko));
}
function Oe() {
...
function ei() {
  F.ouvindoVisibilidade || typeof document > "u" || (document.addEventListener("visibilitychange", ai), F.ouvindoVisibilidade = !0);
}
function oi(r) {
  Y.add(r), ei(), Te();
  let a = !1;
  return () => {
    a || (a = !0, Y.delete(r), Y.size === 0 && Oe());
  };
}
const N = "ha-web-rtc-player", ii = 6e3, ea = 48, oa = 27, de = 500;
let Ea;
...
function C(r, a, e = 0, o = !0) {
  G(`marco: ${ti(r)} · player webrtc · ${a}`, e, o);
}
function ri() {
  return typeof customElements > "u" ? Promise.resolve(!1) : customElements.get(N) ? Promise.resolve(!0) : new Promise((r) => {
    ...
    }, o = globalThis.setTimeout(() => e(!!customElements.get(N)), ii);
    customElements.whenDefined(N).then(() => e(!0));
  });
}
async function ni(r, a) {
  ...
  try {
    ...
    return i && a && (i.hass = a), await ri();
  } catch {
    return !1;
  }
}
async function Ie(r, a) {
  if (typeof customElements < "u" && customElements.get(N)) return !0;
  const e = typeof performance < "u" ? performance.now() : Date.now();
  C(r, "ausente; carregando modulo", 0, !1), Ea ??= ni(r, a).finally(() => {
    Ea = void 0;
  });
  const o = await Ea, i = typeof performance < "u" ? performance.now() : Date.now();
    ...
    for (let l = 0; l < o; l++) {
      ...
      for (let f = s * n; f < (s + 1) * n; f++)
        for (let v = l * t; v < (l + 1) * t; v++) {
          ...
          if (d++, !De(b, $, M)) continue;
          u++;
          const T = b >> 4 | $ >> 4 << 4 | M >> 4 << 8, P = (m.get(T) ?? 0) + 1;
          m.set(T, P), g = Math.max(g, P);
        }
...
function ci(r, a = ea, e = oa) {
  ...
  return t / i >= 0.45 && De(c, s, l) || si(r, a, e);
}
function li(r) {
  if (ma.has(r)) return;
  let a = 0;
  const e = () => {
    if (r.isConnected) {
      ...
      if (t && t.readyState >= 2) {
        const n = qa(t), c = r.hasAttribute("data-bruno-quadro-verde");
        n && r.classList.contains("is-ready") ? (r.classList.remove("is-ready"), r.setAttribute("data-bruno-quadro-verde", ""), C(r.entityid ?? "camera.desconhecida", "quadro verde eventual rejeitado", 0, !1)) : !n && c && (r.removeAttribute("data-bruno-quadro-verde"), r.classList.add("is-ready"), C(r.entityid ?? "camera.desconhecida", "stream recuperado apos quadro verde"));
      }
    } else if (a += 1, a >= 20) {
      ma.delete(r);
      return;
    }
    const i = globalThis.setTimeout(e, de);
    ma.set(r, i);
  }, o = globalThis.setTimeout(e, de);
  ma.set(r, o);
}
function qa(r) {
  ...
  try {
    ...
    return e ? (e.drawImage(r, 0, 0, ea, oa), ci(
...
const di = {
  ...
  principal: 1500,
  secundaria: 3e3
}, mi = 25e3, ui = 300, hi = 6e4, gi = 12e3, pe = { comImagem: 2, semImagem: 4 };
function bi(r, a) {
...
const fi = (r, a) => {
  ...
  return e.onload = () => i(qa(e) ? "quadro-verde" : !0), e.onerror = () => i(!1), e.src = r, () => {
...
class Pe {
  constructor(a = {}) {
    this.cameras = /* @__PURE__ */ new Map(), this.ligado = !1, this.carregador = a.carregador ?? fi, this.agenda = a.agenda ?? xi, this.aoCarregar = a.aoCarregar ?? (() => {
  ...
  buscar(a) {
    ...
    const e = bi(a.alvo.base, Math.round(a.inicio) || 1);
    a.prazo = this.agenda.agendar(() => this.encerrar(a, "prazo", e), mi), a.abortar = this.carregador(
      e,
      (o) => this.encerrar(
        a,
  ...
  agendarProximo(a, e) {
    ...
    let i = Math.max(pi[o], Ne[o] - e);
    const t = a.quadros === 0, n = t ? pe.semImagem : pe.comImagem, c = t ? gi : hi;
...
const Oi = ["on", "playing", "paused", "idle"], Ii = ["playing", "paused", "on", "idle"], Ri = ["streaming", "recording", "idle", "on"], Di = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], Ni = ["cooling", "heating", "drying", "fan", "preheating"], Pi = ["off", "idle"], Li = [
  { visual: 0, position: 0 },
  { visual: 25, position: 33 },
  { visual: 50, position: 47 },
  { visual: 75, position: 70 },
  { visual: 100, position: 100 }
], me = 3e4, ue = 1200, Vi = 350, ji = 2;
function Fi(r) {
  if (!r) return "∅";
...
const Bi = 4e3, Ui = 3e4, Gi = 700, Hi = "/local/bruno-ui/assets/tcl-qled-mini-led-75.png?v=20260802-assets-resize-1", Yi = "/local/images/echo_pop.png?v=20260702-all-images-1", Xi = "/local/images/office_pc.png?v=20260702-all-images-1";
function U(r, a = 0) {
  const e = Number(r);
...
class Qi extends E {
    ...
    super(...arguments), this._lightsOpen = !1, this._folha = null, this._folhaSaindo = !1, this._fonteMidia = "", this._fonteMidiaManual = !1, this._midiaAtivasAntes = [], this._menuMidiaAberto = !1, this._spotifyFerramentas = !1, this._painelClima = "", this._controlesCameraAbertos = !1, this._cameraAtiva = "", this._urlsCarregadas = {}, this._ultimaImagem = {}, this._motorCameras = new Pe({
      ...
      if (qa(o)) {
        this._quadroVerdeRegistrado !== e && (this._quadroVerdeRegistrado = e, C(
          ...
          !1
        )), k(x, this._timerQuadroVerde), this._timerQuadroVerde = R(x, () => {
      ...
      a.detail?.dialog === "ha-more-info-dialog" && this._estadoAoVivo === "entregue-more-info" && (this._estadoAoVivo = "retomando", C(this._cameraAtiva, "more-info fechado; retomando"), k(x, this._timerRetomadaAoVivo), this._timerRetomadaAoVivo = R(x, () => {
  ...
  setConfig(a) {
    ...
    const e = Ba.find((c) => c.id === a.room);
    if (!e) throw new Error(`bruno-room-subview: cômodo desconhecido "${a.room}"`);
    this._config = a, this._room = e, this._sub = Jo[a.room], this._config, this._hass;
    const o = [
      ...ne(e),
      ...ne(this._sub)
    ], i = this._sub?.entities ?? {}, t = ["spotify", "tv", "speaker"].flatMap((c) => {
      const s = i[c];
      return Array.isArray(s) ? s : typeof s == "string" ? [s] : [];
    }).filter((c) => !!c), n = Object.fromEntries(t.map((c) => [c, Fi]));
    this._observador = new fa(o, { projecoes: n }), this._aplicarAtributos();
  }
  /**
  ...
  update(a) {
    const e = this._motivo;
    this._motivo = "", Na(x, () => super.update(a), e || this._motivoPadrao());
  }
  _motivoPadrao() {
  ...
  connectedCallback() {
    super.connectedCallback(), Ra(x), this._estadoAoVivo = "ocioso", this._fallbackAoVivo = "", this._montadoEm = performance.now(), this._quadrosNaTela.clear(), this._socorros.clear(), this._aplicarAtributos();
    const a = globalThis;
  ...
  _iniciarTimerRelogio() {
    this._cancelarRelogio || (this._cancelarRelogio = oi(() => {
      const a = this._hora();
  ...
  _armarPrazoAoVivo(a, e) {
    k(x, this._timerAoVivo), this._timerAoVivo = R(x, () => {
  ...
  _injetarMaterial(a = 0) {
    ...
    if (!i) {
      a < 20 && R(x, () => this._injetarMaterial(a + 1), 60);
      return;
    }
    try {
   ...
   */
  _alternarDock() {
    this._lightsOpen = !this._lightsOpen, this._luzesAssentadas = !1, k(x, this._timerLuzes), this._timerLuzes = R(x, () => {
  ...
  _preservarBaseDuranteFolha() {
    ...
    for (; a; ) {
      if (a instanceof HTMLElement) {
        const c = globalThis.getComputedStyle?.(a);
        if (c && /(auto|scroll)/.test(c.overflowY)) {
          e = a;
          break;
        }
      }
      ...
      a = n instanceof ShadowRoot && n.host !== a ? n.host : null;
    }
    if (!e) return;
    const i = (this.renderRoot.querySelector(".cameras-card") ?? this).getBoundingClientRect().top, t = e.scrollTop;
    this.updateComplete.then(() => {
      globalThis.requestAnimationFrame(() => {
        if (!e?.isConnected) return;
        const c = (this.renderRoot.querySelector(".cameras-card") ?? this).getBoundingClientRect().top - i;
        e.scrollTop = Math.max(0, t + c);
      });
    });
  }
  /**
  ...
  _abrirFolha(a) {
    if (this._estaNoTelefone()) {
      ...
      k(x, this._timerFecharFolha), this._timerFecharFolha = void 0, this._folhaSaindo = !1, this._folha = a, this._folha === "luzes" && (this._lightsOpen = !0, this._luzesAssentadas = !0), this._aplicarAtributos(), this._avisarFolha(), this.requestUpdate(), this._preservarBaseDuranteFolha();
    }
  }
  _fecharFolha() {
    ...
    this._timerFecharFolha = R(x, () => {
      this._timerFecharFolha = void 0, this._limparFolhaImediatamente();
    }, 280);
  }
  _limparFolhaImediatamente(a = !0) {
    const e = !!this._folha;
    k(x, this._timerFecharFolha), this._timerFecharFolha = void 0, this._folhaSaindo = !1, this._folha = null, this._encerrarArrasto(), this._aplicarAtributos(), e && a && this._avisarFolha(), this.requestUpdate(), this._preservarBaseDuranteFolha();
  }
  /**
  ...
  _interpolarCortina(a, e, o) {
    const i = this._percentualCortinaValido(a) ?? 0, t = Li, n = t[0];
    if (i <= n[e]) return n[o];
  ...
  _fechamentoCortina() {
    ...
    if (e.retido) return e.fechado;
    if (Math.abs(a - e.alvoFechado) <= ji)
      return this._movimentoCortina = void 0, this._pararTimerMovimentoCortina(), e.alvoFechado;
    if (Math.abs(a - e.ultimoRelatado) >= 1)
      return e.ultimoRelatado = a, e.inicioFechado = a, e.iniciadoEm = Date.now(), e.duracao = Math.max(
        ue,
        me * (Math.abs(e.alvoFechado - a) / 100)
      ), a;
    const t = this._fechamentoMovimentoCortina(e);
    return Date.now() - e.iniciadoEm >= e.duracao ? (this._movimentoCortina = void 0, this._pararTimerMovimentoCortina(), e.alvoFechado) : t ?? a;
  }
  _iniciarTimerMovimentoCortina() {
    this._timerMovimentoCortina || !this.isConnected || (this._timerMovimentoCortina = ao(x, () => {
  ...
  _pararTimerMovimentoCortina() {
    k(x, this._timerMovimentoCortina), this._timerMovimentoCortina = void 0;
  }
  ...
  _reterMovimentoCortina() {
    ...
    this._movimentoCortina = { entityId: a, fechado: e, retido: !0 }, this._pararTimerMovimentoCortina(), this.requestUpdate();
  }
   ...
   */
  _cameraViva(a) {
    const e = this._estado(a.entity), o = this._indisponivel(e), i = !o && Ri.includes(String(e?.state ?? "")), t = String(e?.attributes.entity_picture ?? "");
  ...
  _modeloTv() {
    const a = this._estado(this._idDe("tv")), e = a?.attributes ?? {}, o = a?.state ?? "off", i = Oi.includes(o), t = String(e.source ?? e.app_name ?? "") || "HDMI 1", n = String(e.media_title ?? e.media_series_title ?? e.app_name ?? "");
    return {
      st: a,
      estado: o,
      ativo: i,
  ...
  _modeloSpotify() {
    const a = this._estado(this._idDe("spotify")), e = a?.attributes ?? {}, o = a?.state ?? "off", t = Ii.includes(o) && Ce(
      a,
  ...
  _corpoTv() {
    const a = this._modeloTv(), e = this._idDe("tv"), o = this._sub?.tvStandbyImage ?? Hi, t = (!(!a.titulo || /^TV (ligada|desligada)$/i.test(a.titulo) || a.titulo === a.fonte) && a.estado === "playing" ? a.titulo : "") || a.fonte;
    if (!a.ativo)
      return p`
        <div class="mh-left">
  ...
  _corpoPc() {
    const a = this._modeloPc(), e = this._sub?.pcImage ?? Xi, o = a.ativo ? [a.sessao, a.janela].filter((t) => t && t !== "--")[0] || "Sessão ativa" : "Pronto para ligar", i = (t) => () => {
  ...
  _corpoSpotify() {
    const a = this._modeloSpotify(), e = this._idDe("spotify"), o = this._sub?.spotifyStandbyImage ?? Yi;
    if (!a.ativo)
      return p`
        <div class="mh-left">
  ...
  _maisInfo(a) {
    a && (Ma(a) && (this._tokenDefinicaoPlayer++, this._estadoAoVivo = "entregue-more-info", C(a, "entregue ao more-info"), this._pararAoVivo(), this._sincronizarCameras()), this.dispatchEvent(
  ...
  _renderEletrodomesticos() {
    ...
    return Array.isArray(a) ? a.filter((e) => !!e && typeof e == "object").map((e) => {
      const o = String(e.key ?? "item").replace(/[^a-z0-9_-]/gi, "-").toLowerCase(), i = String(e.name ?? "Eletrodoméstico"), t = typeof e.image == "string" ? e.image : "", n = typeof e.entity == "string" ? e.entity : "", c = typeof e.stateEntity == "string" ? e.stateEntity : n, s = c && this._hass ? this._hass.states[c] : void 0, l = Array.isArray(e.activeStates) ? e.activeStates.map((q) => String(q).toLowerCase()) : ["on"], m = typeof e.activeAttr == "string" ? e.activeAttr : "", d = this._room?.activeSensor ? this._hass?.states[this._room.activeSensor] : void 0, u = l.includes(String(s?.state ?? "").toLowerCase()) || (m ? Ti(d?.attributes[m]) : !1), g = !!e.placeholder || !n, f = typeof e.moreInfoEntity == "string" ? e.moreInfoEntity : n, v = ["appliance-tile", `is-${o}`, u ? "is-on" : "", g ? "is-muted" : ""].filter(Boolean).join(" ");
      return p`
          <article class=${v}>
            <button
              type="button"
   ...
   */
  _modeloClimate() {
    const a = this._estadoClimate(), e = a?.attributes ?? {}, o = String(e.hvac_action ?? "").toLowerCase(), i = this._indisponivel(a), t = i || a?.state === "off" ? !1 : Ni.includes(o) ? !0 : Pi.includes(o) ? !1 : Di.includes(String(a?.state ?? "")), n = (c, s) => Number.isFinite(Number(c)) ? Number(c) : s;
    return {
      st: a,
      indisponivel: i,
      ativo: t,
  ...
  _rotuloVentilacao(a) {
    ...
    return e === "auto" ? "Auto" : e.includes("low") || e.includes("baixo") ? "Baixa" : e.includes("med") ? "Média" : e.includes("high") || e.includes("alto") ? "Alta" : e.includes("fort") ? "Forte" : Ta(a);
  }
  _iconeVentilacao(a) {
    const e = String(a).toLowerCase();
  ...
  _rotuloSwing(a) {
    const e = String(a).toLowerCase();
    return e ? ["off", "desativado", "desativada", "disabled"].includes(e) ? "Desligado" : ["on", "ativo", "ativada", "enabled"].includes(e) ? "Ativo" : Ta(a) : "Indisponível";
  }
  /**
   ...
   * 720×460. Somente o raio luminoso interno sobe de 285 para 300; as duas
   * coroas de marcas e as cinco legendas continuam calculadas.
   */
  _renderAnelClimate(a) {
    const s = Number.isFinite(a.minima) ? a.minima : 12, l = Number.isFinite(a.maxima) ? a.maxima : 30, m = Number.isFinite(Number(a.alvo)) ? Math.max(s, Math.min(l, Number(a.alvo))) : s + (l - s) / 2, u = -180 + 180 * Math.max(0, Math.min(1, (m - s) / Math.max(1, l - s))), g = (y, z) => {
      const A = z * Math.PI / 180;
      return { x: 360 + y * Math.cos(A), y: 410 + y * Math.sin(A) };
    }, f = (y, z, A) => {
      const O = g(y, z), I = g(y, A), sa = Math.abs(A - z) <= 180 ? "0" : "1";
      return `M ${O.x.toFixed(3)} ${O.y.toFixed(3)} A ${y} ${y} 0 ${sa} 1 ${I.x.toFixed(3)} ${I.y.toFixed(3)}`;
    }, v = Array.from({ length: 91 }, (y, z) => {
      const A = -180 + 180 * (z / 90), O = z % 15 === 0, I = z % 5 === 0, sa = g(334, A), Ga = g(O ? 308 : I ? 314 : 321, A), je = O ? "icg-tick major" : I ? "icg-tick medium" : "icg-tick minor";
      return Aa`<line x1=${sa.x.toFixed(3)} y1=${sa.y.toFixed(3)} x2=${Ga.x.toFixed(3)} y2=${Ga.y.toFixed(3)} class=${je}></line>`;
    }), q = Array.from({ length: 73 }, (y, z) => {
      const A = -180 + 180 * (z / 72), O = g(282, A), I = g(266, A);
      return Aa`<line x1=${O.x.toFixed(3)} y1=${O.y.toFixed(3)} x2=${I.x.toFixed(3)} y2=${I.y.toFixed(3)} class="icg-inner-tick"></line>`;
    }), b = [
      { texto: `${U(s, 0)}°`, ang: -180, r: 352, cls: "edge" },
      { texto: "10", ang: -148, r: 358, cls: "" },
      { texto: "20", ang: -90, r: 352, cls: "top" },
      { texto: "25", ang: -32, r: 358, cls: "" },
      { texto: `${U(l, 0)}°`, ang: 0, r: 352, cls: "edge" }
    ].map((y) => {
      const z = g(y.r, y.ang);
      return Aa`<text x=${z.x.toFixed(3)} y=${z.y.toFixed(3)} text-anchor="middle" dominant-baseline="middle" class=${`icg-label ${y.cls}`}>${y.texto}</text>`;
    }), $ = g(300, u), M = a.alvo == null ? "--" : U(a.alvo, 0), T = a.atual == null ? "--" : U(a.atual, 1), P = (a.modo === "cool" ? "Resfriamento" : a.modo === "heat" ? "Aquecimento" : a.modo === "fan_only" ? "Ventilacao" : "Temperatura").toUpperCase();
    return p`
      <div class="icg-root">
        <div class="icg-shell">
          <svg
          ...
          >
            ...
            <g>${v}</g>
            <g>${q}</g>
            <path d=${f(300, -180, 0)} class="icg-track-shadow"></path>
            <path d=${f(300, u, 0)} class="icg-track-muted"></path>
            <path d=${f(300, -180, u)} class="icg-active-glow"></path>
            <path d=${f(300, -180, u)} class="icg-active-arc"></path>
            ${b}
...
customElements.get("bruno-room-subview") || customElements.define("bruno-room-subview", Qi);
const va = window;
va.customCards = va.customCards ?? [];
va.customCards.some((r) => r.type === "bruno-room-subview") || va.customCards.push({
...
], at = ["cool", "heat", "fan_only", "dry", "heat_cool", "auto"], et = ["on", "playing", "paused", "idle", "buffering"];
class _a extends E {
  static {
  ...
  get _entityId() {
    return Le(this._instancia?.entity, this._hass);
  }
  _estado(a) {
    return a && this._hass ? this._hass.states[a] : void 0;
  }
...
class ot extends _a {
  static {
    this.styles = [_a.estilosComuns];
  }
  render() {
    const a = this._entityId, e = this._estado(a);
    if (!e) return p`<p class="indisponivel">Entidade indisponível: ${a ?? "—"}</p>`;
    const o = et.includes(String(e.state)), i = String(e.attributes.source ?? e.attributes.app_name ?? "") || "HDMI 1", t = e.attributes.volume_level != null ? Math.round(Number(e.attributes.volume_level) * 100) : null;
    return p`
      <div class="titulo">
...
customElements.get("bruno-control-tv") || customElements.define("bruno-control-tv", ot);
customElements.get("bruno-control-climate") || customElements.define("bruno-control-climate", it);
function Ve(r) {
  return (a) => {
...
S.conhece("climate") || S.registrar({
  ...
  icon: "mdi:air-conditioner",
  create: Ve("bruno-control-climate"),
  entities: (r) => [typeof r.entity == "string" ? r.entity : r.entity?.[0] ?? ""].filter(Boolean),
  validate: (r) => ({
    ok: !!r.entity,
...
const Oa = "bruno-devices-panel", tt = ["on", "playing", "paused", "idle", "buffering", "cool", "heat", "fan_only", "dry", "heat_cool", "auto"];
class rt extends E {
  constructor() {
    super(...arguments), this._selecionado = "", this._controles = /* @__PURE__ */ new Map(), this._observador = new fa(
      be.flatMap((a) => ge(a))
    ), this._motivo = "";
  }
  static {
  ...
  _estaAtivo(a) {
    const e = Le(a.entity, this._hass), o = e && this._hass ? this._hass.states[e] : void 0;
    return !!o && tt.includes(String(o?.state ?? "").toLowerCase());
  }
  /**
  ...
  update(a) {
    const e = this._motivo;
    this._motivo = "", Na(Oa, () => super.update(a), e || "outro");
  }
  render() {
  ...
  entidadesObservadas() {
    return [...new Set(this._dispositivos.flatMap((a) => ge(a)))];
  }
  static {
    this.styles = _`
...
customElements.get("bruno-devices-panel") || customElements.define("bruno-devices-panel", rt);
to();
console.info("[bruno-dashboard] build 20260815");
globalThis.BrunoCameraEngine = Pe;
globalThis.BrunoCameraLive = di;
//# sourceMappingURL=bruno-dashboard.DLc4aRtS.js.map
