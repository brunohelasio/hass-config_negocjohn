...
const BRUNO_QUARTO_CASAL_SUBVIEW_DEFAULT_CONFIG = {
  ...
  entities: {
    ...
    zigbee_hub: '',
    lights: [
      { entity: 'light.qc_luz_principal', name: 'QC Luz principal', icon_type: 'ledstrip', zone: 'sala' },
      { entity: 'light.quarto_casal_switch_1', name: 'QC Luzes quadros', icon_type: 'light_flush', zone: 'sala' },
      { entity: 'light.quarto_casal_2_switch_2', name: 'QC Luz sanca', icon_type: 'ledstrip', zone: 'sala' },
      { entity: 'light.quarto_casal_switch_2', name: 'QC Luzes closet', icon_type: 'light_flush', zone: 'sala' },
      { entity: 'light.quarto_casal_2_switch_3', name: 'QC Luz cortineiro', icon_type: 'ledstrip', zone: 'varanda' },
      { entity: 'light.suite_casal_switch_1', name: 'QCS Luz principal', icon_type: 'ledstrip', zone: 'varanda' },
      { entity: 'light.suite_casal_switch_2', name: 'QCS Luz azul', icon_type: 'light_flush', zone: 'varanda' },
    ],
    cameras: [
...
class BrunoQuartoCasalSubview extends HTMLElement {
  ...
  _spotifyModel() {
    ...
    const attrs = entity?.attributes || {};
    const state = entity?.state || 'off';
    const active = BRUNO_QUARTO_CASAL_SUBVIEW_MEDIA_ON_STATES.includes(state);
