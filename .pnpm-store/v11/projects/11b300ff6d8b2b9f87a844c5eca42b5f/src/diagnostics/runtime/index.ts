...
import { coletor, type ContagemDeRecursos, type InstantaneoDeRuntime } from './collector';
import { iniciarObservadores, observadoresLigados } from './observers';
import { limparMarca, marcar, timersVivos } from './probe';
...
export interface JanelaDeRuntime {
  ...
  texto(): string;
  zerar(): void;
  /** Congela a contagem atual, para o teste de ciclo de navegação (Fase 6.1). */
  marcar(): ContagemDeRecursos;
  limparMarca(): void;
}
