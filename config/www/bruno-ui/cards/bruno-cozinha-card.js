...
const BRUNO_COZINHA_DEFAULT_CONFIG = {
  ...
  "icon": {
    ...
    "off": "/local/bruno-ui/assets/kitchen-off-tight.png?v=20260802-assets-resize-1",
    // ORIGINAL (rollback rapido): "on": "/local/bruno-ui/assets/kitchen-on.png?v=20260702-all-images-1",
    "on": "/local/bruno-ui/assets/kitchen-on-tight.png?v=20260802-assets-resize-1",
    "phone_off": "/local/bruno-ui/assets/v2/cozinha-off.webp?v=20260817-mobile-perf-webp-1",
    "phone_on": "/local/bruno-ui/assets/v2/cozinha-on.webp?v=20260817-mobile-perf-webp-1",
...
class BrunoCozinhaCard extends HTMLElement {
  ...
  _assetVisual(active) {
    ...
    const phoneOff = BrunoCozinhaCard._escape(icon.phone_off || '');
    const phoneOn = BrunoCozinhaCard._escape(icon.phone_on || '');
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="room-card${roomActiveClass}${this._tileClasses()}" style="--room-icon-size:${iconSize}px;">
        ...
        <button class="room-action${hasMetricClass}" type="button" data-action-key="room" aria-label="${BrunoCozinhaCard._escape(this._config.name)}">
          ...
          <span class="room-nav-zone" data-room-nav role="button" tabindex="0" aria-label="Abrir ${BrunoCozinhaCard._escape(this._config.name)}">
            <span class="room-title-row">
              <span class="title">${BrunoCozinhaCard._escape(this._config.name)}</span>
